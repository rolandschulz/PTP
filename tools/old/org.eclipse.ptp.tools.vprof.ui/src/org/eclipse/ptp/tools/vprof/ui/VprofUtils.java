 ...
 *
 */
public class VprofUtils {
    public static final String VprofView_ID = "org.eclipse.ptp.tools.vprof.ui.views.VprofView";
	public static final String VprofPerspectiveFactory_ID = "org.eclipse.ptp.tools.vprof.VprofPerspective";
        ...
        Display.getDefault().syncExec(new Runnable() {
            public void run() {
                ...
                if (page.getPerspective().getId().equals(perspectiveID))
                    return;
                IWorkbench bench = VprofUIPlugin.getDefault().getWorkbench();
                try {
                    bench.showPerspective(perspectiveID, VprofUIPlugin.getActiveWorkbenchWindow());
    ...
    public static IWorkbenchPage getActivePage() {
        return VprofUIPlugin.getDefault().getWorkbench().getActiveWorkbenchWindow().getActivePage();
    }
