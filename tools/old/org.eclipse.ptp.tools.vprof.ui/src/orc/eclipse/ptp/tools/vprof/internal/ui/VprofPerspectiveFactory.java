 ...
 * LA-CC 04-115
 *******************************************************************************/
package orc.eclipse.ptp.tools.vprof.internal.ui;

import org.eclipse.debug.ui.IDebugUIConstants;
import org.eclipse.ptp.tools.vprof.ui.VprofUtils;
...
public class VprofPerspectiveFactory implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		folder1.addView(VprofUtils.VprofView_ID);
		...
		//layout.addActionSet(VprofUtils.PTP_ACTION_SET);
		...
		layout.addShowViewShortcut(VprofUtils.VprofView_ID);
		//layout.addShowViewShortcut(IPageLayout.ID_RES_NAV);
		layout.addShowViewShortcut(IPageLayout.ID_PROP_SHEET);

		// link - things we should do
		layout.addShowInPart(VprofUtils.VprofView_ID);
