 ...
 * @since 3.0.0
 */
public class AltivecABIValueHandler extends CellDefaultOptionValueHandler {

	public AltivecABIValueHandler() {
						...
						MessageDialog
								.openWarning(
										PlatformUI.getWorkbench()
												...
												.getShell(),
										GnuManagedMakeMessages.AltivecABIWarningDialogTitle,
										NLS
												.bind(
														GnuManagedMakeMessages.AltivecABIWarningDialogMessage,
														option.getCommand(),
														otherOption
																.getCommand()));
					}
