...
/**
 * Displays SPU Mailbox info.
 *
 * @author Ricardo M. Matinata
 * @since 1.3
 */
public class SPUMailboxView extends AbstractDebugEventHandlerView 
						 implements ISelectionListener, 
						 			INullSelectionListener, 
									IPropertyChangeListener, 
									IDebugExceptionHandler {

	public class SPUMailboxViewLabelProvider extends LabelProvider implements ITableLabelProvider {
		...
		public String getColumnText( Object element, int columnIndex ) {
			if ( element instanceof MISPUMailbox ) {
				
				switch( columnIndex ) {
					case 0:
						return ((MISPUMailbox)element).getName();
					case 1:
						return ((MISPUMailbox)element).getIndex();
					case 2:
						return ((MISPUMailbox)element).getValue();
	...
	protected Viewer createViewer( Composite parent ) {
		...
		// add tree viewer
		final SPUMailboxViewer vv = new SPUMailboxViewer( parent, SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL );
		vv.setContentProvider( createContentProvider() );
		vv.setLabelProvider( new SPUMailboxViewLabelProvider() );
		...
		setEventHandler( new SPUMailboxViewEventHandler( this ) );
	...
	private IContentProvider createContentProvider() {
		SPUMailboxViewContentProvider cp = new SPUMailboxViewContentProvider();
