...
/**
 * View for the SPU events
 * 
 * @author Ricardo M. Matinata
 * @since 1.3
 */
public class SPUEventView extends AbstractDebugEventHandlerView 
						 implements ISelectionListener, 
						 			INullSelectionListener, 
									IPropertyChangeListener, 
									IDebugExceptionHandler {

	public class SPUEventViewLabelProvider extends LabelProvider implements ITableLabelProvider {
		...
		public String getColumnText( Object element, int columnIndex ) {
			if ( element instanceof MISPUEvent ) {
				
				switch( columnIndex ) {
					case 0:
						return ((MISPUEvent)element).getName();
					case 1:
						return ((MISPUEvent)element).getValue();
	...
	protected Viewer createViewer( Composite parent ) {
		...
		// add tree viewer
		final SPUEventViewer vv = new SPUEventViewer( parent, SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL );
		vv.setContentProvider( createContentProvider() );
		vv.setLabelProvider( new SPUEventViewLabelProvider() );
		...
		setEventHandler( new SPUEventViewEventHandler( this ) );
	...
	private IContentProvider createContentProvider() {
		SPUEventViewContentProvider cp = new SPUEventViewContentProvider();
