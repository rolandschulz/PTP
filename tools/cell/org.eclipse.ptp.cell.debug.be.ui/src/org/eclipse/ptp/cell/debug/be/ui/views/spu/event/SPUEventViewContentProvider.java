...
/**
 * Content provider for SPU event view
 * 
 * @author Ricardo M. Matinata
 * @since 1.3
 */
public class SPUEventViewContentProvider implements IStructuredContentProvider {
	...
	public SPUEventViewContentProvider() {
	}
	...
	public Object[] getElements( Object inputElement ) {
		if ( inputElement instanceof ICDebugTarget ) {
			...
			if ( target != null ) {
				Object[] events = DebugBEActivator.getDefault().getSPUProcessor().processSPUEvent(target);
				if ( events != null )
					return events;
			}
		}
