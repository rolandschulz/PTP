...
/**
 * Updates the SPU Proxy DMA Queue view.
 *
 * @author Ricardo M. Matinata
 * @since 1.3
 */
public class SPUProxyDMAViewEventHandler extends AbstractDebugEventHandler {

	/**
	 * Constructs a new event handler on the given view
	 * 
	 * @param view mailbox view
	 */
	public SPUProxyDMAViewEventHandler( AbstractDebugView view ) {
		super( view );
	}
