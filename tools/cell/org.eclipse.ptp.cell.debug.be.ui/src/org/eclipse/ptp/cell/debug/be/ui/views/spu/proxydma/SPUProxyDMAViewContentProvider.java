...
/**
 * Provides content for the SPU Proxy DMA Queue view.
 *
 * @author Ricardo M. Matinata
 * @since 1.3
 */
public class SPUProxyDMAViewContentProvider implements IStructuredContentProvider {
	...
	public SPUProxyDMAViewContentProvider(Viewer viewer) {
	...
	public Object[] getElements( Object inputElement ) {
		if ( inputElement instanceof ICDebugTarget ) {
			...
			if ( target != null ) {
				Object[] events = DebugBEActivator.getDefault().getSPUProcessor().processSPUProxyDMA(target);
