...
public class AltivecValueHandler extends CellDefaultOptionValueHandler {
	 ...
	 * extraArgument must be the id of the other option in which this option depends on.
	 * 
						...
						MessageDialog
								.openWarning(
										PlatformUI.getWorkbench()
												...
												.getShell(),
										XlManagedMakeMessages.AltivecWarningDialogTitle,
										NLS
												.bind(
														XlManagedMakeMessages.AltivecWarningDialogMessage,
														otherOption
																.getCommand(),
														option.getCommand()));
					}
