 ...
 * @since 3.0.0
 */
public class FileFieldEditorWithSearch extends FileFieldEditor implements
		FieldEditorWithSearch {

	private FieldEditorWithSearchDelegate delegate;

	public FileFieldEditorWithSearch() {
	}
	 ...
	 * @param parent
	 */
	public FileFieldEditorWithSearch(String name, String labelText,
			Composite parent) {
	...
	public void addSearcher(Searcher searcher) {
		// If the FileFieldEditorWithSearch is already created, the Search
