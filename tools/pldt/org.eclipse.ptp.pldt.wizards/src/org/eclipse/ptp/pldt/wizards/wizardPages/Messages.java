...
public class Messages extends NLS {
	...
	public static String add_mpi_proj_settings_to_proj;
	public static String browse;
	public static String default_project_setting_better_if_prefs_set;
	public static String include_path;
	public static String library_name;
	public static String library_search_path;
	public static String locn_of_mpi_incl_path;
	public static String mpi;
	public static String mpi_compile_cmd;
	public static String mpi_include_path;
	public static String mpi_lib_search_path;
	public static String mpi_link_cmd;
	public static String mpi_project_page;
	public static String mpi_project_settings;
	...
	public static String no_mpi_preferences_set;
	public static String no_mpi_prefs_set;
	...
	public static String select_mpi_incl_path_libname_and_etc;
	public static String use_default_info;
	public static String use_window_prefs_and_select_pldt;
	public static String you_can_cancel_out_to_do_mpi_prefs;
	static {
