...
public class EnhancedSynchronizeTab extends AbstractLaunchConfigurationTab {
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(IRemoteLaunchAttributes.ATTR_SYNC_AFTER, IRemoteLaunchAttributes.DEFAULT_SYNC_AFTER);
		configuration.setAttribute(IRemoteLaunchAttributes.ATTR_SYNC_BEFORE, IRemoteLaunchAttributes.DEFAULT_SYNC_BEFORE);
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		dataChanged = false;
		try {
			syncAfterButton.setSelection(configuration.getAttribute(IRemoteLaunchAttributes.ATTR_SYNC_AFTER,
					IRemoteLaunchAttributes.DEFAULT_SYNC_AFTER));
			syncBeforeButton.setSelection(configuration.getAttribute(IRemoteLaunchAttributes.ATTR_SYNC_BEFORE,
					IRemoteLaunchAttributes.DEFAULT_SYNC_BEFORE));
			java.util.List list = configuration.getAttribute(IRemoteLaunchAttributes.ATTR_SYNC_RULES, new ArrayList());
			rules.clear();
			...
			if (configuration.getAttribute(IRemoteLaunchAttributes.ATTR_AUTOMATIC_WORKING_DIRECTORY,
				...
				ruleLabelProvider.setRemoteWorkingDir(configuration.getAttribute(IRemoteLaunchAttributes.ATTR_REMOTE_DIRECTORY,
