...
public class ParallelToolRecompMainTab extends ApplicationTab{
	...
	private void initializeConfCombo(ILaunchConfiguration configuration)
	{
		try {
			...
			String programName=configuration.getAttribute(IToolLaunchConfigurationConstants.ATTR_PERFORMANCEBUILD_CONFIGURATION_NAME, EMPTY_STRING);
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		...
		configuration.setAttribute(IToolLaunchConfigurationConstants.ATTR_PERFORMANCEBUILD_CONFIGURATION_NAME, buildConfCombo.getText());
	}
	...
	protected void initConfCombo()
	{
		...
		if(info==null)
		{
			MessageDialog.openInformation(getShell(), org.eclipse.cdt.launch.internal.ui.LaunchMessages.CMainTab_Enter_project_before_searching_for_program,  //$NON-NLS-1$
