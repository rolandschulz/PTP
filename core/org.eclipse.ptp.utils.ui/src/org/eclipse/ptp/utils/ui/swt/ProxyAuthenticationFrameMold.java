 ...
 * 
 */
public final class ProxyAuthenticationFrameMold {
	...
	public ProxyAuthenticationFrameMold(String title) {
		this.bitmask = 0;
		setTitle(title);
	}

	public ProxyAuthenticationFrameMold(String title, String description) {
		this.bitmask = 0;
		setTitle(title);
