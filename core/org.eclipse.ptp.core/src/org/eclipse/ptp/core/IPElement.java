 ...
 * extend, like Machine, Node, Job, etc.  This base class maintains a name
 * for each entity that extends it and handles parent/child operations.  A
 * key is also maintained for each parallel element which is used in storing
 * these elements in hash tables and such. 
 * 
...
public interface IPElement extends ISearchPageScoreComputer {
     ...
     * 
     * @return	An Element array of the children of this Element, null if there are none
     */
    public IPElement[] getChildren();
    
    /**
     * If this Element has a parent then this method returns it, else it
     * returns null.
     * 
    ...
    */
     ...
     * 
     * @param member	The Element to add as a child to this Element
     */
    public void addChild(IPElement member);
    
    /**
     * Locate a child Element of this Element and remove it as a child,
     * breaking the parent-child relationship between the two.  If
     * the proposed child member is not found as a child of this Element
     * then no action is taken.
     * 
     * @param member	The Element to remove as a child of this Element
     */
	...
	/**
	 * Finds an child Element of this Element by searching by the name
	 * of the Element.  If found, the Element object is returned, else
	 * null is returned.
	 * 
	 ...
	 * open to the implementer of this interface as to how the sorting
	 * is done and what the sorting is performed on.
	 * 
	 * @return	Sorted Element array of the children of this Element, null
	 * if there are none
	 */
	...
	/**
	 * Returns the children of this Element as a Collection or null if
	...
	/**
	 * Returns true if this Element has children Elements, else returns
	 * false.
	 * 
