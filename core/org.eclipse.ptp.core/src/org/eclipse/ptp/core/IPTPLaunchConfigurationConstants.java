...
public interface IPTPLaunchConfigurationConstants {
	...
	public static final String ATTR_PROJECT_NAME = PTP_LAUNCH_ID
			+ ".PROJECT_ATTR";

	public static final String ATTR_APPLICATION_NAME = PTP_LAUNCH_ID
			+ ".APPLICATION_NAME";

	public static final String ATTR_STOP_IN_MAIN = PTP_LAUNCH_ID
			+ ".STOP_IN_MAIN";

	public static final String NUMBER_OF_PROCESSES = PTP_LAUNCH_ID
			+ ".NUMBER_OF_PROCESSES";

	// public static final String NETWORK_TYPE = PTP_LAUNCH_ID +
	// ".COMMUNICATION";
	public static final String PROCESSES_PER_NODE = PTP_LAUNCH_ID
			+ ".NUMBER_OF_PROCESSES_START";

	public static final String FIRST_NODE_NUMBER = PTP_LAUNCH_ID
			+ ".NODE_NUMBER";

	public static final String ATTR_ARGUMENT = PTP_LAUNCH_ID + ".ARGUMENT_ATTR";

	public static final String ATTR_WORK_DIRECTORY = PTP_LAUNCH_ID
			+ ".WORK_DIRECTORY_ATTR";
