 ...
 * 
 */
public interface INodeProcessListener {
	
	/**
	 * @param e
	 */
	public void handleEvent(INodeChangedProcessEvent e);
	
	/**
	 * @param e
	 */
	public void handleEvent(INodeNewProcessEvent e);

	/**
	 * @param e
	 */
	public void handleEvent(INodeRemoveProcessEvent e);
}
