 ...
 *
 */
public class MachineRemoveNodeEvent implements IMachineRemoveNodeEvent {

	private final IPMachine machine;
	private final IPNode node;

	public MachineRemoveNodeEvent(IPMachine machine, IPNode node) {
		this.machine = machine;
		this.node = node;
	}

	/* (non-Javadoc)
	 * @see org.eclipse.ptp.core.elements.events.IMachineRemoveNodeEvent#getProcess()
	 */
