 ...
 *
 */
public class ModelManagerRemoveResourceManagerEvent implements IModelManagerRemoveResourceManagerEvent {

	private final IModelManager mm;
	private final IResourceManager rm;

	public ModelManagerRemoveResourceManagerEvent(IModelManager mm, IResourceManager rm) {
		this.mm = mm;
		this.rm = rm;
	}
