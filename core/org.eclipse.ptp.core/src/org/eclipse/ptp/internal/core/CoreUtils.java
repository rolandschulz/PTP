...
public class CoreUtils {
    ...
    public static void switchPerspectiveTo(final String perspectiveID) {
        Display.getDefault().syncExec(new Runnable() {
            public void run() {
                ...
                try {
                    bench.showPerspective(perspectiveID, PTPCorePlugin.getActiveWorkbenchWindow());
    ...
    public static IWorkbenchPage getActivePage() {
        return PTPCorePlugin.getDefault().getWorkbench().getActiveWorkbenchWindow().getActivePage();
    }
