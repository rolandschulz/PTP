 ...
 *
 */
public class ModelManagerNewResourceManagerEvent implements IModelManagerNewResourceManagerEvent {

	private final IModelManager mm;
	private final IResourceManager rm;

	public ModelManagerNewResourceManagerEvent(IModelManager mm, IResourceManager rm) {
		this.mm = mm;
		this.rm = rm;
	}
