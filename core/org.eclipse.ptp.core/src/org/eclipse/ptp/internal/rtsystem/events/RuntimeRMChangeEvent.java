...
public class RuntimeRMChangeEvent extends AbstractRuntimeChangeEvent implements IRuntimeRMChangeEvent {

	public RuntimeRMChangeEvent(ElementAttributeManager attrs) {
		super(attrs);
	}
}
