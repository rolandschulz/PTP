 ...
 *
 *****************************************************************************/
package org.eclipse.ptp.remote.remotetools.environment.conf;
...
public class AttributeNames extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.ptp.remote.remotetools.environment.conf.attribute_names"; //$NON-NLS-1$
