...
/* This is a version of the simulated runtime model that spawns simulated
 * jobs through Threads and has them do random things.  It's not great for
 * use as a simulation but good for a demo where we want to show off the
 * system without having to interact with it constantly.
 */
public class SimulationWithJobsRuntimeModel implements IRuntimeModel {
	...
	public SimulationWithJobsRuntimeModel() {
		nodeMap = new HashMap();
