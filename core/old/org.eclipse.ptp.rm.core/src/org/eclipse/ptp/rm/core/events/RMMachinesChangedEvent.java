 ...
 * 
 */
public class RMMachinesChangedEvent extends RMResourceManagerEvent {
	...
	/**
	 * @return list of added, modified, or removed machines
	 */
	public IRMMachine[] getMachines() {
		return (IRMMachine[]) machines.clone();
	}
}
