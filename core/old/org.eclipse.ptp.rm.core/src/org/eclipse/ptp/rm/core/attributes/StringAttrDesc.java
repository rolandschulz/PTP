...
/**
 * Create string-valued attributes
 * 
 * @author rsqrd
 * 
 */
public class StringAttrDesc extends AbstractAttrDesc {

	public StringAttrDesc(String name, String description) {
	...
	protected IAttrComponent doCreateAttribute(String attrString) {
		return new StringAttrComponent(attrString);
	}
