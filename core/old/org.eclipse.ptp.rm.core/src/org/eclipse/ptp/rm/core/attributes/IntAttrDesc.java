...
/**
 * Create integer-valued attributes
 * 
 * @author rsqrd
 * 
 */
public class IntAttrDesc extends AbstractAttrDesc {

	public IntAttrDesc(String name, String description) {
	...
	protected IAttrComponent doCreateAttribute(String attrString) {
		return new IntAttrComponent(attrString);
	}
