...
public class SimQueue extends AbstractSimElement implements IRMQueue {

	private RMStatus status;

	public SimQueue(int id, String name, RMStatus status, IAttribute[] attributes) {
		super(id, name, attributes);
		this.status = status;
	}

	public IRMNode[] getCanBeDispatchedTo() {
