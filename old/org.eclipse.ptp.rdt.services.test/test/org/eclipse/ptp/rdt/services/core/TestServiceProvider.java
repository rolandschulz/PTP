...
public class TestServiceProvider implements IServiceProvider, IServiceProviderConfiguration {
	...
	public String getId() {
		return "TestProvider1"; //$NON-NLS-1$
	}

	public String getName() {
		return "Test Provider 1"; //$NON-NLS-1$
	}
