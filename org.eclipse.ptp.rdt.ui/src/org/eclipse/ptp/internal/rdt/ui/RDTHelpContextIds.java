 ...
 * 
 * The string is the id of the help context in context_RDT.xml in org.eclipse.ptp.rdt.doc.user.
 * 
 * @author bergerm  
 */
public final class RDTHelpContextIds {
	...
	public static final String SERVICE_MODEL_PROPERTY_PAGE = PREFIX + "servce_model_property_page_context"; //$NON-NLS-1$
