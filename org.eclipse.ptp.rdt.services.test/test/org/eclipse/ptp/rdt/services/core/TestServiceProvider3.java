...
public class TestServiceProvider3 implements IServiceProvider, IServiceProviderConfiguration {
	...
	public String getId() {
		return "TestProvider3"; //$NON-NLS-1$
	}

	public String getName() {
		return "Test Provider 3"; //$NON-NLS-1$
	}

	public String getServiceId() {
		return "TestService2"; //$NON-NLS-1$
	}
