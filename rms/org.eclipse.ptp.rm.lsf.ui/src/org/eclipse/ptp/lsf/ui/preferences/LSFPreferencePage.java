...
import org.eclipse.ptp.lsf.ui.internal.ui.Messages;
...
public class LSFPreferencePage extends PreferencePage implements IWorkbenchPreferencePage, PreferenceConstants 
{
	public static final String EMPTY_STRING = "";

	protected Text proxyServerText = null;

	protected Button browseButton = null;
	protected Button fManualButton = null;

	private String proxyServerFile = EMPTY_STRING;

	private boolean loading = true;

	public LSFPreferencePage() {
	...
	protected class WidgetListener extends SelectionAdapter implements ModifyListener, IPropertyChangeListener 
	{
		...
		public void modifyText(ModifyEvent evt) {
			...
			if(!loading && source == proxyServerText)
				updatePreferencePage();
		}
	...
	private void createLSFContents(Composite parent)
	{
		...
		bGroup.setText(Messages.getString("LSFPreferencesPage.group_proxy"));
		
		new Label(bGroup, SWT.WRAP).setText("Enter the path to the PTP LSF proxy server.");
		
		Composite server = new Composite(bGroup, SWT.NONE);
		...
		new Label(server, SWT.NONE).setText(Messages
				.getString("LSFPreferencesPage.server_text"));
		...
		browseButton = SWTUtil.createPushButton(server, Messages
				.getString("LSFPreferencesPage.browseButton"), null);
		browseButton.addSelectionListener(listener);
		
		fManualButton = createCheckButton(parent, Messages.getString("LSFPreferencesPage.manual"));
	...
	private void store() 
	{
		proxyServerFile = proxyServerText.getText();
	}
	...
	public boolean performOk() 
	{
		...
		preferences.setValue(PreferenceConstants.LSF_PROXY_PATH, proxyServerFile);
		preferences.setValue(PreferenceConstants.LSF_LAUNCH_MANUALLY, fManualButton.getSelection());
	...
	protected void handlePathBrowseButtonSelected() 
	{
		...
		dialog.setText(Messages
				.getString("LSFPreferencesPage.Select_LSF_PROXY_FILE"));
		...
		if (selectedPath != null)
			proxyServerText.setText(selectedPath);
	}
	...
	protected boolean isValidSetting() 
	{
		...
		if (name == null) {
			setErrorMessage(Messages
					.getString("LSFPreferencesPage.Incorrect_server_file"));
			//setValid(false);
			//return false;
		}
		else {
