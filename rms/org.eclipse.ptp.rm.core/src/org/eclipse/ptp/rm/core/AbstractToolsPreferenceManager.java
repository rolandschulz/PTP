...
public class AbstractToolsPreferenceManager {
	...
	public static final String PREFS_CONTINUOUS_MONITOR_CMD = "continuousMonitorCmd";
	public static final String PREFS_REMOTE_INSTALL_PATH = "remoteInstallPAth";
	public static final String PREFS_USE_DEFAULTS = "useDefaults";
}
