...
// Generated on: 2011.03.07 at 11:53:45 AM CST 
//
...
@XmlType(name = "", propOrder = { "regex", "target", "setOrAddOrPut", "test" })
@XmlRootElement(name = "match")
public class Match {

	protected Regex regex;
	protected Target target;
	@XmlElements({ @XmlElement(name = "put", type = Put.class), @XmlElement(name = "add", type = Add.class),
