...
/**
 * 
 * A caveat on the foreground and background settings. They are exposed here but
 * may not work as expected: these are currently applied to the column through
 * the cell label provider; foreground seems not to change the font color but to
 * color the entire cell.
 * 
 * 
 * <p>
