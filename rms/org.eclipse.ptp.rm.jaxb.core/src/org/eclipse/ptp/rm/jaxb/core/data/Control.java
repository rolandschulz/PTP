 ...
 *         &lt;element name="attribute" type="{http://org.eclipse.ptp/rm}attribute" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *           &lt;element name="submit-debug-interactive" type="{http://org.eclipse.ptp/rm}command"/>
 *           &lt;element name="submit-debug-batch" type="{http://org.eclipse.ptp/rm}command"/>
 *         &lt;/choice>
...
@XmlType(name = "control", propOrder = { "property", "attribute", "managedFiles", "script", "startUpCommand",
		"submitInteractiveOrSubmitBatchOrSubmitDebugInteractive", "getJobStatus", "terminateJob", "suspendJob", "resumeJob",
		"holdJob", "releaseJob", "shutDownCommand", "launchTab" })
public class Control {
	...
	@XmlElementRefs({
			...
			@XmlElementRef(name = "submit-debug-batch", namespace = "http://org.eclipse.ptp/rm", type = JAXBElement.class),
			@XmlElementRef(name = "submit-batch", namespace = "http://org.eclipse.ptp/rm", type = JAXBElement.class),
			@XmlElementRef(name = "submit-debug-interactive", namespace = "http://org.eclipse.ptp/rm", type = JAXBElement.class) })
	protected List<JAXBElement<Command>> submitInteractiveOrSubmitBatchOrSubmitDebugInteractive;
	 ...
	 * submitInteractiveOrSubmitBatchOrSubmitDebugInteractive property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 ...
	 * 
	 * <pre>
	 * getSubmitInteractiveOrSubmitBatchOrSubmitDebugInteractive().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 ...
	 * {@link Command }{@code >} {@link JAXBElement }{@code <}{@link Command }
	 * {@code >}
	 * 
	 * 
	 */
	public List<JAXBElement<Command>> getSubmitInteractiveOrSubmitBatchOrSubmitDebugInteractive() {
		if (submitInteractiveOrSubmitBatchOrSubmitDebugInteractive == null) {
			submitInteractiveOrSubmitBatchOrSubmitDebugInteractive = new ArrayList<JAXBElement<Command>>();
		}
		return this.submitInteractiveOrSubmitBatchOrSubmitDebugInteractive;
	}
