 ...
 * to the job dimensions and requested resources. The value for attribute can by
 * any primitive type. NOTE: the untyped "value" element on attributes is for
...
@XmlType(name = "attribute-type", propOrder = { "description", "tooltip", "choice", "_default", "value", "validator" })
