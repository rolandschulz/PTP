 ...
 *       &lt;sequence>
 *         &lt;element name="arg" type="{http://eclipse.org/ptp/schemas}arg-type" maxOccurs="unbounded"/>
 *         &lt;element name="input" type="{http://eclipse.org/ptp/schemas}arg-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="environment" type="{http://eclipse.org/ptp/schemas}environment-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="stdout-parser" type="{http://eclipse.org/ptp/schemas}tokenizer-type" minOccurs="0"/>
 *         &lt;element name="stderr-parser" type="{http://eclipse.org/ptp/schemas}tokenizer-type" minOccurs="0"/>
 *         &lt;element name="redirect-parser" type="{http://eclipse.org/ptp/schemas}tokenizer-type" minOccurs="0"/>
 *         &lt;element name="pre-launch-cmd" type="{http://eclipse.org/ptp/schemas}simple-command-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="post-launch-cmd" type="{http://eclipse.org/ptp/schemas}simple-command-type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
