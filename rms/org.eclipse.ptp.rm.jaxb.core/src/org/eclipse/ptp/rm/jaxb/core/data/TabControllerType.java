...
@XmlType(name = "tab-controller-type", propOrder = { "title", "layout", "layoutData", "font", "tabFolderOrCompositeOrWidget" })
public class TabControllerType {
	...
	@XmlElements({ @XmlElement(name = "button-group", type = ButtonGroupType.class),
			@XmlElement(name = "widget", type = WidgetType.class), @XmlElement(name = "viewer", type = AttributeViewerType.class),
			@XmlElement(name = "composite", type = CompositeType.class), @XmlElement(name = "browse", type = BrowseType.class),
			@XmlElement(name = "tab-folder", type = TabFolderType.class), @XmlElement(name = "action", type = PushButtonType.class) })
	 ...
	 * {@link ButtonGroupType } {@link WidgetType } {@link AttributeViewerType }
	 * {@link CompositeType } {@link BrowseType } {@link TabFolderType }
	 * {@link PushButtonType }
	 * 
	 * 
	 */
