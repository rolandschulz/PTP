...
// Generated on: 2011.03.11 at 07:58:28 PM CST 
//
...
@XmlType(name = "test", propOrder = { "test", "value", "_if", "_else" })
public class Test {
	...
	public static class Else {
		...
		@XmlElements({ @XmlElement(name = "add", type = Add.class), @XmlElement(name = "put", type = Put.class),
				@XmlElement(name = "set", type = Set.class), @XmlElement(name = "append", type = Append.class) })
	 ...
	 * 
	 * @return possible object is {@link Test.If }
	 * 
	 */
	public Test.If getIf() {
		return _if;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Test.If }
	 * 
	 */
	public void setIf(Test.If value) {
		this._if = value;
	}
