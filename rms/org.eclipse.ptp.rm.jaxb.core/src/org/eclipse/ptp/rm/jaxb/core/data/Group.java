...
public class Group {
	...
	@XmlElements({ @XmlElement(name = "viewer", type = Viewer.class), @XmlElement(name = "group", type = Group.class),
			@XmlElement(name = "widget", type = Widget.class), @XmlElement(name = "tab-folder", type = TabFolder.class) })
	 ...
	 * {@link Group } {@link Widget } {@link TabFolder }
	 * 
	 * 
	 */
