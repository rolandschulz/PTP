...
public class Group {
	...
	@XmlElements({ @XmlElement(name = "widget", type = Widget.class), @XmlElement(name = "tab-folder", type = TabFolder.class),
			@XmlElement(name = "group", type = Group.class), @XmlElement(name = "viewer", type = Viewer.class) })
	 ...
	 * {@link TabFolder } {@link Group } {@link Viewer }
	 * 
	 * 
	 */
