...
public class Group {
	...
	@XmlElements({ @XmlElement(name = "widget", type = Widget.class), @XmlElement(name = "viewer", type = Viewer.class),
			@XmlElement(name = "tab-folder", type = TabFolder.class), @XmlElement(name = "group", type = Group.class) })
	 ...
	 * {@link Viewer } {@link TabFolder } {@link Group }
	 * 
	 * 
	 */
