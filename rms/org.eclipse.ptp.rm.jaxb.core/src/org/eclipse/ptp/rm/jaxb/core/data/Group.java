...
public class Group {
	...
	@XmlElements({ @XmlElement(name = "viewer", type = Viewer.class), @XmlElement(name = "tab-folder", type = TabFolder.class),
			@XmlElement(name = "group", type = Group.class), @XmlElement(name = "widget", type = Widget.class) })
	 ...
	 * {@link TabFolder } {@link Group } {@link Widget }
	 * 
	 * 
	 */
