...
public class CompositeType {
	...
	@XmlElements({ @XmlElement(name = "button-group", type = ButtonGroupType.class),
			@XmlElement(name = "browse", type = BrowseType.class), @XmlElement(name = "widget", type = WidgetType.class),
			@XmlElement(name = "tab-folder", type = TabFolderType.class),
			@XmlElement(name = "composite", type = CompositeType.class), @XmlElement(name = "action", type = PushButtonType.class),
	 ...
	 * {@link ButtonGroupType } {@link BrowseType } {@link WidgetType }
	 * {@link TabFolderType } {@link CompositeType } {@link PushButtonType }
