 ...
 *         &lt;/choice>
 *         &lt;choice minOccurs="0">
 *           &lt;element name="select-if" type="{http://org.eclipse.ptp/rm}control-state-rule-type" minOccurs="0"/>
 *           &lt;element name="deselect-if" type="{http://org.eclipse.ptp/rm}control-state-rule-type" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
@XmlType(name = "control-state-type", propOrder = { "showIf", "hideIf", "enableIf", "disableIf", "selectIf", "deselectIf" })
public class ControlStateType {
	...
	@XmlElement(name = "select-if")
	protected ControlStateRuleType selectIf;
	@XmlElement(name = "deselect-if")
	protected ControlStateRuleType deselectIf;

	/**
	 * Gets the value of the deselectIf property.
	 * 
	 * @return possible object is {@link ControlStateRuleType }
	 * 
	 */
	public ControlStateRuleType getDeselectIf() {
		return deselectIf;
	}
	 ...
	 * 
	 */
	public ControlStateRuleType getSelectIf() {
		return selectIf;
	}
	...
	/**
	 * Sets the value of the deselectIf property.
	 * 
	 * @param value
	 *            allowed object is {@link ControlStateRuleType }
	 * 
	 */
	public void setDeselectIf(ControlStateRuleType value) {
		this.deselectIf = value;
	}
	...
	/**
	 * Sets the value of the selectIf property.
	 * 
	 * @param value
	 *            allowed object is {@link ControlStateRuleType }
	 * 
	 */
	public void setSelectIf(ControlStateRuleType value) {
		this.selectIf = value;
	}
