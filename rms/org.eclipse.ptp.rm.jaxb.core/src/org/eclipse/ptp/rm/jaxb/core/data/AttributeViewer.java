 ...
 *       &lt;attribute name="tooltipOnName" type="{http://www.w3.org/2001/XMLSchema}boolean" default="true" />
...
public class AttributeViewer {
	...
	@XmlAttribute
	protected Boolean tooltipOnName;
	@XmlAttribute
	...
	/**
	 * Gets the value of the tooltipOnName property.
	 * 
	 * @return possible object is {@link Boolean }
	 * 
	 */
	public boolean isTooltipOnName() {
		if (tooltipOnName == null) {
			return true;
		} else {
			return tooltipOnName;
		}
	}
	...
	/**
	 * Sets the value of the tooltipOnName property.
	 * 
	 * @param value
	 *            allowed object is {@link Boolean }
	 * 
	 */
	public void setTooltipOnName(Boolean value) {
		this.tooltipOnName = value;
	}
