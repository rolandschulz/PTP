...
public class ObjectFactory {
	...
	private final static QName _ControlTypeSubmitDebugInteractive_QNAME = new QName("http://org.eclipse.ptp/rm", //$NON-NLS-1$
			"submit-debug-interactive"); //$NON-NLS-1$
	private final static QName _ControlTypeSubmitInteractive_QNAME = new QName("http://org.eclipse.ptp/rm", "submit-interactive"); //$NON-NLS-1$ //$NON-NLS-2$
	private final static QName _ControlTypeSubmitDebugBatch_QNAME = new QName("http://org.eclipse.ptp/rm", "submit-debug-batch"); //$NON-NLS-1$ //$NON-NLS-2$
	private final static QName _ControlTypeSubmitBatch_QNAME = new QName("http://org.eclipse.ptp/rm", "submit-batch"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link CommandType }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://org.eclipse.ptp/rm", name = "submit-batch", scope = ControlType.class)
	public JAXBElement<CommandType> createControlTypeSubmitBatch(CommandType value) {
		return new JAXBElement<CommandType>(_ControlTypeSubmitBatch_QNAME, CommandType.class, ControlType.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://org.eclipse.ptp/rm", name = "submit-debug-batch", scope = ControlType.class)
	public JAXBElement<CommandType> createControlTypeSubmitDebugBatch(CommandType value) {
		return new JAXBElement<CommandType>(_ControlTypeSubmitDebugBatch_QNAME, CommandType.class, ControlType.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://org.eclipse.ptp/rm", name = "submit-debug-interactive", scope = ControlType.class)
	public JAXBElement<CommandType> createControlTypeSubmitDebugInteractive(CommandType value) {
		return new JAXBElement<CommandType>(_ControlTypeSubmitDebugInteractive_QNAME, CommandType.class, ControlType.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://org.eclipse.ptp/rm", name = "submit-interactive", scope = ControlType.class)
	public JAXBElement<CommandType> createControlTypeSubmitInteractive(CommandType value) {
		return new JAXBElement<CommandType>(_ControlTypeSubmitInteractive_QNAME, CommandType.class, ControlType.class, value);
	}
