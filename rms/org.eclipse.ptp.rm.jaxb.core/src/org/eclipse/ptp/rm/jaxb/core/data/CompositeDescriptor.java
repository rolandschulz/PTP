...
@XmlType(name = "composite-descriptor", propOrder = { "layout", "layoutData", "font", "title", "tabFolderOrCompositeOrWidget" })
public class CompositeDescriptor {
	...
	@XmlElements({ @XmlElement(name = "viewer", type = AttributeViewer.class),
			@XmlElement(name = "composite", type = CompositeDescriptor.class), @XmlElement(name = "widget", type = Widget.class),
	 ...
	 * {@link AttributeViewer } {@link CompositeDescriptor } {@link Widget }
	 * {@link TabFolderDescriptor }
	 * 
	 * 
	 */
