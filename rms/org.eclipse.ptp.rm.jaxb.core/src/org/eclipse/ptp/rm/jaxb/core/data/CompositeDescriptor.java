...
@XmlType(name = "composite-descriptor", propOrder = { "gridData", "gridLayout", "title", "tabFolderOrCompositeOrWidget" })
public class CompositeDescriptor {
	...
	@XmlElements({ @XmlElement(name = "tab-folder", type = TabFolderDescriptor.class),
			@XmlElement(name = "viewer", type = AttributeViewer.class), @XmlElement(name = "widget", type = Widget.class),
	 ...
	 * {@link TabFolderDescriptor } {@link AttributeViewer } {@link Widget }
