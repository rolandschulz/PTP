 ...
 * provided to filter the unchecked items in the viewer. The viewer outputs its
 * selected values to the environment (and on update removes unselected ones).
 * The name of the viewer is also stored against a string of all selected
 * values, constructed from a template.
 * 
 * 
 * <p>
