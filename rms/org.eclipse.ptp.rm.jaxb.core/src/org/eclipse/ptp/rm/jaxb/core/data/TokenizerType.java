 ...
 *           &lt;element name="target" type="{http://eclipse.org/ptp/schemas}target-type" maxOccurs="unbounded"/>
 *         &lt;/choice>
 *         &lt;element name="exit-on" type="{http://eclipse.org/ptp/schemas}regex-type" minOccurs="0"/>
 *         &lt;element name="exit-after" type="{http://eclipse.org/ptp/schemas}regex-type" minOccurs="0"/>
 *       &lt;/sequence>
