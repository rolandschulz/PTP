...
// Generated on: 2011.06.15 at 06:09:12 PM CDT 
//
 ...
 * ${ptp_rm:name#getterName}; all properties and attributes defined in the
 * configuration are mapped. The following hard-coded variables are also added
 * at runtime:
 * 
 * control.user.name control.address control.working.dir
 * 
 * executablePath progArgs directory
 * 
 * control.queue.name stdout_remote_path stderr_remote_path
 * 
 * 
 * <p>
...
public class ControlType {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the managedFiles property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
