 ...
 *           &lt;element name="submit-debug-interactive" type="{http://org.eclipse.ptp/rm}command-type"/>
 *           &lt;element name="submit-debug-batch" type="{http://org.eclipse.ptp/rm}command-type"/>
 *         &lt;/choice>
...
public class ControlType {
	...
	protected List<JAXBElement<CommandType>> submitInteractiveOrSubmitBatchOrSubmitDebugInteractive;
	 ...
	 * 
	 */
	public List<JAXBElement<CommandType>> getSubmitInteractiveOrSubmitBatchOrSubmitDebugInteractive() {
		if (submitInteractiveOrSubmitBatchOrSubmitDebugInteractive == null) {
			submitInteractiveOrSubmitBatchOrSubmitDebugInteractive = new ArrayList<JAXBElement<CommandType>>();
		}
