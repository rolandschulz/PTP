 ...
 *         &lt;element name="button-action" type="{http://org.eclipse.ptp/rm}command-type" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "control-type", propOrder = { "property", "attribute", "managedFiles", "script", "startUpCommand",
		...
		"suspendJob", "resumeJob", "holdJob", "releaseJob", "shutDownCommand", "buttonAction", "launchTab" })
public class ControlType {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the buttonAction property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
