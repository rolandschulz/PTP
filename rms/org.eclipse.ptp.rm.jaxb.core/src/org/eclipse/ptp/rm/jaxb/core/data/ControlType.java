 ...
 *       &lt;sequence>
 *         &lt;element name="attribute" type="{http://eclipse.org/ptp/schemas}attribute-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="managed-files" type="{http://eclipse.org/ptp/schemas}managed-files-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="script" type="{http://eclipse.org/ptp/schemas}script-type" minOccurs="0"/>
 *         &lt;element name="start-up-command" type="{http://eclipse.org/ptp/schemas}command-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;choice minOccurs="0">
 *           &lt;sequence>
 *             &lt;element name="submit-interactive" type="{http://eclipse.org/ptp/schemas}command-type"/>
 *             &lt;element name="submit-interactive-debug" type="{http://eclipse.org/ptp/schemas}command-type" minOccurs="0"/>
 *           &lt;/sequence>
 *           &lt;sequence>
 *             &lt;element name="submit-batch" type="{http://eclipse.org/ptp/schemas}command-type"/>
 *             &lt;element name="submit-batch-debug" type="{http://eclipse.org/ptp/schemas}command-type" minOccurs="0"/>
 *           &lt;/sequence>
 *         &lt;/choice>
 *         &lt;element name="get-job-status" type="{http://eclipse.org/ptp/schemas}command-type" minOccurs="0"/>
 *         &lt;element name="terminate-job" type="{http://eclipse.org/ptp/schemas}command-type" minOccurs="0"/>
 *         &lt;element name="suspend-job" type="{http://eclipse.org/ptp/schemas}command-type" minOccurs="0"/>
 *         &lt;element name="resume-job" type="{http://eclipse.org/ptp/schemas}command-type" minOccurs="0"/>
 *         &lt;element name="hold-job" type="{http://eclipse.org/ptp/schemas}command-type" minOccurs="0"/>
 *         &lt;element name="release-job" type="{http://eclipse.org/ptp/schemas}command-type" minOccurs="0"/>
 *         &lt;element name="shut-down-command" type="{http://eclipse.org/ptp/schemas}command-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="button-action" type="{http://eclipse.org/ptp/schemas}command-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="launch-tab" type="{http://eclipse.org/ptp/schemas}launch-tab-type" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
