 ...
 *         &lt;element name="content" type="{http://org.eclipse.ptp/rm}arglist" minOccurs="0"/>
...
@XmlType(name = "widget", propOrder = { "label", "style", "tooltip", "content", "saveValueTo" })
public class Widget {

	protected String label;
	protected Style style;
	protected String tooltip;
	protected Arglist content;
	 ...
	 * 
	 */
	public void setContent(Arglist value) {
		this.content = value;
	}
