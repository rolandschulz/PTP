 ...
 *         &lt;element name="valueArgs" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "widget", propOrder = { "gridData", "label", "style", "tooltip", "valueArgs" })
public class Widget {
	...
	protected Widget.ValueArgs valueArgs;
	@XmlAttribute
	...
	/**
	 * Gets the value of the valueArgs property.
	 * 
	 * @return possible object is {@link Widget.ValueArgs }
	 * 
	 */
	public Widget.ValueArgs getValueArgs() {
		return valueArgs;
	}
	...
	/**
	 * Sets the value of the valueArgs property.
	 * 
	 * @param value
	 *            allowed object is {@link Widget.ValueArgs }
	 * 
	 */
	public void setValueArgs(Widget.ValueArgs value) {
