...
@XmlType(name = "match", propOrder = { "expression", "addOrAppendOrPut" })
public class Match {

	protected Regex expression;
	@XmlElements({ @XmlElement(name = "set", type = Set.class), @XmlElement(name = "add", type = Add.class),
			@XmlElement(name = "put", type = Put.class), @XmlElement(name = "append", type = Append.class) })
