...
public class TabItemDescriptor {
	...
	@XmlElements({ @XmlElement(name = "composite", type = CompositeDescriptor.class),
			@XmlElement(name = "widget", type = Widget.class), @XmlElement(name = "tab-folder", type = TabFolderDescriptor.class) })
	 ...
	 * {@link CompositeDescriptor } {@link Widget } {@link TabFolderDescriptor }
	 * 
	 * 
	 */
