...
import org.eclipse.ptp.rm.mpich2.core.rmsystem.MPICH2ResourceManager;

public class MPICH2RMLaunchConfigurationFactory extends
	...
	protected IRMLaunchConfigurationDynamicTab doCreate(IResourceManager rm) throws CoreException {
		return new MPICH2RMLaunchConfigurationDynamicTab(rm);
	}
