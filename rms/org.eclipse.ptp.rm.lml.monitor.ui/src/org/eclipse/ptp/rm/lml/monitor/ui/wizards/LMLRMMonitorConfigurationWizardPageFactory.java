 ...
 */
public class LMLRMMonitorConfigurationWizardPageFactory extends RMConfigurationWizardPageFactory {
	...
	public RMConfigurationWizardPage[] getPages(IRMConfigurationWizard wizard) {
		...
		pages.add(new LMLRMMonitorConfigurationWizardPage(wizard));
