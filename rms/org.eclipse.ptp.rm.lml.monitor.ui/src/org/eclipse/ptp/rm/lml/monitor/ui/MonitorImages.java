...
public class MonitorImages {
	...
	public static String IMG_STOPPED = NAME_PREFIX + "stopped.gif"; //$NON-NLS-1$
	public static String IMG_STARTED = NAME_PREFIX + "started.gif"; //$NON-NLS-1$

	public static final ImageDescriptor DESC_STOPPED = createManaged(T_TABS, IMG_STOPPED);
