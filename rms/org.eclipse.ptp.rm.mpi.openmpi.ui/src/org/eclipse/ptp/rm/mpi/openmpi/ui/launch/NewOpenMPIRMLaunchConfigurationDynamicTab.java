...
org.eclipse.ptp.launch.ui.extensions.AbstractRMLaunchConfigurationDynamicTab implements IRMLaunchConfigurationContentsChangedListener {
	...
	public IAttribute<?, ?, ?>[] getAttributes(IResourceManager rm,
		...
		for (AbstractRMLaunchConfigurationDynamicTab tabControl : tabControllers) {
			List<IAttribute<?, ?, ?>> attributesList = Arrays.asList(tabControl.getAttributes(rm, queue, configuration));
