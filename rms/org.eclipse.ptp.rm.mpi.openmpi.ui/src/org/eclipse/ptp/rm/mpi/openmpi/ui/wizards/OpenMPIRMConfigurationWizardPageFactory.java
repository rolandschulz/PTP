...
public class OpenMPIRMConfigurationWizardPageFactory extends RMConfigurationWizardPageFactory {
	...
	public RMConfigurationWizardPage[] getPages(IRMConfigurationWizard wizard) {
		return new RMConfigurationWizardPage[] { new OpenMPIRMConfigurationWizardPage(wizard),
