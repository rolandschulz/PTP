 ...
 * @since 5.0
 */
public class PBSResourceManagerFactory implements IResourceManagerFactory {
	...
	public IResourceManager create(IResourceManagerConfiguration configuration) {
		PBSResourceManagerControl control = new PBSResourceManagerControl(configuration);
		PBSResourceManagerMonitor monitor = new PBSResourceManagerMonitor(configuration);
		return new PBSResourceManager(configuration, control, monitor);
	}
