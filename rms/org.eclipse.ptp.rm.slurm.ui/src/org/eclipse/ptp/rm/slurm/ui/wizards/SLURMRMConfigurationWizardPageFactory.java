...
public class SLURMRMConfigurationWizardPageFactory extends RMConfigurationWizardPageFactory {
	...
	public RMConfigurationWizardPage[] getPages(IRMConfigurationWizard wizard) {
		...
		wizardPages[0] = new SLURMResourceManagerConfigurationWizardPage(wizard);
		return wizardPages;
	}
