 ...
 *
 */
public class SLURMServiceProviderConfigurationWizardPageFactory extends RMConfigurationWizardPageFactory {

	public SLURMServiceProviderConfigurationWizardPageFactory() {
		// no-op
	}

	@Override
	public RMConfigurationWizardPage[] getPages(IRMConfigurationWizard wizard) {
		return new RMConfigurationWizardPage[]{new SLURMResourceManagerConfigurationWizardPage(wizard)};
	}

	@Override
	public Class<? extends IResourceManagerFactory> getRMFactoryClass() {
		return SLURMServiceProviderFactory.class;
	}
}
