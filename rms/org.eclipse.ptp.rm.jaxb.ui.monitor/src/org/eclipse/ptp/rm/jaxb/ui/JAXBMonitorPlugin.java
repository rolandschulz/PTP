 ...
 */
public class JAXBMonitorPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.ptp.rm.jaxb.ui.monitor"; //$NON-NLS-1$

	// The shared instance
	private static JAXBMonitorPlugin plugin;

	/**
	 * The constructor
	 */
	public JAXBMonitorPlugin() {
	 ...
	 */
	public static JAXBMonitorPlugin getDefault() {
		return plugin;
	}
	...
	public static void log(Throwable e) {
		log(new Status(IStatus.ERROR, getUniqueIdentifier(), IStatus.ERROR, Messages.JAXBMonitorPlugin_Exception_InternalError, e));
	}
}
