 ...
 */
public class JAXBUIPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.ptp.internal.rm.jaxb.ui"; //$NON-NLS-1$

	// The shared instance
	private static JAXBUIPlugin plugin;
	 ...
	 */
	public static JAXBUIPlugin getDefault() {
		return plugin;
	}
