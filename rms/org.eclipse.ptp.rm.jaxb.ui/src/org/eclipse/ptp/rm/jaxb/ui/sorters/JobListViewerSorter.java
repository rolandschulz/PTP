 ...
 * 
 */
public class JobListViewerSorter extends ViewerSorter implements IJAXBUINonNLSConstants {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		PersistentCommandJobStatus st1 = (PersistentCommandJobStatus) o1;
		PersistentCommandJobStatus st2 = (PersistentCommandJobStatus) o2;
		...
		case 2:
			...
			break;
		case 4:
			s1 = ZEROSTR + st1.getOutReady();
			s2 = ZEROSTR + st2.getOutReady();
			break;
		case 5:
			s1 = ZEROSTR + st1.getErrReady();
			s2 = ZEROSTR + st2.getErrReady();
			break;
		default:
		}
