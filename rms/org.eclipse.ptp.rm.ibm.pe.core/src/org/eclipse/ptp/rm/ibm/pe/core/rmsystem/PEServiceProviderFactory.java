 ...
 *
 */
public class PEServiceProviderFactory extends AbstractResourceManagerFactory {

	public static final String RM_FACTORY_ID = "org.eclipse.ptp.rm.ibm.pe.resourcemanager"; //$NON-NLS-1$
	
	private static final String LAUNCH_SERVICE = "org.eclipse.ptp.core.LaunchService"; //$NON-NLS-1$
	private static final String PE_SERVICE_PROVIDER = "org.eclipse.ptp.rm.ibm.pe.PEServiceProvider"; //$NON-NLS-1$
	...
	public IResourceManagerControl create(IResourceManagerConfiguration config) {
		...
		return new PEResourceManager(Integer.valueOf(universe.getNextResourceManagerId()), universe, config);
	}
	...
	public IResourceManagerConfiguration createConfiguration() {
		IServiceConfiguration config = fServiceManager.newServiceConfiguration("IBM PE"); //$NON-NLS-1$
