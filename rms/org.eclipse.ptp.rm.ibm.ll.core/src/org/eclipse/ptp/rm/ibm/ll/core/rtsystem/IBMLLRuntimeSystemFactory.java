...
public class IBMLLRuntimeSystemFactory implements IRuntimeSystemFactory {
	...
	public IRuntimeSystem create(IResourceManager rm) {
		...
		return new IBMLLRuntimeSystem(new IBMLLProxyRuntimeClient((IIBMLLResourceManagerConfiguration) rm.getConfiguration(),
				baseId));
	}
}
