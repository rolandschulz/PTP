...
public class ViewerUpdateModel extends AbstractUpdateModel implements ICheckStateListener, SelectionListener {
	 ...
	 */
	public ViewerUpdateModel(String name, boolean initialAllChecked, IUpdateHandler handler, ICheckable viewer,
	 ...
	 * 
	 * @see org.eclipse.ptp.internal.rm.jaxb.ui.model.AbstractUpdateModel#storeValue()
	 */
	@SuppressWarnings("unchecked")
