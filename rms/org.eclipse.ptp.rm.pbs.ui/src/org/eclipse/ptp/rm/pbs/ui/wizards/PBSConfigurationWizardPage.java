...
public class PBSConfigurationWizardPage extends RMConfigurationWizardPage {
	...
	protected void handlePathBrowseButtonSelected() {
		...
		if (connection != null) {
					...
					public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
						try {
							...
							ErrorDialog.openError(getShell(), Messages.PBSConfigurationWizardPage_connection_error,
									Messages.PBSConfigurationWizardPage_connection_error_msg, new Status(IStatus.ERROR,
											PBSUIPlugin.PLUGIN_ID, e.getMessage()));
						}
					}
			...
			String selectedPath = fileMgr.browseFile(getControl().getShell(), Messages.PBSConfigurationWizardPage_select,
