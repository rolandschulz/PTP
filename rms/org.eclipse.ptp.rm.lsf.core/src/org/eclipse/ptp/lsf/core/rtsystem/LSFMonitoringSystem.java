...
public class LSFMonitoringSystem implements IMonitoringSystem, IProxyRuntimeEventListener {

	protected List listeners = new ArrayList(2);
	
	private LSFProxyRuntimeClient proxy = null;
	private boolean proxyDead = true;
	
	public boolean isHealthy() { return !proxyDead; }

	public LSFMonitoringSystem(LSFProxyRuntimeClient proxy) {
		this.proxy = proxy;
	...
	public void startup() {
		System.out.println("LSFMonitoringSystem startup()");
	}

	public void shutdown() {
		System.out.println("LSFMonitoringSystem shutdown()");
		listeners.clear();
		listeners = null;
	}
	...
	public void initiateDiscovery() throws CoreException {
		...
		System.out.println("LSFMonitoringSystem: initiateDiscovery phase");
		try {
    ...
    public synchronized void handleEvent(IProxyRuntimeEvent e) {
        //System.out.println("LSFMonitoringSystem got event: " + e.toString());
