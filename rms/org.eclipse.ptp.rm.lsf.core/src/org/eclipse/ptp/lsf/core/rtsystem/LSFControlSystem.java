...
public class LSFControlSystem implements IControlSystem, IProxyRuntimeEventListener {
	...
	public LSFControlSystem(LSFProxyRuntimeClient proxy) {
		this.proxy = proxy;
...
// TODO		argList.add(Integer.toString(jobRunConfig.getFirstNodeNumber()));
	...
	public void shutdown() {
		System.out.println("LSFControlSystem: shutdown() called");
		listeners.clear();
		listeners = null;
	}
