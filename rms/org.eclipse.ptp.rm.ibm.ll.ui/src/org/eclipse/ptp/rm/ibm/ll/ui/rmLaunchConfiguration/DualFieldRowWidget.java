...
public class DualFieldRowWidget implements ValidationState {
	...
	private class EventMonitor implements ModifyListener {
		...
		/**
		 * Set the non-default indicator to '*' if the data value for this
		 * object does not match the default value from the attribute definition
		 * 
		 * @param e
		 *            The event indicating value has changed
		 */
	...
	/**
	 * This class implements a widget containing two text fields laid out
	 * horizontally. The intended use is for attributes which may have two
	 * values, such as MP_BUFFER_SIZE, so that each field can be handled and
	...
	private class DualField {
		...
		/**
		 * Add a ModifyListener that will monitor the Text field for
		 * modifications
		 * 
		 * @param listener
		 *            The ModifyListener
		 ...
		 * 
		 * @param tip1
		 *            Tooltip text for first field
		 * @param tip2
		 *            Tooltip text for second field
		 */
	...
	/**
	 * Create a widget with two text entry fields representing the two
	 * sub-fields required by this widget. This class assumes that the layout
	 * set for the parent Composite object is a GridLayout with four columns.
	 * 
	 * @param parent
	 *            The parent widget
	 * @param id1
	 *            The attribute name for the first field in this widget
	 * @param id2
	 *            The attribute name for the second field in this widget
	 * @param def1
	 *            The attribute definition for the first field in this widget
	 * @param def2
	 *            The attribute definition for the second field in this widget
	 */
	 ...
	 * 
	 * @param value1
	 *            First text object's value
	 * @param value2
	 *            Second text object's value
	 */
	...
	/**
	 * Get the data object (the attribute name) associated with the first Text
	 * widget in this object
	 * 
	...
	/**
	 * Get the data object (the attribute name) associated with the second Text
	 * widget in this object
	 * 
	 * @return The attribute name
	 */
	...
	/**
	 * Return a String array containing the values from the two Text objects
	 * contained in this object
	 * 
	 * @return Two element array containing the value from the two Text widgets
	 *         contained in this object
	 */
