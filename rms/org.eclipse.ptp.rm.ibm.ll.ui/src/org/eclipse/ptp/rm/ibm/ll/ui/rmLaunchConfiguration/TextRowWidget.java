...
public class TextRowWidget implements ValidationState {
	...
	/**
	 * Internal class which listens for events indicating the data value for
	...
	private class EventMonitor implements ModifyListener {
		...
		/**
		 * Change the non-default value indicator for this object to indicate
		 * whether the data value matches the default value from the attribute
		 * definition
		 * 
		 * @param e
		 *            The event indicating data value has changed
		 */
	...
	/**
	 * Create a widget which is used as a text entry field in the launch
	 * configuration. This class assumes that the layout manager set for the
	 * parent Composite object is a GridLayout widget with 4 columns
	 * 
	 * @param parent
	 *            The parent Composite object
	 * @param id
	 *            The name of the attribute for this widget
	 * @param def
	 ...
	 * 
	 * @param key
	 *            The key to use in retrieving the data object
