...
public class BooleanRowWidget implements ValidationState {
	...
	private final StringSetAttributeDefinition attrDef;
	private final BooleanOption widget;
	private String defaultValue;
	private final EventMonitor eventMonitor;
	private int validationState;

	/**
	 * Internal listener class for events needed for notification of changes in
	 * data value for this widget
	 * 
	 */
	private class EventMonitor implements SelectionListener {
		...
		/**
		 * Set the non-default value indicator if the widget's value does not
		 * match the attribute's default value
		 * 
		 * @param e
		 *            The selection event indicating this object was clicked
		 */
	...
	private class BooleanOption {
		...
		/**
		 * Create a radio button pair for use in selecting a boolean option.
		 * This object is a container for a pair of radio buttons in a group
		 * box.
		 * 
		 * @param parent
		 *            The parent widget for this object
		 * @param labels
		 *            A list of two labels used to label the radio buttons
		 */
		...
		/**
		 * Set the tooltip text for the object. The tooltip text is set on the
		 * group object
		 * 
		 * @param text
		 *            The tooltip text
		...
		/**
		 * Set the selection state. The button with text matching the value
		 * string is set selected
		 * 
		 * @param value
		...
		/**
		 * Get the value for the selected button. The value returned is the
		 * label for the selected button.
		 * 
		...
		/**
		 * Set the enable state for the Button objects in this object to the
		 * specified state
		 * 
		 * @param state
		 *            Enable state for this widget
		 */
		...
		/**
		 * Set the 'data object' as if we were setting the ATTR_NAME object for
		 * a Widget object.
		 * 
		 * @param value
		 *            - The value to be set
		...
		/**
		 * Return the 'data object' as if we were retrieving the ATTR_NAME
		 * object for a Widget object
		 * 
		...
		/**
		 * Add a selection listener to the Button objects contained in this
		 * object
		 * 
		 * @param listener
	...
	/**
	 * Create the widgets contained within this row. This class assumes that the
	 * layout manager for the Composite parent is a GridLayout with four
	 * columns.
	 * 
	 * @param parent
	 *            The Composite object that contains this widget
	 * @param id
	 *            The attribute name for this widget
	 * @param def
	 *            The attribute definition for this widget
	 */
	...
	/**
	 * Add a selection listener to this object. This method is a wrapper that
	 * just calls addSelectionListener for the BooleanOption widget contained in
	 * this class
	 * 
	 * @param listener
	 *            The selection listener
	...
	/**
	 * Set the enable state for the BooleanOption object contained in this
	 * object
	 * 
	 * @param state
	 *            The enable state
	...
	/**
	 * Set the value for the BooleanOption object contained in this object. The
	 * result is that the radio button with label text matching the value
	 * parameter is set selected.
	 * 
	 * @param value
	 *            The value to set
	 */
	...
	/**
	 * Get the value of the BooleanOption object contained in this object. THe
	 * returned value is the label text of the radio button in selected state.
	 * 
	...
	/**
	 * Return status indicating that the actual widget contained in this object
	 * is the widget that is being searched for
	 * 
	 * @param source
	 *            - The widget that is being searched for
	...
	/**
	 * Set this object's validation state to indicate that the value is in error
	 * and must be validated again
	 */
	...
	/**
	 * Set this object's validation state to indicate the value has changed and
