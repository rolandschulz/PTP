 ...
 * 
 * <p>
 * Java class for colordefinition_type complex type.
 * 
 * <p>
...
public class ColordefinitionType {
	 ...
	 * returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the colorname
	 * property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ColorconstantType }
	 * 
	 * 
	 */
