...
/**
 * <p>
 * Java class for layout_root complex type.
 * 
 * <p>
...
public class LayoutRoot {
	 ...
	 * textlayoutAndInfoboxlayoutAndTablelayout property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link NodedisplaylayoutType }{@code >}
	 * {@link JAXBElement }{@code <}{@link SplitlayoutType }{@code >} {@link JAXBElement }{@code <}{@link InfoboxlayoutType }{@code >}
	 * {@link JAXBElement }{@code <}{@link TablelayoutType }{@code >} {@link JAXBElement }{@code <}{@link ChartlayoutType }{@code >}
	 * {@link JAXBElement }{@code <}{@link InfoboxlayoutType }{@code >} {@link JAXBElement }{@code <}{@link UsagebarlayoutType }{@code >}
