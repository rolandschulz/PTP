 ...
 * 
 * <p>
 * Java class for lgui_type complex type.
 * 
 * <p>
...
public class LguiType {
	 ...
	 * objectsAndRelationsAndInformation property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link UsagebarType }{@code >}
	 * {@link JAXBElement }{@code <}{@link ChartgroupType }{@code >} {@link JAXBElement }{@code <}{@link ChartlayoutType }{@code >}
	 * {@link JAXBElement }{@code <}{@link TextboxType }{@code >} {@link JAXBElement }{@code <}{@link SplitlayoutType }{@code >}
	 * {@link JAXBElement }{@code <}{@link ObjectsType }{@code >} {@link JAXBElement }{@code <}{@link InformationType }{@code >}
	 * {@link JAXBElement }{@code <}{@link InfoboxlayoutType }{@code >} {@link JAXBElement }{@code <}{@link AbslayoutType }{@code >}
	 * {@link JAXBElement }{@code <}{@link ChartType }{@code >} {@link JAXBElement }{@code <}{@link TableType }{@code >}
	 * {@link JAXBElement }{@code <}{@link UsagebarlayoutType }{@code >} {@link JAXBElement }{@code <}{@link InfoboxType }{@code >}
	 * {@link JAXBElement }{@code <}{@link RelationsType }{@code >} {@link JAXBElement }{@code <}{@link Nodedisplay }{@code >}
	 * {@link JAXBElement }{@code <}{@link TablelayoutType }{@code >} {@link JAXBElement }{@code <}{@link InfoboxlayoutType }{@code >}
