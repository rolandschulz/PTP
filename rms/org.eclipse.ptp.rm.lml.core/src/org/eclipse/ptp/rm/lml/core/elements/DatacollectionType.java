 ...
 * 
 * <p>
 * Java class for datacollection_type complex type.
 * 
 * <p>
...
public class DatacollectionType {
	 ...
	 * returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the pAndR
	 * property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link DatarectType } {@link DatapointType }
	 * 
	 * 
	 */
