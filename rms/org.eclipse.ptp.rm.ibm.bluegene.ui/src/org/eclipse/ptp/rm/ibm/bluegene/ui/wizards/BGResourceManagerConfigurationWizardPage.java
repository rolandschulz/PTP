...
public final class BGResourceManagerConfigurationWizardPage extends
	...
	public BGResourceManagerConfigurationWizardPage(RMConfigurationWizard wizard) {
		super(wizard, "Blue Gene Proxy Configuration");
		setTitle("Blue Gene Proxy Configuration");
		setDescription("Enter information to connect to a Blue Gene proxy server");
	}
}
