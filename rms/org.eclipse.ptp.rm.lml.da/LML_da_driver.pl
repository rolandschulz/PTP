...
sub exit_witherror {
    ...
    $xmlout.="<lml:lgui xmlns:lml=\"http://eclipse.org/ptp/schemas\"\n";
    $xmlout.="          xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n";
    $xmlout.="          version=\"1\" xsi:schemaLocation=\"http://eclipse.org/ptp/schemas http://eclipse.org/ptp/schemas/lgui.xsd\">\n";
    $xmlout.=" <objects>\n";
