...
//	private final static String remoteProjectName = "eclipse_auto";
	...
	public UnisonRemoteSyncConnection(IRemoteConnection conn, String localDir, String remoteDir, SyncFileFilter filter,
	...
	private void synchronize(IProgressMonitor monitor){
		try{
			...
			//p.waitFor();
			executeLocalCommandWithConnection(tempArray, serverSocket);
			serverSocket.close();
		} catch (IOException e){
			e.printStackTrace();
