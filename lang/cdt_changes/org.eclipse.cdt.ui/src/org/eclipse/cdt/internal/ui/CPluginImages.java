...
public class CPluginImages {
	...
	public static final String IMG_OBJS_TUNIT_FORTRAN= NAME_PREFIX + "f_file_obj.gif"; //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_OBJS_TUNIT_FORTRAN= createManaged(T_OBJ, IMG_OBJS_TUNIT_FORTRAN);
	...
	public static final ImageDescriptor DESC_WIZABAN_NEW_PROJ= create(T_WIZBAN, "newmprj_wiz.gif"); //$NON-NLS-1$
	...
	public static final String IMG_OBJS_SEARCHPROJECT = NAME_PREFIX + "mmprojects.gif";  //$NON-NLS-1$
