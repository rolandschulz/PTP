// $ANTLR 3.0b4 fortran.g 2006-10-17 13:46:00
...
public class FortranLexer extends Lexer {
    ...
    public void mT_CHAR_CONSTANT() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3160:11: ( '\\'' ( Rep_Char )* '\\'' | '\\\"' ( Rep_Char )* '\\\"' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // fortran.g:3160:11: '\\'' ( Rep_Char )* '\\''
                    {
                    match('\''); 
                    // fortran.g:3160:16: ( Rep_Char )*
                    loop1:
                    do {
                        int alt1=2;
                    ...
                    break;
                case 2 :
                    // fortran.g:3161:11: '\\\"' ( Rep_Char )* '\\\"'
                    {
                    match('\"'); 
                    // fortran.g:3161:16: ( Rep_Char )*
                    loop2:
                    do {
                        int alt2=2;
    ...
    public void mBINARY_CONSTANT() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3170:7: ( ('b'|'B') '\\'' ( '0' .. '1' )+ '\\'' | ('b'|'B') '\\\"' ( '0' .. '1' )+ '\\\"' )
            int alt6=2;
    ...
    public void mOCTAL_CONSTANT() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3176:7: ( ('o'|'O') '\\'' ( '0' .. '7' )+ '\\'' | ('o'|'O') '\\\"' ( '0' .. '7' )+ '\\\"' )
            int alt9=2;
    ...
    public void mHEX_CONSTANT() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3182:7: ( ('z'|'Z') '\\'' ( Digit | 'a' .. 'f' | 'A' .. 'F' )+ '\\'' | ('z'|'Z') '\\\"' ( Digit | 'a' .. 'f' | 'A' .. 'F' )+ '\\\"' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // fortran.g:3182:7: ('z'|'Z') '\\'' ( Digit | 'a' .. 'f' | 'A' .. 'F' )+ '\\''
                    {
                    ...
                    match('\''); 
                    // fortran.g:3182:22: ( Digit | 'a' .. 'f' | 'A' .. 'F' )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=4;
                    ...
                    break;
                case 2 :
                    // fortran.g:3183:7: ('z'|'Z') '\\\"' ( Digit | 'a' .. 'f' | 'A' .. 'F' )+ '\\\"'
                    {
                    if ( input.LA(1)=='Z'||input.LA(1)=='z' ) {
                        input.consume();
                    ...
                    match('\"'); 
                    // fortran.g:3183:22: ( Digit | 'a' .. 'f' | 'A' .. 'F' )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=4;
    ...
    public void mREAL_CONSTANT() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3187:4: ( Significand ( E_Exponent )? | Digit_String E_Exponent )
            int alt14=2;
            alt14 = dfa14.predict(input);
            switch (alt14) {
                case 1 :
                    // fortran.g:3187:4: Significand ( E_Exponent )?
                    {
                    mSignificand(); 
                    // fortran.g:3187:16: ( E_Exponent )?
                    int alt13=2;
                    ...
                    break;
                case 2 :
                    // fortran.g:3188:4: Digit_String E_Exponent
                    {
                    mDigit_String(); 
                    mE_Exponent(); 
    ...
    public void mDOUBLE_CONSTANT() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3192:4: ( Significand D_Exponent | Digit_String D_Exponent )
            int alt15=2;
            alt15 = dfa15.predict(input);
            switch (alt15) {
                case 1 :
                    // fortran.g:3192:4: Significand D_Exponent
                    {
                    mSignificand(); 
                    mD_Exponent(); 
                    ...
                    break;
                case 2 :
                    // fortran.g:3193:4: Digit_String D_Exponent
                    {
                    mDigit_String(); 
                    mD_Exponent(); 
    ...
    public void mSignificand() throws RecognitionException {
        try {
            ruleNestingLevel++;
            // fortran.g:3210:9: ( Digit_String '.' ( Digit_String )? | '.' Digit_String )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // fortran.g:3210:9: Digit_String '.' ( Digit_String )?
                    {
                    mDigit_String(); 
                    match('.'); 
                    // fortran.g:3210:26: ( Digit_String )?
                    int alt17=2;
                    ...
                    switch (alt17) {
                        case 1 :
                            // fortran.g:3210:28: Digit_String
                            {
                            mDigit_String(); 
    ...
    public void mAlphanumeric_Character() throws RecognitionException {
        try {
            ruleNestingLevel++;
            // fortran.g:3222:26: ( Letter | Digit | '_' )
            int alt23=3;
            switch ( input.LA(1) ) {
            case 'A':
            case 'B':
    ...
    public void mT_ASYNCHRONOUS() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3298:25: ( 'ASYNCHRONOUS' )
            // fortran.g:3298:25: 'ASYNCHRONOUS'
            {
            match("ASYNCHRONOUS"); 
    ...
    public void mT_DOUBLEPRECISION() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3318:25: ( 'DOUBLEPRECISION' )
            // fortran.g:3318:25: 'DOUBLEPRECISION'
            {
    ...
    public void mT_NON_INTRINSIC() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3354:25: ( 'NON_INTRINSIC' )
            // fortran.g:3354:25: 'NON_INTRINSIC'
            {
            match("NON_INTRINSIC"); 
    ...
    public void mT_NON_OVERRIDABLE() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3355:25: ( 'NON_OVERRIDABLE' )
            // fortran.g:3355:25: 'NON_OVERRIDABLE'
            {
    ...
    public void mT_ENDASSOCIATE() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3404:25: ( 'ENDASSOCIATE' )
            // fortran.g:3404:25: 'ENDASSOCIATE'
            {
            match("ENDASSOCIATE"); 
    ...
    public void mT_ENDBLOCKDATA() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3406:25: ( 'ENDBLOCKDATA' )
            // fortran.g:3406:25: 'ENDBLOCKDATA'
            {
            match("ENDBLOCKDATA"); 
    ...
    public void mT_ENDINTERFACE() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3413:25: ( 'ENDINTERFACE' )
            // fortran.g:3413:25: 'ENDINTERFACE'
            {
            match("ENDINTERFACE"); 
    ...
    public void mT_ENDSUBROUTINE() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3417:25: ( 'ENDSUBROUTINE' )
            // fortran.g:3417:25: 'ENDSUBROUTINE'
            {
            match("ENDSUBROUTINE"); 
    ...
    public void mT_DEFINED_OP() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3426:10: ( '.' ( Letter )+ '.' )
            // fortran.g:3426:10: '.' ( Letter )+ '.'
            {
            match('.'); 
            // fortran.g:3426:14: ( Letter )+
            int cnt24=0;
            loop24:
            do {
                int alt24=2;
    ...
    public void mT_LABEL_DO_TERMINAL() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3437:4: ( 'LABEL_DO_TERMINAL' )
            // fortran.g:3437:4: 'LABEL_DO_TERMINAL'
            {
    ...
    public void mT_STMT_FUNCTION() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3441:4: ( 'STMT_FUNCTION' )
            // fortran.g:3441:4: 'STMT_FUNCTION'
            {
            match("STMT_FUNCTION"); 
    ...
    public void mT_IDENT() throws RecognitionException {
        try {
            ...
            int charPosition = getCharPositionInLine();
            int channel = Token.DEFAULT_CHANNEL;
            // fortran.g:3447:4: ( Letter ( Alphanumeric_Character )* )
            // fortran.g:3447:4: Letter ( Alphanumeric_Character )*
            {
            mLetter(); 
            // fortran.g:3447:11: ( Alphanumeric_Character )*
            loop25:
            do {
                int alt25=2;
                ...
                switch (alt25) {
            	case 1 :
            	    // fortran.g:3447:13: Alphanumeric_Character
            	    {
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt28) {
            ...
            case 2 :
                ...
                break;
            case 3 :
                // fortran.g:1:21: T_CHAR_CONSTANT
                {
                mT_CHAR_CONSTANT(); 
            ...
            case 4 :
                ...
                break;
            case 5 :
                // fortran.g:1:52: BINARY_CONSTANT
                {
                mBINARY_CONSTANT(); 
            ...
            case 8 :
                ...
                break;
            case 9 :
                // fortran.g:1:110: DOUBLE_CONSTANT
                {
                mDOUBLE_CONSTANT(); 
            ...
            case 18 :
                ...
                break;
            case 19 :
                // fortran.g:1:209: T_GREATERTHAN_EQ
                {
                mT_GREATERTHAN_EQ(); 
            ...
            case 57 :
                ...
                break;
            case 58 :
                // fortran.g:1:564: T_ASYNCHRONOUS
                {
                mT_ASYNCHRONOUS(); 
            ...
            case 77 :
                ...
                break;
            case 78 :
                // fortran.g:1:758: T_DOUBLEPRECISION
                {
                mT_DOUBLEPRECISION(); 
            ...
            case 113 :
                ...
                break;
            case 114 :
                // fortran.g:1:1093: T_NON_INTRINSIC
                {
                mT_NON_INTRINSIC(); 
                ...
                break;
            case 115 :
                // fortran.g:1:1109: T_NON_OVERRIDABLE
                {
                mT_NON_OVERRIDABLE(); 
            ...
            case 150 :
                ...
                break;
            case 151 :
                // fortran.g:1:1454: T_UNFORMATTED
                {
                mT_UNFORMATTED(); 
            ...
            case 158 :
                ...
                break;
            case 159 :
                // fortran.g:1:1524: T_BIND_LPAREN_C
                {
                mT_BIND_LPAREN_C(); 
                ...
                break;
            case 160 :
                // fortran.g:1:1540: T_ENDASSOCIATE
                {
                mT_ENDASSOCIATE(); 
            ...
            case 161 :
                ...
                break;
            case 162 :
                // fortran.g:1:1566: T_ENDBLOCKDATA
                {
                mT_ENDBLOCKDATA(); 
            ...
            case 166 :
                ...
                break;
            case 167 :
                // fortran.g:1:1621: T_ENDFUNCTION
                {
                mT_ENDFUNCTION(); 
            ...
            case 168 :
                ...
                break;
            case 169 :
                // fortran.g:1:1643: T_ENDINTERFACE
                {
                mT_ENDINTERFACE(); 
            ...
            case 172 :
                ...
                break;
            case 173 :
                // fortran.g:1:1695: T_ENDSUBROUTINE
                {
                mT_ENDSUBROUTINE(); 
            ...
            case 177 :
                ...
                break;
            case 178 :
                // fortran.g:1:1751: T_ID_OR_OTHER
                {
                mT_ID_OR_OTHER(); 
                ...
                break;
            case 179 :
                // fortran.g:1:1765: T_LABEL_DO_TERMINAL
                {
                ...
                break;
            case 180 :
                // fortran.g:1:1785: T_STMT_FUNCTION
                {
                mT_STMT_FUNCTION(); 
