 ...
 * @author aniefer
 */
public class FortranParameter extends PlatformObject implements IParameter {
	...
	public FortranParameter( IASTName parameterName ){
	...
	public String getName() {
	    ...
	    return FortranVisitor.EMPTY_STRING;
	}
	public char[] getNameCharArray(){
	    IASTName name = getPrimaryDeclaration();
	    if( name != null )
	        return name.toCharArray();
	    return FortranVisitor.EMPTY_CHAR_ARRAY;
	}
