...
import org.eclipse.cldt.internal.core.ProcessClosure;
import org.eclipse.cldt.utils.spawner.EnvironmentReader;
...
public class CommandLauncher {
	...
	public int waitAndRead(OutputStream output, OutputStream err, IProgressMonitor monitor) {
		...
		if (monitor.isCanceled()) {
			...
			setErrorMessage(CommonLanguageCore.getResourceString("CommandLauncher.error.commandCanceled")); //$NON-NLS-1$
		}
