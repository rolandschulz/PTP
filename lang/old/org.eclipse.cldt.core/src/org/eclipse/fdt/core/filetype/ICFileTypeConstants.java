...
***********************************************************************/
package org.eclipse.fdt.core.filetype;
...
public interface ICFileTypeConstants {
	...
	public static String ID_PREFIX		= "org.eclipse.fdt.core."; //$NON-NLS-1$
	
	// Default languages known to FDT
	...
	// Default file types known to FDT
