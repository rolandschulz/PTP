...
public class CDescriptorEvent extends EventObject {
	...
	public static final int FDTPROJECT_CHANGED = 1;
	public static final int FDTPROJECT_ADDED = 2;
	public static final int FDTPROJECT_REMOVED = 3;
	...
	public String toString() {
		...
		switch (getType()) {
			case FDTPROJECT_ADDED :
				buf.append("FDTPROJECT_ADDED"); //$NON-NLS-1$
				break;
			case FDTPROJECT_REMOVED :
				buf.append("FDTPROJECT_REMOVED"); //$NON-NLS-1$
				break;
			case FDTPROJECT_CHANGED :
				buf.append("FDTPROJECT_CHANGED"); //$NON-NLS-1$
				break;
		}
