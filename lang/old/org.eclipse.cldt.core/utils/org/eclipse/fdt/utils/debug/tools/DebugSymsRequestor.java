...
import org.eclipse.fdt.utils.debug.DebugVariableKind;
...
public class DebugSymsRequestor implements IDebugEntryRequestor {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#enterCompilationUnit(java.lang.String, long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#exitCompilationUnit(long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#enterInclude(java.lang.String)
	 */
	public void enterInclude(String name) {
	}

	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#exitInclude()
	 */
	public void exitInclude() {
	}

	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#enterFunction(java.lang.String, int, boolean, long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#exitFunction(long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#enterCodeBlock(long)
	 */
	public void enterCodeBlock(long offset) {
	}

	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#exitCodeBlock(long)
	 */
	public void exitCodeBlock(long offset) {
	}

	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#acceptStatement(int, long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#acceptIntegerConst(java.lang.String, long)
	 */
	public void acceptIntegerConst(String name, int value) {
	}

	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#acceptFloatConst(java.lang.String, double)
	 */
	public void acceptFloatConst(String name, double value) {
	}

	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#acceptTypeConst(java.lang.String, org.eclipse.fdt.utils.debug.DebugType, int)
	 */
	public void acceptTypeConst(String name, DebugType type, int value) {
	}
	
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#acceptParameter(java.lang.String, int, int, long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#acceptVariable(java.lang.String, int, int, long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#acceptCaughtException(java.lang.String, org.eclipse.fdt.utils.debug.DebugType, long)
	 */
	public void acceptCaughtException(String name, DebugType type, long address) {
	}

	/* (non-Javadoc)
	 * @see org.eclipse.fdt.utils.debug.IDebugEntryRequestor#acceptTypeDef(java.lang.String, org.eclipse.fdt.utils.debug.DebugType)
	 */
