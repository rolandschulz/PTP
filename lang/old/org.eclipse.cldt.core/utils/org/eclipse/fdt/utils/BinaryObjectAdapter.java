...
public abstract class BinaryObjectAdapter extends BinaryFile implements IBinaryObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.IBinaryParser.IBinaryObject#getSymbol(long)
	 */
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryObject#getBSS()
	 */
	public long getBSS() {
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryObject#getCPU()
	 */
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryObject#getData()
	 */
	public long getData() {
		BinaryObjectInfo info = getBinaryObjectInfo();
		if (info != null) {
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryObject#getText()
	 */
	public long getText() {
		BinaryObjectInfo info = getBinaryObjectInfo();
		if (info != null) {
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryObject#hasDebug()
	 */
	public boolean hasDebug() {
		BinaryObjectInfo info = getBinaryObjectInfo();
		if (info != null) {
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryObject#isLittleEndian()
	 */
	public boolean isLittleEndian() {
		BinaryObjectInfo info = getBinaryObjectInfo();
		if (info != null) {
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryExecutable#getNeededSharedLibs()
	 */
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryShared#getSoName()
	 */
	...
	/**
	 * @see org.eclipse.fdt.core.model.IBinaryParser.IBinaryObject#getName()
	 */
