 ...
 *******************************************************************************/
package org.eclipse.fdt.utils.spawner;
...
public class Spawner extends Process {
	...
	private void exec_pty(String[] cmdarray, String[] envp, String dirpath, PTY pty) throws IOException {
		...
		Reaper reaper = new Reaper(cmdarray, envp, dirpath) {
			/* (non-Javadoc)
			 * @see org.eclipse.fdt.utils.spawner.Spawner.Reaper#execute(java.lang.String[], java.lang.String[], java.lang.String, int[])
			 */
	...
	class Reaper extends Thread {
		...
		public Reaper(String[] array, String[] env, String dir) {
			...
			fEnvp = env;
			fDirpath = dir;
			fErrMesg = new String(CommonLanguageCore.getResourceString("Util.error.cannotRun") + fCmdarray[0]); //$NON-NLS-1$
		}
