 ...
 *******************************************************************************/
package org.eclipse.cldt.utils.pty;
...
import org.eclipse.cldt.utils.pty.PTY.MasterFD;
...
class PTYInputStream extends InputStream {
	...
	public void close() throws IOException {
		...
		if (status == -1)
			throw new IOException(CommonLanguageCore.getResourceString("Util.exception.closeError")); //$NON-NLS-1$
		master.setFD(-1);
	}
