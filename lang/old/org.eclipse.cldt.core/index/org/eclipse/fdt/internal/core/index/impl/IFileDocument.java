...
public class IFileDocument extends PropertyDocument {
	...
	public byte[] getByteContent() throws IOException {
		...
		return byteContents = org.eclipse.fdt.internal.core.Util.getFileByteContent(location.toFile());
	}
	/**
	...
	public char[] getCharContent() throws IOException {
		...
		return charContents = org.eclipse.fdt.internal.core.Util.getFileCharContent(
					location.toFile(), 
					getEncoding());
	}
	/**
