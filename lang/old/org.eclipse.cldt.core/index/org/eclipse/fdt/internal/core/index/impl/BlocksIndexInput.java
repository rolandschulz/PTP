...
public class BlocksIndexInput extends IndexInput {
	...
	public IQueryResult[] queryFilesReferringToPrefix(char[] prefix) throws IOException {
		...
		org.eclipse.fdt.internal.core.search.HashtableOfInt fileMatches = new  org.eclipse.fdt.internal.core.search.HashtableOfInt(20);
		int count = 0; 
		while(blockLoc >= 0){
			IndexBlock block = getIndexBlock(summary.getBlockNum(blockLoc));
			block.reset();
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.index.impl.IndexInput#moveToNextIncludeEntry()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.index.impl.IndexInput#setFirstInclude()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.index.impl.IndexInput#queryIncludeEntries()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.index.impl.IndexInput#queryIncludeEntries(int)
	 */
