...
import org.eclipse.cldt.core.index.IIndexDelta;
	...
	protected void indexFile(IDocument document) throws IOException {
		...
		try{
			...
			if (vmErr instanceof OutOfMemoryError){
				org.eclipse.cldt.internal.core.model.Util.log(null, "Out Of Memory error: " + vmErr.getMessage() + " on File: " + resourceFile.getName(), ICLogConstants.CDT); //$NON-NLS-1$ //$NON-NLS-2$
			}
		}
		catch (ParseError e){
			org.eclipse.cldt.internal.core.model.Util.log(null, "Parser Timeout on File: " + resourceFile.getName(), ICLogConstants.CDT); //$NON-NLS-1$ //$NON-NLS-2$
		}
		catch ( Exception ex ){
