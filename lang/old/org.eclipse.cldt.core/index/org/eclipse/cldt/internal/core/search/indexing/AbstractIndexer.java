...
import org.eclipse.cldt.internal.core.index.IDocument;
import org.eclipse.cldt.internal.core.index.IIndexer;
import org.eclipse.cldt.internal.core.index.IIndexerOutput;
...
public abstract class AbstractIndexer implements IIndexer, IIndexConstants, ICSearchConstants {
	...
	private final static String C_SOURCE_ID = "org.eclipse.cldt.core.fileType.c_source"; //$NON-NLS-1$
	private final static String C_HEADER_ID = "org.eclipse.cldt.core.fileType.c_header"; //$NON-NLS-1$
	private final static String CPP_SOURCE_ID = "org.eclipse.cldt.core.fileType.cxx_source"; //$NON-NLS-1$
	private final static String CPP_HEADER_ID = "org.eclipse.cldt.core.fileType.cxx_header"; //$NON-NLS-1$
