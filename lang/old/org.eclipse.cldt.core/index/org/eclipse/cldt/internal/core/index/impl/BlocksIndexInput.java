...
import org.eclipse.cldt.internal.core.index.IQueryResult;
import org.eclipse.cldt.internal.core.util.LRUCache;
...
public class BlocksIndexInput extends IndexInput {
	...
	public IQueryResult[] queryFilesReferringToPrefix(char[] prefix) throws IOException {
		...
		org.eclipse.cldt.internal.core.search.HashtableOfInt fileMatches = new  org.eclipse.cldt.internal.core.search.HashtableOfInt(20);
		int count = 0; 
		while(blockLoc >= 0){
			IndexBlock block = getIndexBlock(summary.getBlockNum(blockLoc));
			block.reset();
