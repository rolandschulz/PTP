...
public class CPPASTCompositeTypeSpecifier extends CPPASTBaseDeclSpecifier
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTDeclSpecifier#getUnpreprocessedSignature()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTCompositeTypeSpecifier#getBaseSpecifiers()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTCompositeTypeSpecifier#addBaseSpecifier(org.eclipse.fdt.core.dom.ast.cpp.ICPPASTCompositeTypeSpecifier.ICPPASTBaseSpecifier)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTCompositeTypeSpecifier#getKey()
     */
    public int getKey() {
        return k;
    }
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTCompositeTypeSpecifier#setKey(int)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTCompositeTypeSpecifier#getName()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTCompositeTypeSpecifier#setName(org.eclipse.fdt.core.dom.ast.IASTName)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTCompositeTypeSpecifier#getMembers()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTCompositeTypeSpecifier#addMemberDeclaration(org.eclipse.fdt.core.dom.ast.IASTDeclaration)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTCompositeTypeSpecifier#getScope()
     */
