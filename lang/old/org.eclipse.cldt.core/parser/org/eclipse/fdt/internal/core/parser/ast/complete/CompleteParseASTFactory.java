...
import org.eclipse.fdt.core.parser.ast.ASTSemanticException;
...
import org.eclipse.fdt.core.parser.ast.IASTConstructorMemberInitializer;
...
import org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier;
import org.eclipse.fdt.core.parser.ast.IASTTemplate;
...
import org.eclipse.fdt.core.parser.ast.IASTTemplateParameter;
...
import org.eclipse.fdt.core.parser.ast.IASTClassSpecifier.ClassNameType;
import org.eclipse.fdt.core.parser.ast.IASTExpression.IASTNewExpressionDescriptor;
import org.eclipse.fdt.core.parser.ast.IASTExpression.Kind;
import org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier.Type;
import org.eclipse.fdt.core.parser.ast.IASTTemplateParameter.ParamKind;
...
import org.eclipse.fdt.internal.core.parser.ast.BaseASTFactory;
import org.eclipse.fdt.internal.core.parser.problem.IProblemFactory;
import org.eclipse.fdt.internal.core.parser.pst.ExtensibleSymbolExtension;
import org.eclipse.fdt.internal.core.parser.pst.ForewardDeclaredSymbolExtension;
import org.eclipse.fdt.internal.core.parser.pst.IContainerSymbol;
import org.eclipse.fdt.internal.core.parser.pst.IDeferredTemplateInstance;
import org.eclipse.fdt.internal.core.parser.pst.IDerivableContainerSymbol;
import org.eclipse.fdt.internal.core.parser.pst.IExtensibleSymbol;
import org.eclipse.fdt.internal.core.parser.pst.IParameterizedSymbol;
import org.eclipse.fdt.internal.core.parser.pst.ISymbol;
import org.eclipse.fdt.internal.core.parser.pst.ISymbolASTExtension;
import org.eclipse.fdt.internal.core.parser.pst.ISymbolOwner;
import org.eclipse.fdt.internal.core.parser.pst.ITemplateFactory;
import org.eclipse.fdt.internal.core.parser.pst.ITemplateSymbol;
import org.eclipse.fdt.internal.core.parser.pst.ITypeInfo;
import org.eclipse.fdt.internal.core.parser.pst.IUsingDeclarationSymbol;
import org.eclipse.fdt.internal.core.parser.pst.IUsingDirectiveSymbol;
import org.eclipse.fdt.internal.core.parser.pst.NamespaceSymbolExtension;
import org.eclipse.fdt.internal.core.parser.pst.ParserSymbolTable;
import org.eclipse.fdt.internal.core.parser.pst.ParserSymbolTableError;
import org.eclipse.fdt.internal.core.parser.pst.ParserSymbolTableException;
import org.eclipse.fdt.internal.core.parser.pst.StandardSymbolExtension;
import org.eclipse.fdt.internal.core.parser.pst.TemplateSymbolExtension;
import org.eclipse.fdt.internal.core.parser.pst.TypeInfoProvider;
import org.eclipse.fdt.internal.core.parser.pst.UndefinedTemplateSymbol;
import org.eclipse.fdt.internal.core.parser.pst.ISymbolASTExtension.ExtensionException;
import org.eclipse.fdt.internal.core.parser.token.TokenFactory;
import org.eclipse.fdt.internal.core.parser.util.TraceUtil;
...
public class CompleteParseASTFactory extends BaseASTFactory implements
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createUsingDirective(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      org.eclipse.fdt.core.parser.ITokenDuple, int, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createUsingDeclaration(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      boolean, org.eclipse.fdt.core.parser.ITokenDuple, int, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createASMDefinition(org.eclipse.fdt.core.parser.ast.IASTScope,
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createNamespaceDefinition(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String, int, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createCompilationUnit()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createLinkageSpecification(org.eclipse.fdt.core.parser.ast.IASTScope,
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createClassSpecifier(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String, org.eclipse.fdt.core.parser.ast.ASTClassKind,
    *      org.eclipse.fdt.core.parser.ast.IASTClassSpecifier.ClassNameType,
    *      org.eclipse.fdt.core.parser.ast.ASTAccessVisibility,
    *      org.eclipse.fdt.core.parser.ast.IASTTemplate, int, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#addBaseSpecifier(org.eclipse.fdt.core.parser.ast.IASTClassSpecifier,
    *      boolean, org.eclipse.fdt.core.parser.ast.ASTAccessVisibility,
    *      java.lang.String)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createEnumerationSpecifier(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String, int, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#addEnumerator(org.eclipse.fdt.core.parser.ast.IASTEnumerationSpecifier,
    *      java.lang.String, int, int,
    *      org.eclipse.fdt.core.parser.ast.IASTExpression)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createExpression(org.eclipse.fdt.core.parser.ast.IASTExpression.Kind,
    *      org.eclipse.fdt.core.parser.ast.IASTExpression,
    *      org.eclipse.fdt.core.parser.ast.IASTExpression,
    *      org.eclipse.fdt.core.parser.ast.IASTExpression, java.lang.String,
    *      java.lang.String, java.lang.String,
    *      org.eclipse.fdt.core.parser.ast.IASTExpression.IASTNewExpressionDescriptor)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createNewDescriptor()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createExceptionSpecification(java.util.List)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createConstructorMemberInitializer(org.eclipse.fdt.core.parser.ITokenDuple,
    *      org.eclipse.fdt.core.parser.ast.IASTExpression)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createSimpleTypeSpecifier(org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier.Type,
    *      org.eclipse.fdt.core.parser.ITokenDuple, boolean, boolean, boolean,
    *      boolean, boolean)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createFunction(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String, java.util.List,
    *      org.eclipse.fdt.core.parser.ast.IASTAbstractDeclaration,
    *      org.eclipse.fdt.core.parser.ast.IASTExceptionSpecification, boolean,
    *      boolean, boolean, int, int,
    *      org.eclipse.fdt.core.parser.ast.IASTTemplate)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createMethod(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String, java.util.List,
    *      org.eclipse.fdt.core.parser.ast.IASTAbstractDeclaration,
    *      org.eclipse.fdt.core.parser.ast.IASTExceptionSpecification, boolean,
    *      boolean, boolean, int, int,
    *      org.eclipse.fdt.core.parser.ast.IASTTemplate, boolean, boolean,
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createVariable(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String, boolean,
    *      org.eclipse.fdt.core.parser.ast.IASTInitializerClause,
    *      org.eclipse.fdt.core.parser.ast.IASTExpression,
    *      org.eclipse.fdt.core.parser.ast.IASTAbstractDeclaration, boolean,
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createField(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String, boolean,
    *      org.eclipse.fdt.core.parser.ast.IASTInitializerClause,
    *      org.eclipse.fdt.core.parser.ast.IASTExpression,
    *      org.eclipse.fdt.core.parser.ast.IASTAbstractDeclaration, boolean,
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createTemplateDeclaration(org.eclipse.fdt.core.parser.ast.IASTScope,
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createTemplateParameter(org.eclipse.fdt.core.parser.ast.IASTTemplateParameter.ParamKind,
    *      java.lang.String, java.lang.String,
    *      org.eclipse.fdt.core.parser.ast.IASTParameterDeclaration,
    *      java.util.List)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createTemplateInstantiation(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createTemplateSpecialization(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createTypedef(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String,
    *      org.eclipse.fdt.core.parser.ast.IASTAbstractDeclaration, int, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createTypeSpecDeclaration(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      org.eclipse.fdt.core.parser.ast.IASTTypeSpecifier,
    *      org.eclipse.fdt.core.parser.ast.IASTTemplate, int, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createNamespaceAlias(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      java.lang.String, org.eclipse.fdt.core.parser.ITokenDuple, int, int,
    *      int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createNewCodeBlock(org.eclipse.fdt.core.parser.ast.IASTScope)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#queryIsTypeName(org.eclipse.fdt.core.parser.ITokenDuple)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#createTypeId(org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier.Type,
    *      org.eclipse.fdt.core.parser.ITokenDuple, java.util.List,
    *      java.util.List)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#signalEndOfClassSpecifier(org.eclipse.fdt.core.parser.ast.IASTClassSpecifier)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#lookupSymbolInContext(org.eclipse.fdt.core.parser.ast.IASTScope,
    *      org.eclipse.fdt.core.parser.ITokenDuple)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#getNodeForThisExpression(org.eclipse.fdt.core.parser.ast.IASTExpression)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#validateIndirectMemberOperation(org.eclipse.fdt.core.parser.ast.IASTNode)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#validateDirectMemberOperation(org.eclipse.fdt.core.parser.ast.IASTNode)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.parser.ast.IASTFactory#constructExpressions(boolean)
    */
