...
public class ASTTypedef extends ASTSymbol implements IASTTypedefDeclaration
{
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypedefDeclaration#getName()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypedefDeclaration#getAbstractDeclarator()
     */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTTypedefDeclaration#getFinalTypeSpecifier()
	 */
