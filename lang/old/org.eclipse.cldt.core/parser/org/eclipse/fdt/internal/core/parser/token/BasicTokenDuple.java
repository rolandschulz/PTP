...
//		assert ( first != null && last != null ) : this; 
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ITokenDuple#getSubDuple(int, int)
     */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getEndOffset()
	 */
	public int getEndOffset() {
		return getLastToken().getEndOffset();
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getLineNumber()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#toCharArray()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getFilename()
	 */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ITokenDuple#isConversion()
     */
