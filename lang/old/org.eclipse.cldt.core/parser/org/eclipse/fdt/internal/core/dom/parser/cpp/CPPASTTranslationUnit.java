...
import org.eclipse.fdt.core.dom.ast.IASTVisitor;
...
import org.eclipse.fdt.internal.core.dom.parser.IRequiresLocationInformation;
import org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver;
import org.eclipse.fdt.internal.core.parser.scanner2.InvalidPreprocessorNodeException;
...
public class CPPASTTranslationUnit extends CPPASTNode implements
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getDeclarations()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getScope()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getDeclarations(org.eclipse.fdt.core.dom.ast.IBinding)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getReferences(org.eclipse.fdt.core.dom.ast.IBinding)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getLocationInfo(int,
     *      int)
     */
    ...
    private class CPPFindNodeForOffsetAction extends CPPVisitor.CPPBaseVisitorAction {
    	...
    	/* (non-Javadoc)
    	 * @see org.eclipse.fdt.internal.core.dom.parser.cpp.CPPVisitor.CPPBaseVisitorAction#processDeclaration(org.eclipse.fdt.core.dom.ast.IASTDeclaration)
    	 */
    	...
    	/* (non-Javadoc)
    	 * @see org.eclipse.fdt.internal.core.dom.parser.cpp.CPPVisitor.CPPBaseVisitorAction#processDeclarator(org.eclipse.fdt.core.dom.ast.IASTDeclarator)
    	 */
    	...
    	/* (non-Javadoc)
    	 * @see org.eclipse.fdt.internal.core.dom.parser.c.CVisitor.CBaseVisitorAction#processDesignator(org.eclipse.fdt.core.dom.ast.c.ICASTDesignator)
    	 */
    	...
    	/* (non-Javadoc)
    	 * @see org.eclipse.fdt.internal.core.dom.parser.c.CVisitor.CBaseVisitorAction#processInitializer(org.eclipse.fdt.core.dom.ast.IASTInitializer)
    	 */
    	...
    	/* (non-Javadoc)
    	 * @see org.eclipse.fdt.internal.core.dom.parser.c.CVisitor.CBaseVisitorAction#processName(org.eclipse.fdt.core.dom.ast.IASTName)
    	 */
    	...
    	/* (non-Javadoc)
    	 * @see org.eclipse.fdt.internal.core.dom.parser.c.CVisitor.CBaseVisitorAction#processParameterDeclaration(org.eclipse.fdt.core.dom.ast.IASTParameterDeclaration)
    	 */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getNodeForLocation(org.eclipse.fdt.core.dom.ast.IASTNodeLocation)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getMacroDefinitions()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getIncludeDirectives()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getAllPreprocessorStatements()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser2.IRequiresLocationInformation#setLocationResolver(org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTTranslationUnit#resolveBinding()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getPreprocesorProblems()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getUnpreprocessedSignature(org.eclipse.fdt.core.dom.ast.IASTNodeLocation[])
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getVisitor()
     */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.fdt.core.dom.ast.IASTTranslationUnit#getFilePath()
	 */
