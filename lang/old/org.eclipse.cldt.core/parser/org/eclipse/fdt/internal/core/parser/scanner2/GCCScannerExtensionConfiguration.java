...
import org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner.ExpressionEvaluator;
...
public class GCCScannerExtensionConfiguration extends GNUScannerExtensionConfiguration implements IScannerExtensionConfiguration {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerConfiguration#supportMinAndMaxOperators()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerConfiguration#getAdditionalMacros()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerConfiguration#getAdditionalKeywords()
     */
