...
public class ExtensibleSymbol implements Cloneable, IExtensibleSymbol {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.pst.IExtensibleSymbol#getSymbolTable()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.pst.IExtensibleSymbol#getASTExtension()
	 */
	public ISymbolASTExtension getASTExtension() {
		return _object;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.pst.IExtensibleSymbol#setASTExtension(org.eclipse.fdt.internal.core.parser.pst.ISymbolASTExtension)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.pst.IExtensibleSymbol#getContainingSymbol()
	 */
