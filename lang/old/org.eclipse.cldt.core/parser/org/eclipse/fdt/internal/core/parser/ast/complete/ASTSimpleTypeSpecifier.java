...
public class ASTSimpleTypeSpecifier extends ASTNode implements IASTSimpleTypeSpecifier
{
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#getType()
     */
    public Type getType()
    {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#getTypename()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#isLong()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#isShort()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#isSigned()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#isUnsigned()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#isTypename()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#getTypeSpecifier()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#isComplex()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#isImaginary()
     */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTSimpleTypeSpecifier#releaseReferences(org.eclipse.fdt.core.parser.ast.IReferenceManager)
	 */
