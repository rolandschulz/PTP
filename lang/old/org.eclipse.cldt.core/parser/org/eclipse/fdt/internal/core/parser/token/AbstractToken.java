...
public abstract class AbstractToken implements IToken, ITokenDuple {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.IToken#getFilename()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.IToken#isKeyword()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#contains(org.eclipse.fdt.core.parser.ITokenDuple)
	 */
	public boolean contains(ITokenDuple duple) {
		return ( duple.getFirstToken() == duple.getLastToken() ) && ( duple.getFirstToken() == this );
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#extractNameFromTemplateId()
	 */
	public char[] extractNameFromTemplateId(){
		return getCharImage();
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#findLastTokenType(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getFirstToken()
	 */
	public IToken getFirstToken() {
		return this;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getLastSegment()
	 */
	public ITokenDuple getLastSegment() {
		return this;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getLastToken()
	 */
	public IToken getLastToken() {
		return this;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getLeadingSegments()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getStartOffset()
	 */
	public int getStartOffset() {
		return getOffset();
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getSubrange(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#getToken(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#isIdentifier()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#iterator()
	 */
	public Iterator iterator() {
		return new SingleIterator();
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#length()
	 */
	public int length() {
		return 1;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#syntaxOfName()
	 */
	public boolean syntaxOfName() {
		return ( getType() == IToken.tIDENTIFIER );
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ITokenDuple#toQualifiedName()
	 */
	...
	/* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ITokenDuple#getSegmentIterator()
     */
