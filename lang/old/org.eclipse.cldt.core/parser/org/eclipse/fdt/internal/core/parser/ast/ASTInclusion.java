...
public class ASTInclusion implements IASTInclusion {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTInclusion#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTInclusion#getFullFileName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTInclusion#isLocal()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IOffsetableElement#getElementStartingOffset()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IOffsetableElement#getElementEndingOffset()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IOffsetableElement#getElementNameOffset()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.ast.IOffsetableElementRW#setStartingOffset(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.ast.IOffsetableElementRW#setEndingOffset(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.ast.IOffsetableElementRW#setNameOffset(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTOffsetableElement#getFileIndex()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTOffsetableElement#setFileIndex()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTInclusion#isImplicit()
	 */
