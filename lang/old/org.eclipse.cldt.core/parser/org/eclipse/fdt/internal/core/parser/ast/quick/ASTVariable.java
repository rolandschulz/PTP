...
public class ASTVariable extends ASTDeclaration implements IASTVariable
{
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#isAuto()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#isRegister()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#isStatic()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#isExtern()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#isMutable()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#getAbstractDeclaration()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#getName()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#getInitializerClause()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#isBitfield()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#getBitfieldExpression()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTVariable#getConstructorExpression()
     */
