...
public class CPPASTQualifiedName extends CPPASTNode implements
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTQualifiedName#addName(org.eclipse.fdt.core.dom.ast.IASTName)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTQualifiedName#getNames()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTQualifiedName#isFullyQualified()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTQualifiedName#setFullyQualified(boolean)
    */
