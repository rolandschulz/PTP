...
public class Scanner2 extends BaseScanner {
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser.scanner.IScannerData#getASTFactory()
    */
   ...
   protected void processMacro(char[] name, int startingOffset,
         ...
         int textEnd, int endingLine, org.eclipse.fdt.core.parser.IMacro macro) {
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#beforeSecondFetchToken()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser.scanner.IScannerData#getWorkingCopies()
    */
   ...
   /* (non-Javadoc)
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#processIfdef(int, int, boolean, boolean)
    */
   protected void processIfdef(int startPos, int endPos, boolean positive, boolean taken) {
   }

   /* (non-Javadoc)
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#processIf(int, int, boolean)
    */
   protected void processIf(int startPos, int endPos, boolean taken) {
   }

   /* (non-Javadoc)
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#processElsif(int, int, boolean)
    */
   protected void processElsif(int startPos, int endPos, boolean taken) {
   }

   /* (non-Javadoc)
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#processElse(int, int, boolean)
    */
   protected void processElse(int startPos, int endPos, boolean taken) {
   }

   /* (non-Javadoc)
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#processUndef(int, int)
    */
   protected void processUndef(int pos, int endPos) {
   }

   /* (non-Javadoc)
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#processError(int, int)
    */
   protected void processError(int startPos, int endPos) {
   }

   /* (non-Javadoc)
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#processEndif(int, int)
    */
   protected void processEndif(int pos, int i) {
   }

   /* (non-Javadoc)
    * @see org.eclipse.fdt.internal.core.parser.scanner2.BaseScanner#processPragma(int, int)
    */
