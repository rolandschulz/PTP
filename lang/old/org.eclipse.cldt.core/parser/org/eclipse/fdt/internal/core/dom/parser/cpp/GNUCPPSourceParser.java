...
import org.eclipse.fdt.core.dom.ast.IASTBreakStatement;
...
import org.eclipse.fdt.core.dom.ast.IASTContinueStatement;
...
import org.eclipse.fdt.core.dom.ast.IASTDefaultStatement;
...
import org.eclipse.fdt.core.dom.ast.IASTNullStatement;
...
import org.eclipse.fdt.core.dom.ast.IASTProblemDeclaration;
import org.eclipse.fdt.core.dom.ast.IASTProblemExpression;
import org.eclipse.fdt.core.dom.ast.IASTProblemHolder;
import org.eclipse.fdt.core.dom.ast.IASTProblemStatement;
import org.eclipse.fdt.core.dom.ast.IASTProblemTypeId;
...
import org.eclipse.fdt.core.dom.ast.cpp.ICPPASTExplicitTemplateInstantiation;
...
import org.eclipse.fdt.core.dom.ast.cpp.ICPPASTParameterDeclaration;
...
import org.eclipse.fdt.core.dom.ast.cpp.ICPPASTTemplatedTypeTemplateParameter;
import org.eclipse.fdt.core.dom.ast.cpp.ICPPASTTryBlockStatement;
import org.eclipse.fdt.core.dom.ast.cpp.ICPPASTTypeIdExpression;
import org.eclipse.fdt.core.dom.ast.cpp.ICPPASTTypenameExpression;
import org.eclipse.fdt.core.dom.ast.cpp.ICPPASTUnaryExpression;
...
import org.eclipse.fdt.core.dom.ast.gnu.cpp.IGPPASTBinaryExpression;
import org.eclipse.fdt.core.dom.ast.gnu.cpp.IGPPASTDeclSpecifier;
import org.eclipse.fdt.core.dom.ast.gnu.cpp.IGPPASTExplicitTemplateInstantiation;
import org.eclipse.fdt.core.dom.ast.gnu.cpp.IGPPASTPointer;
...
import org.eclipse.fdt.core.parser.IGCCToken;
...
import org.eclipse.fdt.internal.core.dom.parser.AbstractGNUSourceCodeParser;
import org.eclipse.fdt.internal.core.dom.parser.BacktrackException;
import org.eclipse.fdt.internal.core.parser.SimpleDeclarationStrategy;
import org.eclipse.fdt.internal.core.parser.TemplateParameterManager;
...
public class GNUCPPSourceParser extends AbstractGNUSourceCodeParser {
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#getTranslationUnit()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createCompoundStatement()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createBinaryExpression()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createConditionalExpression()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createUnaryExpression()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createCompoundStatementExpression()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createExpressionList()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createName(org.eclipse.fdt.core.parser.IToken)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createName()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createEnumerator()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#buildTypeIdExpression(int,
    *      org.eclipse.fdt.core.dom.ast.IASTTypeId, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.parser2.AbstractGNUSourceCodeParser#createEnumerationSpecifier()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.dom.parser.AbstractGNUSourceCodeParser#nullifyTranslationUnit()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.dom.parser.AbstractGNUSourceCodeParser#createProblemStatement()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.dom.parser.AbstractGNUSourceCodeParser#createProblemExpression()
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.dom.parser.AbstractGNUSourceCodeParser#createProblem(int,
    *      int, int)
    */
    ...
    * (non-Javadoc)
    * 
    * @see org.eclipse.fdt.internal.core.dom.parser.AbstractGNUSourceCodeParser#resolveOtherAmbiguitiesAsDeclaration(org.eclipse.fdt.core.dom.ast.IASTDeclarationStatement,
    *      org.eclipse.fdt.core.dom.ast.IASTExpressionStatement)
    */
   ...
   /* (non-Javadoc)
 * @see org.eclipse.fdt.internal.core.dom.parser.AbstractGNUSourceCodeParser#parseWhileStatement()
 */
