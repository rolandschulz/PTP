...
public class ASTCompletionNode implements IASTCompletionNode {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTCompletionNode#getCompletionKind()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTCompletionNode#getCompletionScope()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTCompletionNode#getCompletionContext()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTCompletionNode#getCompletionPrefix()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTCompletionNode#getKeywords()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTCompletionNode#getFunctionName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTCompletionNode#getFunctionParameters()
	 */
