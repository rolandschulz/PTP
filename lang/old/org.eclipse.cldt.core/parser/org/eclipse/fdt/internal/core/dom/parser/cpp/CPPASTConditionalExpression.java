...
public class CPPASTConditionalExpression extends CPPASTNode implements
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTConditionalExpression#getLogicalConditionExpression()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTConditionalExpression#setLogicalConditionExpression(org.eclipse.fdt.core.dom.ast.IASTExpression)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTConditionalExpression#getPositiveResultExpression()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTConditionalExpression#setPositiveResultExpression(org.eclipse.fdt.core.dom.ast.IASTExpression)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTConditionalExpression#getNegativeResultExpression()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTConditionalExpression#setNegativeResultExpression(org.eclipse.fdt.core.dom.ast.IASTExpression)
     */
