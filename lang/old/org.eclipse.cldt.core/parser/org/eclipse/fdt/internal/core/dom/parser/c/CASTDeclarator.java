...
public class CASTDeclarator extends CASTNode implements IASTDeclarator {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTDeclarator#getPointerOperators()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTDeclarator#getNestedDeclarator()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTDeclarator#getName()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTDeclarator#getInitializer()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTDeclarator#addPointerOperator(org.eclipse.fdt.core.dom.ast.IASTPointerOperator)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTDeclarator#setNestedDeclarator(org.eclipse.fdt.core.dom.ast.IASTDeclarator)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTDeclarator#setName(org.eclipse.fdt.core.dom.ast.IASTName)
     */
