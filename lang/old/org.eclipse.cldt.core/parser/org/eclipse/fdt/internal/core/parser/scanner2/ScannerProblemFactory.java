...
{
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.IProblemFactory#createProblem(int, int, int, int, char[], java.lang.String, boolean, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.IProblemFactory#getRequiredAttributesForId(int)
	 */
