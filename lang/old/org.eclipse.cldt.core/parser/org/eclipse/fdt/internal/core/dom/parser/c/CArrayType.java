...
import org.eclipse.fdt.core.dom.ast.c.ICArrayType;
...
public class CArrayType implements ICArrayType, ITypeContainer {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.IArrayType#getType()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.c.ICArrayType#isConst()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.c.ICArrayType#isRestrict()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.c.ICArrayType#isVolatile()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.c.ICArrayType#isStatic()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.c.ICArrayType#isVariableLength()
	 */
