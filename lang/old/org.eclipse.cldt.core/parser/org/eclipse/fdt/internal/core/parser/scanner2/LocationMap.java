...
import org.eclipse.fdt.core.dom.ast.IASTFunctionStyleMacroParameter;
...
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorElifStatement;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorElseStatement;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorEndifStatement;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorErrorStatement;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorFunctionStyleMacroDefinition;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorIfStatement;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorIfdefStatement;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorIfndefStatement;
...
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorObjectStyleMacroDefinition;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorPragmaStatement;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorStatement;
import org.eclipse.fdt.core.dom.ast.IASTPreprocessorUndefStatement;
...
public class LocationMap implements ILocationResolver, IScannerPreprocessorLog {
    ...
    static class ASTElif extends ScannerASTNode implements
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTPreprocessorElifStatement#taken()
         */
    ...
    public static class ASTInclusionStatement extends ScannerASTNode implements
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTPreprocessorIncludeStatement#getPath()
         */
    ...
    public static class ASTFunctionMacro extends ScannerASTNode implements
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTFunctionStyleMacroDefinition#getParameters()
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTFunctionStyleMacroDefinition#addParameter(org.eclipse.fdt.core.dom.ast.IASTFunctionStyleMacroParameter)
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTMacroDefinition#getName()
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTMacroDefinition#setName(org.eclipse.fdt.core.dom.ast.IASTName)
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTMacroDefinition#getExpansion()
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTMacroDefinition#setExpansion(java.lang.String)
         */
    ...
    static class ScannerASTNode extends ASTNode {
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTNode#setPropertyInParent(org.eclipse.fdt.core.dom.ast.IASTNodeProperty)
         */
    ...
    public static class Location implements IASTNodeLocation {
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTNodeLocation#getNodeOffset()
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTNodeLocation#getNodeLength()
         */
    ...
    public static class ASTFunctionMacroParameter extends ScannerASTNode
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTFunctionStyleMacroParameter#getParameter()
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTFunctionStyleMacroParameter#setParameter(java.lang.String)
         */
    ...
    public static class FileLocation extends Location implements
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.fdt.core.dom.ast.IASTFileLocation#getFileName()
         */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#getMacroDefinitions()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#getIncludeDirectives()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#getAllPreprocessorStatements()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#getLocations(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#startTranslationUnit()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#endTranslationUnit(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#startInclusion(char[],
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#endInclusion(char[],
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#enterObjectStyleMacroExpansion(char[],
     *      char[], int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#exitObjectStyleMacroExpansion(char[],
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#enterFunctionStyleExpansion(char[],
     *      char[][], char[], int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#exitFunctionStyleExpansion(char[],
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#defineObjectStyleMacro(org.eclipse.fdt.internal.core.parser.scanner2.ObjectStyleMacro,
     *      int, int, int, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#defineFunctionStyleMacro(org.eclipse.fdt.internal.core.parser.scanner2.FunctionStyleMacro,
     *      int, int, int, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundIf(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundPragma(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundError(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundIfdef(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundUndef(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundElse(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundElif(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundEndIf(int,
     *      int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#getTranslationUnitPath()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#cleanup()
     */
    public void cleanup() {
        // TODO Auto-generated method stub
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#getScannerProblems()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterIProblem(org.eclipse.fdt.core.parser.IProblem)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#getSignature(org.eclipse.fdt.core.dom.ast.IASTNodeLocation[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.internal.core.parser.scanner2.IScannerPreprocessorLog#encounterPoundIfndef(int,
     *      int, boolean)
     */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.scanner2.ILocationResolver#getPreprocessorNode(int, int)
	 */
