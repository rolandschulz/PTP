...
public class CPPNamespaceScope extends CPPScope implements ICPPNamespaceScope{
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPNamespaceScope#getUsingDirectives()
	 */
	public IASTNode[] getUsingDirectives() {
		return (IASTNode[]) ArrayUtil.trim( IASTNode.class, usings, true );
	}
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPNamespaceScope#addUsingDirective(org.eclipse.fdt.core.dom.ast.cpp.ICPPASTUsingDirective)
	 */
