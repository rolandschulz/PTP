...
public class CPPASTProblem extends CPPASTNode implements IASTProblem {
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.parser.IASTProblem#getID()
     */
    public int getID() {
        return id;
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.parser.IASTProblem#isError()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.fdt.core.parser.IASTProblem#isWarning()
     */
