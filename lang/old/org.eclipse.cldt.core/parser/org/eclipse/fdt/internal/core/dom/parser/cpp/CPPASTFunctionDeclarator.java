...
public class CPPASTFunctionDeclarator extends CPPASTDeclarator implements
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTFunctionDeclarator#getParameters()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTFunctionDeclarator#addParameterDeclaration(org.eclipse.fdt.core.dom.ast.IASTParameterDeclaration)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTFunctionDeclarator#takesVarArgs()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.IASTFunctionDeclarator#setVarArgs(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#isConst()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#setConst(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#isVolatile()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#setVolatile(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#getExceptionSpecification()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#addExceptionSpecificationTypeId(org.eclipse.fdt.core.dom.ast.IASTTypeId)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#isPureVirtual()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#setPureVirtual(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#getConstructorChain()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.dom.ast.cpp.ICPPASTFunctionDeclarator#addConstructorToChain(org.eclipse.fdt.core.dom.ast.cpp.ICPPASTConstructorChainInitializer)
     */
