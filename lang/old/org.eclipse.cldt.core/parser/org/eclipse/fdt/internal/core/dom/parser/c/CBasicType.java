...
import org.eclipse.fdt.core.dom.ast.c.ICBasicType;
...
public class CBasicType implements ICBasicType {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.IBasicType#getType()
	 */
	public int getType() {
		return sds.getType();
	}
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.IBasicType#isSigned()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.IBasicType#isUnsigned()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.IBasicType#isShort()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.IBasicType#isLong()
	 */
