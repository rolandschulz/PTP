...
public class ASTTypeId implements IASTTypeId
{
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#getKind()
     */
    public Type getKind()
    {
        return kind;
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#getType()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#getPointerOperators()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#getArrayModifiers()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#getFullSignature()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#createTypeSymbol(org.eclipse.fdt.core.parser.ast.IASTFactory)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#isConst()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#isVolatile()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#isLong()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#isShort()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#isSigned()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#isUnsigned()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#isTypename()
     */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTTypeId#freeReferences(org.eclipse.fdt.core.parser.ast.IReferenceManager)
	 */
