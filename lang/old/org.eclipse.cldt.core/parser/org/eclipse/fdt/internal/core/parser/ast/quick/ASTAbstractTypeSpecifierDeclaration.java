    ...
    implements IASTAbstractTypeSpecifierDeclaration
{
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.core.parser.ast.IASTAbstractDeclaration#getTypeSpecifier()
     */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTAbstractTypeSpecifierDeclaration#isFriendDeclaration()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.ast.IASTOffsetableNamedElement#setNameEndOffsetAndLineNumber(int, int)
	 */
