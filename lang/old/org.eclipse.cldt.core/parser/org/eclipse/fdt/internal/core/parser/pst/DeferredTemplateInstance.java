...
public class DeferredTemplateInstance extends BasicSymbol implements IDeferredTemplateInstance {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.pst.IDeferredTemplateInstance#getTemplate()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.parser.pst.IDeferredTemplateInstance#getArgumentMap()
	 */
