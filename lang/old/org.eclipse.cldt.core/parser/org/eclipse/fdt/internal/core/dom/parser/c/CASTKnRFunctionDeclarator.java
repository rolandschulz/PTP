...
public class CASTKnRFunctionDeclarator extends CASTDeclarator implements ICASTKnRFunctionDeclarator {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#setParameterNames(org.eclipse.fdt.core.dom.ast.IASTName[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#getParameterNames()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#setParameterDeclarations(org.eclipse.fdt.core.dom.ast.IASTDeclaration[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#getParameterDeclarations()
	 */
