...
public class ExtendedScannerInfo extends ScannerInfo implements IExtendedScannerInfo {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.IExtendedScannerInfo#getMacroFiles()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.IExtendedScannerInfo#getIncludeFiles()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.IExtendedScannerInfo#getLocalIncludePath()
	 */
