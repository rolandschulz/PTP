...
public class SetPathEntriesOperation extends CModelOperation {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.core.model.CModelOperation#executeOperation()
	 */
	protected void executeOperation() throws CModelException {
		//	project reference updated - may throw an exception if unable to write .fdtproject file
