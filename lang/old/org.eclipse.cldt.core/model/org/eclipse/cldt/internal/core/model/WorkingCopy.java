...
public class WorkingCopy extends TranslationUnit implements IWorkingCopy {
	...
	/**
	 * @see org.eclipse.cldt.core.model.IWorkingCopy#commit(boolean, org.eclipse.core.runtime.IProgressMonitor)
	 */
	...
	/**
	 * @see org.eclipse.cldt.core.model.IWorkingCopy#destroy()
	 */
	public void destroy() {
		if (--this.useCount > 0) {
			return;
	...
	/**
	 * @see org.eclipse.cldt.core.model.ICElement#exists()
	 */
	...
	/**
	 * @see org.eclipse.cldt.core.model.IWorkingCopy#getOriginalElement()
	 */
	...
	/**
	 * @see org.eclipse.cldt.core.model.ITranslationUnit#getSharedWorkingCopy(IProgressMonitor, IBufferFactory)
	 */
	...
	/**
	 * @see org.eclipse.cldt.core.model.ITranslationUnit#getWorkingCopy()
	 */	
	...
	/**
	 * @see org.eclipse.cldt.core.model.ITranslationUnit#isWorkingCopy()
	 */
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.CFile#openBuffer(IProgressMonitor)
	 */
	...
	/**
	 * @see org.eclipse.cldt.core.model.IWorkingCopy#reconcile()
	 */
	...
	/**
	 * @see org.eclipse.cldt.core.model.IWorkingCopy#reconcile(boolean, org.eclipse.core.runtime.IProgressMonitor)
	 */
	...
	/**
	 * @see org.eclipse.cldt.core.model.IWorkingCopy#restore()
	 */
	...
	/**
	 * @see org.eclipse.cldt.core.model.ICFile#save(IProgressMonitor, boolean)
	 */
