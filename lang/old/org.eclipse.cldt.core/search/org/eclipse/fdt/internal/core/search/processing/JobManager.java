 ...
 */
package org.eclipse.fdt.internal.core.search.processing;
...
import org.eclipse.fdt.internal.core.search.indexing.IndexRequest;
...
public abstract class JobManager implements Runnable {
	...
	static private final IStatus OK_STATUS = new Status( IStatus.OK, "org.eclipse.fdt.core", IStatus.OK, "", null );  //$NON-NLS-1$//$NON-NLS-2$
	static private final IStatus ERROR_STATUS = new Status( IStatus.ERROR, "org.eclipse.fdt.core", IStatus.ERROR, "", null );  //$NON-NLS-1$//$NON-NLS-2$
	...
	public void run() {
		...
		try {
			...
			if (this.thread != null) { // if not shutting down
				// log exception
				org.eclipse.fdt.internal.core.model.Util.log(e, "Background Indexer Crash Recovery", ICLogConstants.PDE); //$NON-NLS-1$
