 ...
 */
package org.eclipse.cldt.internal.core.search.processing;

import java.util.HashSet;

import org.eclipse.cldt.core.ICLogConstants;
import org.eclipse.cldt.internal.core.Util;
import org.eclipse.cldt.internal.core.search.indexing.IndexRequest;
...
public abstract class JobManager implements Runnable {
	...
	static private final IStatus OK_STATUS = new Status( IStatus.OK, "org.eclipse.cldt.core", IStatus.OK, "", null );  //$NON-NLS-1$//$NON-NLS-2$
	static private final IStatus ERROR_STATUS = new Status( IStatus.ERROR, "org.eclipse.cldt.core", IStatus.ERROR, "", null );  //$NON-NLS-1$//$NON-NLS-2$
	...
	public void run() {
		...
		try {
			...
			if (this.thread != null) { // if not shutting down
				// log exception
				org.eclipse.cldt.internal.core.model.Util.log(e, "Background Indexer Crash Recovery", ICLogConstants.PDE); //$NON-NLS-1$
