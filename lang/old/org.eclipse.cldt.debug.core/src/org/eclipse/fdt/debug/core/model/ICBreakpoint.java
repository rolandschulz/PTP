...
public interface ICBreakpoint extends IBreakpoint {
	 ...
	 * installed in (value <code>"org.eclipse.fdt.debug.core.installCount"</code>). 
	 * This attribute is an <code>int</code>.
	 */
	public static final String INSTALL_COUNT = "org.eclipse.fdt.debug.core.installCount"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing the conditional expression associated with
	 * this breakpoint (value <code>"org.eclipse.fdt.debug.core.condition"</code>). 
	 * This attribute is a <code>String</code>.
	 */
	public static final String CONDITION = "org.eclipse.fdt.debug.core.condition"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing a breakpoint's ignore count value (value
	 * <code>"org.eclipse.fdt.debug.core.ignoreCount"</code>). This attribute
	 * is an <code>int</code>.
	 */
	public static final String IGNORE_COUNT = "org.eclipse.fdt.debug.core.ignoreCount"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing an identifier of the thread this breakpoint
	 * is restricted in (value <code>"org.eclipse.fdt.debug.core.threadId"</code>). 
	 * This attribute is a <code>String</code>.
	 */
	public static final String THREAD_ID = "org.eclipse.fdt.debug.core.threadId"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing a source handle this breakpoint
	 * is set in (value <code>"org.eclipse.fdt.debug.core.sourceHandle"</code>). 
	 * This attribute is a <code>String</code>.
	 */
	public static final String SOURCE_HANDLE = "org.eclipse.fdt.debug.core.sourceHandle"; //$NON-NLS-1$	
