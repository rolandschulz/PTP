...
public interface IFDTLaunchConfigurationConstants {

	public static final String FDT_LAUNCH_ID = "org.eclipse.fdt.launch"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_PROJECT_NAME = FDT_LAUNCH_ID + ".PROJECT_ATTR"; //$NON-NLS-1$

	/**
	 * Launch configuration attribute key. The value is a string specifying
	 * application a C/C++ launch configuration.
	 */
	public static final String ATTR_PROGRAM_NAME = FDT_LAUNCH_ID + ".PROGRAM_NAME"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_PROGRAM_ARGUMENTS = FDT_LAUNCH_ID + ".PROGRAM_ARGUMENTS"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_WORKING_DIRECTORY = FDT_LAUNCH_ID + ".WORKING_DIRECTORY"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_PROGRAM_ENVIROMENT_INHERIT = FDT_LAUNCH_ID + ".ENVIRONMENT_INHERIT"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_PROGRAM_ENVIROMENT_MAP = FDT_LAUNCH_ID + ".ENVIRONMENT_MAP"; //$NON-NLS-1$

	/**
	 * Launch configuration attribute key. The value is the platform string of
	 * the launch configuration
	 */
	public static final String ATTR_PLATFORM = FDT_LAUNCH_ID + ".PLATFFORM"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_USE_TERMINAL = FDT_LAUNCH_ID + ".use_terminal";
	 ...
	 */
	public static final String ATTR_DEBUGGER_ID = FDT_LAUNCH_ID + ".DEBUGGER_ID"; //$NON-NLS-1$

	/**
	 * Launch configuration attribute key. The value is the platform string of
	 * the launch configuration
	 */
	public static final String ATTR_DEBUGGER_SPECIFIC_ATTRS_MAP = FDT_LAUNCH_ID + ".DEBUGGER_SPECIFIC_ATTRS_MAP"; //$NON-NLS-1$

	/**
	 * Launch configuration attribute key. The value is a boolean specifying
	 * whether to stop at main().
	 */
	public static final String ATTR_DEBUGGER_STOP_AT_MAIN = FDT_LAUNCH_ID + ".DEBUGGER_STOP_AT_MAIN"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_ATTACH_PROCESS_ID = FDT_LAUNCH_ID + ".ATTACH_PROCESS_ID"; //$NON-NLS-1$
	 ...
	 * interface.
	 */
	public static final String ATTR_COREFILE_PATH = FDT_LAUNCH_ID + ".COREFILE_PATH"; //$NON-NLS-1$

	/**
	 * Launch configuration attribute key. The value is the startup mode for the
	 * debugger.
	 */
	public static final String ATTR_DEBUGGER_START_MODE = FDT_LAUNCH_ID + ".DEBUGGER_START_MODE"; //$NON-NLS-1$

	/**
	 * Launch configuration attribute key. The value is a boolean specifying
	 * whether to enable variable bookkeeping.
	 */
	public static final String ATTR_DEBUGGER_ENABLE_VARIABLE_BOOKKEEPING = FDT_LAUNCH_ID + ".ENABLE_VARIABLE_BOOKKEEPING"; //$NON-NLS-1$

	/**
	 * Launch configuration attribute key. The value is a boolean specifying
	 * whether to enable register bookkeeping.
	 */
	public static final String ATTR_DEBUGGER_ENABLE_REGISTER_BOOKKEEPING = FDT_LAUNCH_ID + ".ENABLE_REGISTER_BOOKKEEPING"; //$NON-NLS-1$

	/**
	 * Launch configuration attribute key. The value is a global variables'
	 * memento.
	 */
	public static final String ATTR_DEBUGGER_GLOBAL_VARIABLES = FDT_LAUNCH_ID + ".GLOBAL_VARIABLES"; //$NON-NLS-1$
	...
	/**
	 * Status code indicating that the FDT debugger is missing
	 * <p>
	 * A status handler may be registered for this error condition, and should
