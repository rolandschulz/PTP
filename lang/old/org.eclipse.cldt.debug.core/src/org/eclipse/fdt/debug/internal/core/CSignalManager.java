...
import org.eclipse.fdt.debug.internal.core.model.CSignal;
...
public class CSignalManager implements IAdaptable {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.ICSignalManager#getSignals()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.internal.core.CUpdateManager#dispose()
	 */
	public void dispose() {
		if ( fSignals != null )
