...
public class CSignal extends CDebugElement implements ICSignal, ICDIEventListener
{
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.model.ICSignal#getDescription()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.model.ICSignal#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.model.ICSignal#isPassEnabled()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.model.ICSignal#isStopEnabled()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.model.ICSignal#setPassEnabled(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.model.ICSignal#setStopEnabled(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.event.ICDIEventListener#handleDebugEvents(ICDIEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.model.ICSignal#dispose()
	 */
	public void dispose()
	{
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.model.ICSignal#signal()
	 */
