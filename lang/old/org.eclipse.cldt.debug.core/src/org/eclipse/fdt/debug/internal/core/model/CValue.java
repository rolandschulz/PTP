...
import org.eclipse.fdt.debug.core.cdi.model.type.ICDICharValue;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIDoubleValue;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIFloatValue;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIIntValue;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDILongLongValue;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDILongValue;
...
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIShortValue;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIWCharValue;
...
public class CValue extends AbstractCValue {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.internal.core.model.AbstractCValue#dispose()
	 */
	public void dispose() {
		Iterator it = fVariables.iterator();
		while( it.hasNext() ) {
...
//		return ( var instanceof CVariable ) ? ((CVariable)var).getType() : null;
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.internal.core.model.AbstractCValue#preserve()
	 */
