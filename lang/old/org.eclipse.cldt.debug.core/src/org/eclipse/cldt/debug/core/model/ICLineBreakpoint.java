...
public interface ICLineBreakpoint extends ICBreakpoint, ILineBreakpoint {
	 ...
	 * execution at (value <code>"org.eclipse.cldt.debug.core.function"</code>).
	 * This attribute is a <code>String</code>.
	 */
	public static final String FUNCTION = "org.eclipse.cldt.debug.core.function"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing the address this breakpoint suspends
	 * execution at (value <code>"org.eclipse.cldt.debug.core.address"</code>).
	 * This attribute is a <code>String</code>.
	 */
	public static final String ADDRESS = "org.eclipse.cldt.debug.core.address"; //$NON-NLS-1$	
