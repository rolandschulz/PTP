...
public interface IFDTLaunchConfigurationConstants {
	...
	public static final String CDT_LAUNCH_ID = "org.eclipse.cldt.launch"; //$NON-NLS-1$

	/**
	 * This is the launch type id.
	 */
	public static final String ID_LAUNCH_FORTRAN_APP = "org.eclipse.cldt.launch.localFortranLaunch"; //$NON-NLS-1$
