...
import org.eclipse.cldt.debug.core.CDIDebugModel;
import org.eclipse.cldt.debug.core.CDebugCorePlugin;
import org.eclipse.cldt.debug.core.CDebugUtils;
import org.eclipse.cldt.debug.core.ICGlobalVariableManager;
import org.eclipse.cldt.debug.core.ICRegisterManager;
import org.eclipse.cldt.debug.core.cdi.CDIException;
import org.eclipse.cldt.debug.core.cdi.ICDIBreakpointHit;
...
import org.eclipse.cldt.debug.core.cdi.ICDISessionConfiguration;
import org.eclipse.cldt.debug.core.cdi.ICDISessionObject;
import org.eclipse.cldt.debug.core.cdi.ICDISharedLibraryEvent;
import org.eclipse.cldt.debug.core.cdi.ICDISignalReceived;
import org.eclipse.cldt.debug.core.cdi.ICDIWatchpointScope;
import org.eclipse.cldt.debug.core.cdi.ICDIWatchpointTrigger;
import org.eclipse.cldt.debug.core.cdi.event.ICDIChangedEvent;
import org.eclipse.cldt.debug.core.cdi.event.ICDICreatedEvent;
import org.eclipse.cldt.debug.core.cdi.event.ICDIDestroyedEvent;
import org.eclipse.cldt.debug.core.cdi.event.ICDIDisconnectedEvent;
import org.eclipse.cldt.debug.core.cdi.event.ICDIEvent;
import org.eclipse.cldt.debug.core.cdi.event.ICDIEventListener;
import org.eclipse.cldt.debug.core.cdi.event.ICDIExitedEvent;
import org.eclipse.cldt.debug.core.cdi.event.ICDIRestartedEvent;
import org.eclipse.cldt.debug.core.cdi.event.ICDIResumedEvent;
import org.eclipse.cldt.debug.core.cdi.event.ICDISuspendedEvent;
...
import org.eclipse.cldt.debug.core.model.CDebugElementState;
import org.eclipse.cldt.debug.core.model.IBreakpointTarget;
import org.eclipse.cldt.debug.core.model.ICAddressBreakpoint;
import org.eclipse.cldt.debug.core.model.ICBreakpoint;
import org.eclipse.cldt.debug.core.model.ICDebugElement;
import org.eclipse.cldt.debug.core.model.ICDebugElementStatus;
import org.eclipse.cldt.debug.core.model.ICDebugTarget;
import org.eclipse.cldt.debug.core.model.ICGlobalVariable;
import org.eclipse.cldt.debug.core.model.ICLineBreakpoint;
import org.eclipse.cldt.debug.core.model.ICModule;
import org.eclipse.cldt.debug.core.model.ICSignal;
import org.eclipse.cldt.debug.core.model.IDebuggerProcessSupport;
import org.eclipse.cldt.debug.core.model.IDisassembly;
import org.eclipse.cldt.debug.core.model.IExecFileInfo;
import org.eclipse.cldt.debug.core.model.IGlobalVariableDescriptor;
import org.eclipse.cldt.debug.core.model.IJumpToAddress;
import org.eclipse.cldt.debug.core.model.IJumpToLine;
import org.eclipse.cldt.debug.core.model.IRunToAddress;
import org.eclipse.cldt.debug.core.model.IRunToLine;
import org.eclipse.cldt.debug.core.sourcelookup.ICSourceLocator;
import org.eclipse.cldt.debug.internal.core.CBreakpointManager;
import org.eclipse.cldt.debug.internal.core.CGlobalVariableManager;
import org.eclipse.cldt.debug.internal.core.CMemoryBlockExtensionRetrieval;
import org.eclipse.cldt.debug.internal.core.CRegisterManager;
import org.eclipse.cldt.debug.internal.core.CSignalManager;
import org.eclipse.cldt.debug.internal.core.ICDebugInternalConstants;
import org.eclipse.cldt.debug.internal.core.sourcelookup.CSourceManager;
...
public class CDebugTarget extends CDebugElement implements ICDebugTarget, ICDIEventListener, ILaunchListener, IExpressionListener {
	...
	protected void initializeSourceManager() {
		...
		if ( locator instanceof IAdaptable ) {
			...
			if ( listener != null )
				CommonLanguageCore.getWorkspace().addResourceChangeListener( listener );
		}
	}
...
//		}
	...
	protected void disposeSourceManager() {
		...
		if ( locator instanceof IAdaptable ) {
			IResourceChangeListener listener = (IResourceChangeListener)((IAdaptable)locator).getAdapter( IResourceChangeListener.class );
			if ( listener != null )
				CommonLanguageCore.getWorkspace().removeResourceChangeListener( listener );
		}
	}
