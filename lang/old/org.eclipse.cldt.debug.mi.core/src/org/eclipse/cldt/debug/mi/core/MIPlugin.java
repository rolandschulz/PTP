...
import org.eclipse.cldt.debug.mi.core.IMITTY;
...
import org.eclipse.cldt.debug.mi.core.command.MITargetAttach;
import org.eclipse.cldt.debug.mi.core.command.MITargetSelect;
...
public class MIPlugin extends Plugin {
	 ...
	 */
	public static final String PLUGIN_ID = "org.eclipse.cldt.debug.mi.core" ; //$NON-NLS-1$
	...
	static {
		try {
			fgResourceBundle = ResourceBundle.getBundle("org.eclipse.cldt.debug.mi.core.MIPluginResources"); //$NON-NLS-1$
