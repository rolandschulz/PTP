...
import org.eclipse.fdt.debug.mi.core.IMITTY;
...
import org.eclipse.fdt.debug.mi.core.command.MITargetAttach;
...
public class MIPlugin extends Plugin {
	 ...
	 */
	public static final String PLUGIN_ID = "org.eclipse.fdt.debug.mi.core" ; //$NON-NLS-1$
	...
	static {
		try {
			fgResourceBundle = ResourceBundle.getBundle("org.eclipse.fdt.debug.mi.core.MIPluginResources"); //$NON-NLS-1$
