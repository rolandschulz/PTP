...
public class Condition implements ICDICondition {
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDICondition#getIgnoreCount()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDICondition#getExpression()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.ICDICondition#getThreadId()
	 */
