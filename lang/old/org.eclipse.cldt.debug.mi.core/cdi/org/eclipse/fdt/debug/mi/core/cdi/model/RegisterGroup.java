...
public class RegisterGroup extends CObject implements ICDIRegisterGroup {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIRegisterGroup#getRegisterDescriptors()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIRegisterGroup#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIRegisterGroup#hasRegisters()
	 */
