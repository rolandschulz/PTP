...
import org.eclipse.fdt.debug.mi.core.command.MIDataWriteMemory;
import org.eclipse.fdt.debug.mi.core.output.MIDataReadMemoryInfo;
import org.eclipse.fdt.debug.mi.core.output.MIInfo;
import org.eclipse.fdt.debug.mi.core.output.MIMemory;
...
public class MemoryBlock extends CObject implements ICDIMemoryBlock {
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock#refresh()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock#getLength()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock#getStartAddress()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock#isFrozen()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock#setFrozen(boolean)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock#setValue(long, byte[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock#getFlags(int)
	 */
