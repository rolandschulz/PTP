...
import org.eclipse.fdt.debug.mi.core.cdi.model.Exceptionpoint;
...
import org.eclipse.fdt.debug.mi.core.command.MIBreakDelete;
import org.eclipse.fdt.debug.mi.core.command.MIBreakDisable;
import org.eclipse.fdt.debug.mi.core.command.MIBreakEnable;
import org.eclipse.fdt.debug.mi.core.command.MIBreakInsert;
import org.eclipse.fdt.debug.mi.core.command.MIBreakList;
import org.eclipse.fdt.debug.mi.core.command.MIBreakWatch;
...
import org.eclipse.fdt.debug.mi.core.output.MIBreakInsertInfo;
import org.eclipse.fdt.debug.mi.core.output.MIBreakListInfo;
import org.eclipse.fdt.debug.mi.core.output.MIBreakWatchInfo;
...
public class BreakpointManager extends Manager {
	...
	public void enableBreakpoint(Breakpoint breakpoint) throws CDIException {
		...
		List bList = (List)breakMap.get(target);
		if (bList == null) {
			throw new CDIException(CdiResources.getString("cdi.BreakpointManager.Not_a_FDT_breakpoint")); //$NON-NLS-1$			
		}
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDIBreakpointManager#allowProgramInterruption()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDIBreakpointManager#deleteBreakpoint(ICDIBreakpoint)
	 */
