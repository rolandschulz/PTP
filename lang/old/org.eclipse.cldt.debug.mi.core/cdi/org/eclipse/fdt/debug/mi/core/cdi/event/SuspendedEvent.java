 ...
 *******************************************************************************/
package org.eclipse.fdt.debug.mi.core.cdi.event;
...
import org.eclipse.fdt.debug.mi.core.cdi.BreakpointHit;
import org.eclipse.fdt.debug.mi.core.cdi.EndSteppingRange;
import org.eclipse.fdt.debug.mi.core.cdi.ErrorInfo;
import org.eclipse.fdt.debug.mi.core.cdi.FunctionFinished;
import org.eclipse.fdt.debug.mi.core.cdi.Session;
import org.eclipse.fdt.debug.mi.core.cdi.SharedLibraryEvent;
import org.eclipse.fdt.debug.mi.core.cdi.SignalReceived;
import org.eclipse.fdt.debug.mi.core.cdi.WatchpointScope;
import org.eclipse.fdt.debug.mi.core.cdi.WatchpointTrigger;
...
public class SuspendedEvent implements ICDISuspendedEvent {
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.event.ICDIEvent#getSource()
	 */
