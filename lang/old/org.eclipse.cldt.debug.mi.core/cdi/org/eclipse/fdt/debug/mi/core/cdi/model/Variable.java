...
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIArrayType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIBoolType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDICharType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIDoubleType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIEnumType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIFloatType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIFunctionType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIIntType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDILongLongType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDILongType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIPointerType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIReferenceType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIShortType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIStructType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIType;
import org.eclipse.fdt.debug.core.cdi.model.type.ICDIWCharType;
...
import org.eclipse.fdt.debug.mi.core.cdi.Format;
...
import org.eclipse.fdt.debug.mi.core.cdi.model.type.ArrayValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.BoolValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.CharValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.DoubleValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.EnumValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.FloatValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.FunctionValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.IntValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.LongLongValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.LongValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.PointerValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.ReferenceValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.ShortValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.StructValue;
import org.eclipse.fdt.debug.mi.core.cdi.model.type.WCharValue;
import org.eclipse.fdt.debug.mi.core.command.CommandFactory;
import org.eclipse.fdt.debug.mi.core.command.MIVarAssign;
import org.eclipse.fdt.debug.mi.core.command.MIVarInfoExpression;
import org.eclipse.fdt.debug.mi.core.command.MIVarInfoType;
import org.eclipse.fdt.debug.mi.core.command.MIVarListChildren;
import org.eclipse.fdt.debug.mi.core.command.MIVarSetFormat;
import org.eclipse.fdt.debug.mi.core.command.MIVarShowAttributes;
import org.eclipse.fdt.debug.mi.core.event.MIVarChangedEvent;
import org.eclipse.fdt.debug.mi.core.output.MIInfo;
import org.eclipse.fdt.debug.mi.core.output.MIVar;
import org.eclipse.fdt.debug.mi.core.output.MIVarInfoExpressionInfo;
import org.eclipse.fdt.debug.mi.core.output.MIVarInfoTypeInfo;
import org.eclipse.fdt.debug.mi.core.output.MIVarListChildrenInfo;
import org.eclipse.fdt.debug.mi.core.output.MIVarShowAttributesInfo;
...
public abstract class Variable extends VariableDescriptor implements ICDIVariable {
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIVariable#getValue()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIVariable#setValue(ICDIValue)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIVariable#setValue(String)
	 */
	 ...
	 * handle it.
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIVariable#isEditable()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIVariable#setFormat()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIVariable#equals()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIVariable#dispose()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIVariableDescriptor#getTypeName()
	 */
