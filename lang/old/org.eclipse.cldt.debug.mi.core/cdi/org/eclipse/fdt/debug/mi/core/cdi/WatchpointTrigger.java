...
public class WatchpointTrigger extends SessionObject implements ICDIWatchpointTrigger {
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDIWatchpointTrigger#getNewValue()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDIWatchpointTrigger#getOldValue()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDIWatchpointTrigger#getWatchpoint()
	 */
