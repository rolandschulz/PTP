...
import org.eclipse.fdt.debug.core.cdi.model.ICDIExceptionpoint;
import org.eclipse.fdt.debug.core.cdi.model.ICDIExpression;
import org.eclipse.fdt.debug.core.cdi.model.ICDIInstruction;
import org.eclipse.fdt.debug.core.cdi.model.ICDILocationBreakpoint;
import org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock;
import org.eclipse.fdt.debug.core.cdi.model.ICDIMixedInstruction;
import org.eclipse.fdt.debug.core.cdi.model.ICDIRegisterGroup;
...
import org.eclipse.fdt.debug.mi.core.CoreProcess;
import org.eclipse.fdt.debug.mi.core.MIException;
import org.eclipse.fdt.debug.mi.core.MISession;
import org.eclipse.fdt.debug.mi.core.cdi.BreakpointManager;
import org.eclipse.fdt.debug.mi.core.cdi.CdiResources;
import org.eclipse.fdt.debug.mi.core.cdi.ExpressionManager;
import org.eclipse.fdt.debug.mi.core.cdi.MI2CDIException;
import org.eclipse.fdt.debug.mi.core.cdi.MemoryManager;
import org.eclipse.fdt.debug.mi.core.cdi.RegisterManager;
import org.eclipse.fdt.debug.mi.core.cdi.Session;
import org.eclipse.fdt.debug.mi.core.cdi.SessionObject;
import org.eclipse.fdt.debug.mi.core.cdi.SharedLibraryManager;
import org.eclipse.fdt.debug.mi.core.cdi.SignalManager;
...
import org.eclipse.fdt.debug.mi.core.command.MIDataEvaluateExpression;
import org.eclipse.fdt.debug.mi.core.command.MIExecContinue;
import org.eclipse.fdt.debug.mi.core.command.MIExecNext;
import org.eclipse.fdt.debug.mi.core.command.MIExecNextInstruction;
import org.eclipse.fdt.debug.mi.core.command.MIExecRun;
import org.eclipse.fdt.debug.mi.core.command.MIExecStep;
import org.eclipse.fdt.debug.mi.core.command.MIExecStepInstruction;
import org.eclipse.fdt.debug.mi.core.command.MIExecUntil;
import org.eclipse.fdt.debug.mi.core.command.MIInfoThreads;
import org.eclipse.fdt.debug.mi.core.command.MIJump;
import org.eclipse.fdt.debug.mi.core.command.MISignal;
import org.eclipse.fdt.debug.mi.core.command.MITargetDetach;
import org.eclipse.fdt.debug.mi.core.command.MIThreadSelect;
import org.eclipse.fdt.debug.mi.core.event.MIDetachedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIThreadCreatedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIThreadExitEvent;
import org.eclipse.fdt.debug.mi.core.output.MIDataEvaluateExpressionInfo;
import org.eclipse.fdt.debug.mi.core.output.MIFrame;
import org.eclipse.fdt.debug.mi.core.output.MIInfo;
import org.eclipse.fdt.debug.mi.core.output.MIInfoThreadsInfo;
import org.eclipse.fdt.debug.mi.core.output.MIThreadSelectInfo;
...
public class Target extends SessionObject implements ICDITarget {
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIObject#getTarget()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#setCurrentThread(ICDIThread)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#getThreads()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#restart()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#stepInto()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExecuteStep#stepInto(int)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#stepIntoInstruction()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExecuteStep#stepIntoInstruction(int)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#stepOver()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExecuteStep#stepOver(int)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#stepOverInstruction()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExecuteStep#stepOverInstruction(int)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#stepReturn()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#runUntil(ICDILocation)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExecuteStep#stepUntil(org.eclipse.fdt.debug.core.cdi.ICDILocation)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#suspend()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#disconnect()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#resume()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExecuteResume#resume(org.eclipse.fdt.debug.core.cdi.ICDILocation)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExecuteResume#resume(org.eclipse.fdt.debug.core.cdi.model.ICDISignal)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExecuteResume#resume(boolean)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#jump(ICDILocation)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#signal()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#signal(ICDISignal)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#terminate()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#isTerminated()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#isDisconnected()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#isSuspended()
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#getProcess()
	 */
	...
	throws CDIException {
	 ...
	 /* 
	  * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#createCondition(int, java.lang.String, String)
	  */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#createLocation(java.lang.String, java.lang.String, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#createLocation(long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#getRuntimeOptions()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExpressionManagement#createExpression(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExpressionManagement#getExpressions()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExpressionManagement#destroyExpression(org.eclipse.fdt.debug.core.cdi.model.ICDIExpression[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIExpressionManagement#destroyAllExpression()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISourceManagement#addSourcePaths(java.lang.String[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISourceManagement#getSourcePaths()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISourceManagement#getInstructions(java.math.BigInteger, java.math.BigInteger)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISourceManagement#getInstructions(java.lang.String, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISourceManagement#getInstructions(java.lang.String, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISourceManagement#getMixedInstructions(java.math.BigInteger, java.math.BigInteger)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISourceManagement#getMixedInstructions(java.lang.String, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISourceManagement#getMixedInstructions(java.lang.String, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlockManagement#createMemoryBlock(java.lang.String, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlockManagement#createMemoryBlock(java.math.BigInteger, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlockManagement#removeBlocks(org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlock[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlockManagement#removeAllBlocks()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDIMemoryBlockManagement#getMemoryBlocks()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDISharedLibraryManagement#getSharedLibraries()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#getGlobalVariableDescriptors(java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#getRegisterGroups()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.ICDITarget#getConfiguration()
	 */
