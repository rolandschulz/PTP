...
import org.eclipse.fdt.debug.core.cdi.ICDIEventManager;
...
import org.eclipse.fdt.debug.mi.core.cdi.event.ChangedEvent;
import org.eclipse.fdt.debug.mi.core.cdi.event.CreatedEvent;
import org.eclipse.fdt.debug.mi.core.cdi.event.DestroyedEvent;
import org.eclipse.fdt.debug.mi.core.cdi.event.DisconnectedEvent;
import org.eclipse.fdt.debug.mi.core.cdi.event.ExitedEvent;
import org.eclipse.fdt.debug.mi.core.cdi.event.MemoryChangedEvent;
import org.eclipse.fdt.debug.mi.core.cdi.event.ResumedEvent;
import org.eclipse.fdt.debug.mi.core.cdi.event.SuspendedEvent;
import org.eclipse.fdt.debug.mi.core.cdi.model.MemoryBlock;
import org.eclipse.fdt.debug.mi.core.cdi.model.Target;
import org.eclipse.fdt.debug.mi.core.cdi.model.Thread;
import org.eclipse.fdt.debug.mi.core.command.Command;
import org.eclipse.fdt.debug.mi.core.command.CommandFactory;
import org.eclipse.fdt.debug.mi.core.command.MIExecContinue;
import org.eclipse.fdt.debug.mi.core.command.MIExecFinish;
import org.eclipse.fdt.debug.mi.core.command.MIStackInfoDepth;
import org.eclipse.fdt.debug.mi.core.command.MIStackSelectFrame;
import org.eclipse.fdt.debug.mi.core.command.MIThreadSelect;
import org.eclipse.fdt.debug.mi.core.event.MIBreakpointChangedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIBreakpointCreatedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIBreakpointDeletedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIChangedEvent;
import org.eclipse.fdt.debug.mi.core.event.MICreatedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIDestroyedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIDetachedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIEvent;
import org.eclipse.fdt.debug.mi.core.event.MIGDBExitEvent;
import org.eclipse.fdt.debug.mi.core.event.MIInferiorCreatedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIInferiorExitEvent;
import org.eclipse.fdt.debug.mi.core.event.MIInferiorSignalExitEvent;
import org.eclipse.fdt.debug.mi.core.event.MIMemoryChangedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIMemoryCreatedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIRegisterChangedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIRegisterCreatedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIRunningEvent;
import org.eclipse.fdt.debug.mi.core.event.MISharedLibChangedEvent;
import org.eclipse.fdt.debug.mi.core.event.MISharedLibCreatedEvent;
import org.eclipse.fdt.debug.mi.core.event.MISharedLibEvent;
import org.eclipse.fdt.debug.mi.core.event.MISharedLibUnloadedEvent;
import org.eclipse.fdt.debug.mi.core.event.MISignalChangedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIStoppedEvent;
...
import org.eclipse.fdt.debug.mi.core.event.MIVarCreatedEvent;
import org.eclipse.fdt.debug.mi.core.event.MIVarDeletedEvent;
...
public class EventManager extends SessionObject implements ICDIEventManager, Observer {
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDIEventManager#addEventListener(ICDIEventListener)
	 */
	...
	/**
	 * @see org.eclipse.fdt.debug.core.cdi.ICDIEventManager#removeEventListener(ICDIEventListener)
	 */
