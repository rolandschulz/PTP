...
public class StructType extends AggregateType implements ICDIStructType {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.type.ICDIStructType#isClass()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.type.ICDIStructType#isStruct()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.debug.core.cdi.model.type.ICDIStructType#isUnion()
	 */
