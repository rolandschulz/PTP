...
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIArrayType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIBoolType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDICharType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIDoubleType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIEnumType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIFloatType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIFunctionType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIIntType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDILongLongType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDILongType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIPointerType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIReferenceType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIShortType;
import org.eclipse.cldt.debug.core.cdi.model.type.ICDIStructType;
...
import org.eclipse.cldt.debug.mi.core.cdi.Format;
...
import org.eclipse.cldt.debug.mi.core.cdi.model.type.ArrayValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.BoolValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.CharValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.DoubleValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.EnumValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.FloatValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.FunctionValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.IntValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.LongLongValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.LongValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.PointerValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.ReferenceValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.ShortValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.StructValue;
import org.eclipse.cldt.debug.mi.core.cdi.model.type.WCharValue;
import org.eclipse.cldt.debug.mi.core.command.CommandFactory;
import org.eclipse.cldt.debug.mi.core.command.MIVarAssign;
import org.eclipse.cldt.debug.mi.core.command.MIVarInfoExpression;
import org.eclipse.cldt.debug.mi.core.command.MIVarInfoType;
import org.eclipse.cldt.debug.mi.core.command.MIVarListChildren;
import org.eclipse.cldt.debug.mi.core.command.MIVarSetFormat;
import org.eclipse.cldt.debug.mi.core.command.MIVarShowAttributes;
...
import org.eclipse.cldt.debug.mi.core.output.MIVarInfoExpressionInfo;
import org.eclipse.cldt.debug.mi.core.output.MIVarInfoTypeInfo;
import org.eclipse.cldt.debug.mi.core.output.MIVarListChildrenInfo;
import org.eclipse.cldt.debug.mi.core.output.MIVarShowAttributesInfo;
...
public abstract class Variable extends VariableDescriptor implements ICDIVariable {
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.model.ICDIVariable#getValue()
	 */
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.model.ICDIVariable#setValue(ICDIValue)
	 */
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.model.ICDIVariable#setValue(String)
	 */
	 ...
	 * handle it.
	 * @see org.eclipse.cldt.debug.core.cdi.model.ICDIVariable#isEditable()
	 */
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.model.ICDIVariable#setFormat()
	 */
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.model.ICDIVariable#equals()
	 */
