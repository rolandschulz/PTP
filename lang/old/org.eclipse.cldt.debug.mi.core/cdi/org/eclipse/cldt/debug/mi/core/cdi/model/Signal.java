...
import org.eclipse.cldt.debug.mi.core.output.MISigHandle;
...
public class Signal extends CObject implements ICDISignal {
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.ICDISignal#getMeaning()
	 */
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.ICDISignal#getName()
	 */
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.ICDISignal#handle()
	 */
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.ICDISignal#isIgnore()
	 */
	...
	/**
	 * @see org.eclipse.cldt.debug.core.cdi.ICDISignal#isStopSet()
	 */
