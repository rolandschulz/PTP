...
import org.eclipse.cldt.debug.mi.core.command.CLICommand;
...
import org.eclipse.cldt.debug.mi.core.command.MIExecReturn;
...
import org.eclipse.cldt.debug.mi.core.command.MIInterpreterExecConsole;
import org.eclipse.cldt.debug.mi.core.event.MIBreakpointHitEvent;
import org.eclipse.cldt.debug.mi.core.event.MIErrorEvent;
import org.eclipse.cldt.debug.mi.core.event.MIEvent;
import org.eclipse.cldt.debug.mi.core.event.MIFunctionFinishedEvent;
...
import org.eclipse.cldt.debug.mi.core.event.MILocationReachedEvent;
import org.eclipse.cldt.debug.mi.core.event.MIRunningEvent;
import org.eclipse.cldt.debug.mi.core.event.MISharedLibEvent;
import org.eclipse.cldt.debug.mi.core.event.MISignalEvent;
import org.eclipse.cldt.debug.mi.core.event.MISteppingRangeEvent;
import org.eclipse.cldt.debug.mi.core.event.MIStoppedEvent;
import org.eclipse.cldt.debug.mi.core.event.MIWatchpointScopeEvent;
import org.eclipse.cldt.debug.mi.core.event.MIWatchpointTriggerEvent;
import org.eclipse.cldt.debug.mi.core.output.MIAsyncRecord;
import org.eclipse.cldt.debug.mi.core.output.MIConsoleStreamOutput;
import org.eclipse.cldt.debug.mi.core.output.MIConst;
import org.eclipse.cldt.debug.mi.core.output.MIExecAsyncOutput;
import org.eclipse.cldt.debug.mi.core.output.MILogStreamOutput;
import org.eclipse.cldt.debug.mi.core.output.MINotifyAsyncOutput;
import org.eclipse.cldt.debug.mi.core.output.MIOOBRecord;
import org.eclipse.cldt.debug.mi.core.output.MIOutput;
import org.eclipse.cldt.debug.mi.core.output.MIParser;
import org.eclipse.cldt.debug.mi.core.output.MIResult;
import org.eclipse.cldt.debug.mi.core.output.MIResultRecord;
import org.eclipse.cldt.debug.mi.core.output.MIStatusAsyncOutput;
import org.eclipse.cldt.debug.mi.core.output.MIStreamRecord;
import org.eclipse.cldt.debug.mi.core.output.MITargetStreamOutput;
import org.eclipse.cldt.debug.mi.core.output.MIValue;
