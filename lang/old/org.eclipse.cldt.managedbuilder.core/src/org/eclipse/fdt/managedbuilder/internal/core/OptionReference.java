...
public class OptionReference implements IOption {
	...
	//       it is not handled in converting from the FDT 2.0 object model
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.build.managed.IBuildObject#getId()
	 */
	public String getId() {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.build.managed.IBuildObject#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.build.managed.IOption#getBooleanValue()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.managedbuilder.core.IOption#getSelectedEnum()
	 */
