...
***********************************************************************/
package org.eclipse.fdt.internal.corext.refactoring.rename;
...
import org.eclipse.fdt.core.model.IEnumerator;
import org.eclipse.fdt.core.model.IField;
import org.eclipse.fdt.core.model.IFunction;
import org.eclipse.fdt.core.model.IFunctionDeclaration;
...
import org.eclipse.fdt.core.model.ISourceManipulation;
...
import org.eclipse.fdt.internal.corext.refactoring.Checks;
import org.eclipse.fdt.internal.corext.refactoring.CompositeChange;
import org.eclipse.fdt.internal.corext.refactoring.IReferenceUpdating;
import org.eclipse.fdt.internal.corext.refactoring.RefactoringCoreMessages;
import org.eclipse.fdt.internal.corext.refactoring.RefactoringSearchEngine;
import org.eclipse.fdt.internal.corext.refactoring.RenameProcessor;
import org.eclipse.fdt.internal.corext.refactoring.ResourceUtil;
import org.eclipse.fdt.internal.corext.refactoring.SearchResultGroup;
import org.eclipse.fdt.internal.corext.refactoring.TextChangeManager;
...
public class RenameElementProcessor extends RenameProcessor implements IReferenceUpdating{
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IRefactoringProcessor#initialize(java.lang.Object[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IRefactoringProcessor#isAvailable()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IRefactoringProcessor#getProcessorName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IRefactoringProcessor#getElements()
	 */
	...
	//---- IRenameProcessor ----------------------------------------------
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IRenameProcessor#getCurrentElementName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IReferenceUpdating#canEnableUpdateReferences()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IReferenceUpdating#getUpdateReferences()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IReferenceUpdating#setUpdateReferences(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.ITextUpdating#canEnableTextUpdating()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IRefactoringProcessor#checkActivation()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IRefactoringProcessor#checkInput(org.eclipse.core.runtime.IProgressMonitor)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.internal.corext.refactoring.IRefactoringProcessor#createChange(org.eclipse.core.runtime.IProgressMonitor)
	 */
