...
import org.eclipse.cldt.internal.ui.refactoring.actions.RedoRefactoringAction;
import org.eclipse.cldt.internal.ui.refactoring.actions.RenameRefactoringAction;
import org.eclipse.cldt.internal.ui.refactoring.actions.UndoRefactoringAction;
...
public class RefactoringActionGroup extends ActionGroup {
	...
	/**
	 * Pop-up menu: id of the refactor sub menu (value <code>org.eclipse.cldt.ui.refactoring.menu</code>).
	 * 
	 * @since 2.1
	 */
	public static final String MENU_ID= "org.eclipse.cldt.ui.refactoring.menu"; //$NON-NLS-1$
	 ...
	 * (value <code>"org.eclipse.cldt.ui.actions.refactor.Rename"</code>).
	 */
	public static final String REFACTOR_RENAME= "org.eclipse.cldt.ui.actions.refactor.RenameAction"; //$NON-NLS-1$
	/**
	 * Refactor menu: name of standard Undo global action
	 * (value <code>"org.eclipse.cldt.ui.actions.refactor.undo"</code>).
	 */
	public static final String REFACTOR_UNDO= "org.eclipse.cldt.ui.actions.refactor.UndoAction"; //$NON-NLS-1$
	/**
	 * Refactor menu: name of standard Redo global action
	 * (value <code>"org.eclipse.cldt.ui.actions.refactor.redo"</code>).
	 */
	public static final String REFACTOR_REDO= "org.eclipse.cldt.ui.actions.refactor.RedoAction"; //$NON-NLS-1$
