...
public class CMarkerAnnotation extends MarkerAnnotation implements IProblemAnnotation, ICAnnotation {		
	...
	public static final String C_MARKER_TYPE_PREFIX= "org.eclipse.cldt"; //$NON-NLS-1$
	public static final String ERROR_ANNOTATION_TYPE= "org.eclipse.cldt.ui.error"; //$NON-NLS-1$
	public static final String WARNING_ANNOTATION_TYPE= "org.eclipse.cldt.ui.warning"; //$NON-NLS-1$
	public static final String INFO_ANNOTATION_TYPE= "org.eclipse.cldt.ui.info"; //$NON-NLS-1$
