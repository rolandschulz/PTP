...
import org.eclipse.cldt.core.model.BufferChangedEvent;
import org.eclipse.cldt.core.model.CModelException;
import org.eclipse.cldt.core.model.IBuffer;
import org.eclipse.cldt.core.model.IBufferChangedListener;
...
public class DocumentAdapter implements IBuffer, IDocumentListener {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#append(char)
	 */
	public void append(char[] text) {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#append(java.lang.String)
	 */
	public void append(String text) {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#close()
	 */
	public void close() {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#getChar(int)
	 */
	public char getChar(int position) {
		try {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#getCharacters()
	 */
	public char[] getCharacters() {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#getContents()
	 */
	public String getContents() {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#getLength()
	 */
	public int getLength() {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#getOwner()
	 */
	public IOpenable getOwner() {
		return fOwner;
	}
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#getText(int, int)
	 */
	public String getText(int offset, int length) {
		try {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#getUnderlyingResource()
	 */
	public IResource getUnderlyingResource() {
		return fFile;
	}
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#hasUnsavedChanges()
	 */
	public boolean hasUnsavedChanges() {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#isClosed()
	 */
	public boolean isClosed() {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#isReadOnly()
	 */
	public boolean isReadOnly() {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#replace(int, int, char)
	 */
	public void replace(int position, int length, char[] text) {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#replace(int, int, java.lang.String)
	 */
	public void replace(int position, int length, String text) {
		if (DEBUG_LINE_DELIMITERS) {
			validateLineDelimiters(text);
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#save(org.eclipse.core.runtime.IProgressMonitor, boolean)
	 */
	public void save(IProgressMonitor progress, boolean force) throws CModelException {
		try {
			if (fTextFileBuffer != null)
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#setContents(char)
	 */
	public void setContents(char[] contents) {
	...
	/**
	 * @see org.eclipse.cldt.internal.core.model.IBuffer#setContents(java.lang.String)
	 */
	public void setContents(String contents) {
