...
import org.eclipse.cldt.core.search.ICSearchConstants.LimitTo;
import org.eclipse.cldt.core.search.ICSearchConstants.SearchFor;
import org.eclipse.cldt.internal.ui.editor.FortranEditor;
import org.eclipse.cldt.internal.ui.search.CSearchQuery;
import org.eclipse.cldt.internal.ui.search.CSearchResultCollector;
	...
	public void run(ITextSelection sel){
		...
		try{
			...
			if (vmErr instanceof OutOfMemoryError){
				org.eclipse.cldt.internal.core.model.Util.log(null, "Selection Search Out Of Memory error: " + vmErr.getMessage() + " on File: " + resourceFile.getName(), ICLogConstants.CDT); //$NON-NLS-1$ //$NON-NLS-2$
			}
		}
