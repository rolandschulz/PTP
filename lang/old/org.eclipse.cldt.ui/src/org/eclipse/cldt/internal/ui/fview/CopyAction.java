	...
	private void setClipboard(IResource[] resources, String[] fileNames, String names) {
		try {
			...
			if (e.code != DND.ERROR_CANNOT_SET_CLIPBOARD)
				throw e;
			if (MessageDialog.openQuestion(shell, FortranViewMessages.getString("CopyToClipboardProblemDialog.title"), FortranViewMessages.getString("CopyToClipboardProblemDialog.message"))) //$NON-NLS-1$ //$NON-NLS-2$
