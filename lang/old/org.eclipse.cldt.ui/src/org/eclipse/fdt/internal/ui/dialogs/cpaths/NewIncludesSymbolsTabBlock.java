...
public class NewIncludesSymbolsTabBlock extends AbstractPathOptionBlock implements IStatusChangeListener {
	...
	protected int[] getFilteredTypes() {
		return new int[] {IPathEntry.FDT_INCLUDE, IPathEntry.FDT_MACRO, IPathEntry.FDT_CONTAINER};
	}

	protected int[] getAppliedFilteredTypes() {
		return new int[] {IPathEntry.FDT_INCLUDE, IPathEntry.FDT_MACRO};
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.fdt.internal.ui.dialogs.IStatusChangeListener#statusChanged(org.eclipse.core.runtime.IStatus)
	 */
