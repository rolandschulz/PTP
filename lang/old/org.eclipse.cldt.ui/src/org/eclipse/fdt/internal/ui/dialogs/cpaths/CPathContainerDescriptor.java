...
public class CPathContainerDescriptor implements IContainerDescriptor {
	...
	public class PathEntryContainerPageAdapter implements IWizardPage, IPathEntryContainerPage {
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.ui.wizards.IPathEntryContainerPage#initialize(org.eclipse.fdt.core.model.ICProject, org.eclipse.fdt.core.model.IPathEntry[])
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.ui.wizards.IPathEntryContainerPage#finish()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.ui.wizards.IPathEntryContainerPage#getNewContainers()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.ui.wizards.IPathEntryContainerPage#setSelection(org.eclipse.fdt.core.model.IContainerEntry)
		 */
