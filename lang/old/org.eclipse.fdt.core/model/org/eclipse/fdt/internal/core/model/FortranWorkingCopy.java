 ...
 */
public class FortranWorkingCopy extends FortranTranslationUnit implements IWorkingCopy {
	 ...
	 */
	public FortranWorkingCopy(ICElement parent, IFile file, String id, IBufferFactory bufferFactory) {
		this(parent, file, id, bufferFactory, null);
	}
	public FortranWorkingCopy(ICElement parent, IFile file, String id, IBufferFactory bufferFactory, IProblemRequestor requestor) {
	...
	public FortranWorkingCopy(ICElement parent, IPath path, String id, IBufferFactory bufferFactory) {
	...
	public ITranslationUnit getOriginalElement() {
		...
		return new FortranTranslationUnit(getParent(), getFile(), id);
	}
	...
	public void restore() throws CModelException{
		...
		FortranTranslationUnit original = (FortranTranslationUnit) getOriginalElement();
	 ...
	 * @throws CModelException
	 */
	protected void updateTimeStamp(FortranTranslationUnit original) throws CModelException {
		long timeStamp =
