 ...
 */
public class FortranEditor extends CEditor implements ISelectionChangedListener, IShowInSource , IReconcilingParticipant{
...
//		String key= forward ? preference.getIsGoToNextNavigationTargetKey() : preference.getIsGoToPreviousNavigationTargetKey();
	...
	public final static String LANGUAGE_FORTRAN = "FortranEditor.language.f"; //$NON-NLS-1$
