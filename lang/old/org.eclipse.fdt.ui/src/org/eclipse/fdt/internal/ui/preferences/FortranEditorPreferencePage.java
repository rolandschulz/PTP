...
import org.eclipse.cdt.internal.ui.preferences.CEditorHoverConfigurationBlock;
 ...
 */
public class FortranEditorPreferencePage extends CEditorPreferencePage implements IWorkbenchPreferencePage {

	protected final String[][] fListModel = new String[][] { {
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags.singleLine"), IFortranColorConstants.FORTRAN_SINGLE_LINE_COMMENT }, { //$NON-NLS-1$
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags.keywords"), IFortranColorConstants.FORTRAN_KEYWORD }, { //$NON-NLS-1$
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags.builtInTypes"), IFortranColorConstants.FORTRAN_TYPE }, { //$NON-NLS-1$
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags.strings"), IFortranColorConstants.FORTRAN_STRING }, { //$NON-NLS-1$
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags.operators"), IFortranColorConstants.FORTRAN_OPERATOR }, { //$NON-NLS-1$
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags.braces"), IFortranColorConstants.FORTRAN_BRACES }, { //$NON-NLS-1$
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags.numbers"), IFortranColorConstants.FORTRAN_NUMBER }, { //$NON-NLS-1$            
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags.others"), IFortranColorConstants.FORTRAN_DEFAULT }, { //$NON-NLS-1$
		PreferencesMessages.getString("FortranEditorPreferencePage.fortranCommentTaskTags"), PreferenceConstants.EDITOR_TASK_TAG_COLOR } //$NON-NLS-1$
	};
	...
	private FortranTextTools fFortranTextTools;
	...
	private Control createPreviewer(Composite parent) {
		...
		IDocumentPartitioner partitioner = fFortranTextTools.createDocumentPartitioner();
	...
	public void dispose() {
		...
		if (fFortranTextTools != null) {
			fFortranTextTools = null;
		}
