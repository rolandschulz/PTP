...
public class FortranContentOutlinePage extends Page implements IContentOutlinePage, ISelectionChangedListener {
	...
	public class IncludeGroupingAction extends Action {
		FortranContentOutlinePage outLine;

		public IncludeGroupingAction(FortranContentOutlinePage outlinePage) {
	...
	public class ToggleLinkingAction extends AbstractToggleLinkingAction {
	    ...
	    FortranContentOutlinePage fOutlinePage;
		 ...
		 */
		public ToggleLinkingAction(FortranContentOutlinePage outlinePage) {
	...
	public FortranContentOutlinePage(FortranEditor editor) {
		this("#TranslationUnitOutlinerContext", editor); //$NON-NLS-1$
	}
	
	public FortranContentOutlinePage(String contextMenuID, FortranEditor editor) {
		super();
		fEditor= editor;
		fInput= null;
