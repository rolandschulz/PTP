...
public class DiscoveredScannerInfo implements IScannerInfo {
	...
	private  org.eclipse.cldt.make.core.MakeScannerInfo userInfo;
	...
	public  org.eclipse.cldt.make.core.MakeScannerInfo getUserScannerInfo() {
		return userInfo;
	}

	public synchronized void setUserScannerInfo( org.eclipse.cldt.make.core.MakeScannerInfo info) {
		userInfo = info;
	}
