...
public class GCCSpecsRunSIProvider extends DefaultRunSIProvider {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.make.internal.core.scannerconfig2.DefaultRunSIProvider#initialize()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.fdt.make.internal.core.scannerconfig2.DefaultRunSIProvider#prepareArguments(boolean)
     */
