...
import org.eclipse.fdt.make.internal.core.scannerconfig2.ScannerConfigProfile.ScannerInfoProvider;
...
//	 following require prefix: profileId
	...
	private static abstract class Store implements IScannerConfigBuilderInfo2 {
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#isAutoDiscoveryEnabled()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setAutoDiscoveryEnabled(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#isSIProblemGenerationEnabled()
		 */
		public boolean isProblemReportingEnabled() {
			return problemReportingEnabled;
		}
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setSIProblemGenerationEnabled(boolean)
		 */
		public void setProblemReportingEnabled(boolean enable) {
            problemReportingEnabled = setDirty(problemReportingEnabled, enable);
		}
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#getSelectedProfileId()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setSelectedProfileId(java.lang.String)
		 */
...
//			}
        ...
        /* (non-Javadoc)
         * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#getProfileIdList()
         */
        ...
        /* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#isBuildOutputFileActionEnabled()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setBuildOutputFileActionEnabled(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#getBuildOutputFilePath()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setBuildOutputFilePath(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#isBuildOutputParserEnabled()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setBuildOutputParserEnabled(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#getSIProviderIdList()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#addSIProvider(java.lang.String)
		 */
...
//		}
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#removeSIProvider(java.lang.String)
		 */
...
//		}
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#isSIProviderOutputParserEnabled(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setSIProviderOutputParserEnabled(java.lang.String, boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#isUseDefaultProviderCommand(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setUseDefaultProviderCommand(java.lang.String, boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#getProviderRunCommand(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setProviderRunCommand(java.lang.String, java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#getProviderRunArguments(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setProviderRunArguments(java.lang.String, java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#getProviderOpenFilePath(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#setProviderOpenFilePath(java.lang.String, java.lang.String)
		 */
...
//		public abstract void store();
	...
	/**
	 * Build properties stored in .fdtproject file
	 * 
	 * @author vhirsl
	 */
	private static class BuildProperty extends Store {
        ...
        /* (non-Javadoc)
         * @see org.eclipse.fdt.make.internal.core.scannerconfig2.ScannerConfigInfoFactory2.Store#load()
         */
        protected void load() {
...
//							providerId).getProviderKind();
        ...
        /* (non-Javadoc)
         * @see org.eclipse.fdt.make.core.scannerconfig.IScannerConfigBuilderInfo2#save()
         */
