 ...
 *******************************************************************************/
package org.eclipse.fdt.make.internal.core.makefile;
...
public class MacroDefinition extends Directive implements IMacroDefinition {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.make.core.makefile.IMacroDefinition#isFromCommand()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.make.core.makefile.IMacroDefinition#isFromDefault()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.make.core.makefile.IMacroDefinition#isFromEnviroment()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.make.core.makefile.IMacroDefinition#isFromMakefile()
	 */
