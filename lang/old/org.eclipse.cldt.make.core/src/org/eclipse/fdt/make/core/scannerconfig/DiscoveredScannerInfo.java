...
public class DiscoveredScannerInfo implements IScannerInfo {
	...
	private  org.eclipse.fdt.make.core.MakeScannerInfo userInfo;
	...
	/* (non-Javadoc)
	 * @see org.eclipse.fdt.core.parser.IScannerInfo#getIncludePaths()
	 */
	...
	public  org.eclipse.fdt.make.core.MakeScannerInfo getUserScannerInfo() {
		return userInfo;
	}

	public synchronized void setUserScannerInfo( org.eclipse.fdt.make.core.MakeScannerInfo info) {
		userInfo = info;
	}
