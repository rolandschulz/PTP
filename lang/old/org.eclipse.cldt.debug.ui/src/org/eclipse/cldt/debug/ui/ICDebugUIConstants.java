...
public interface ICDebugUIConstants {
	/**
	 * C/C++ Debug UI plug-in identifier (value <code>"org.eclipse.cldt.debug.ui"</code>).
	 */
	...
	/**
	 * Modules view identifier (value <code>"org.eclipse.cldt.debug.ui.ModulesView"</code>).
	 */
