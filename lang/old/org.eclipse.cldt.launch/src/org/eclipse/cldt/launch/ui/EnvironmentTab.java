...
public class EnvironmentTab extends LaunchConfigurationTab {
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy config) {
		config.setAttribute(IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ENVIROMENT_MAP, (Map) null);
		config.setAttribute(IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ENVIROMENT_INHERIT, true);
	}

	public void initializeFrom(ILaunchConfiguration config) {
		try {
			Map env = config.getAttribute(IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ENVIROMENT_MAP, (Map) null);
			if (env != null) {
				fElements.clear();
			...
			//			config.getAttribute(IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ENVIROMENT_INHERIT, true);
		} catch (CoreException e) {
		}
	}

	public void performApply(ILaunchConfigurationWorkingCopy config) {
		config.setAttribute(IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ENVIROMENT_MAP, (Map) fElements.clone());
		config.setAttribute(IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ENVIROMENT_INHERIT, true);
	}
