...
public class CoreFileLaunchDelegate extends AbstractLaunchDelegate {
	...
	protected IPath promptForCoreFilePath(final IProject project, final ICDebugConfiguration debugConfig) throws CoreException {
		...
		IStatus processPrompt = new Status(IStatus.INFO, "org.eclipse.cldt.launch", 101, "", null); //$NON-NLS-1$//$NON-NLS-2$
