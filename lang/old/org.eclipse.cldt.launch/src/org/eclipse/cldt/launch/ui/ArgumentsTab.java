...
import org.eclipse.cldt.launch.internal.ui.WorkingDirectoryBlock;
...
//		addControlAccessibleListener(fArgumentVariablesButton, fArgumentVariablesButton.getText()); // need to strip the mnemonic from buttons
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy config) {
		config.setAttribute(IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS, (String) null);
		config.setAttribute(IFDTLaunchConfigurationConstants.ATTR_WORKING_DIRECTORY, (String) null);
	}
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		try {
			fPrgmArgumentsText.setText(configuration.getAttribute(IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS, "")); //$NON-NLS-1$
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(
			IFDTLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS,
