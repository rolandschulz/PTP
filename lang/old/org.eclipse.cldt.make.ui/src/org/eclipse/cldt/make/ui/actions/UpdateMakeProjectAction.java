 ...
 *******************************************************************************/
package org.eclipse.cldt.make.ui.actions;
...
import org.eclipse.cldt.make.ui.wizards.UpdateMakeProjectWizard;
	...
	public static class TargetConvertVisitor implements IResourceProxyVisitor {
		...
		public boolean visit(IResourceProxy proxy) throws CoreException {
			try {
				...
				QualifiedName qName = new QualifiedName("org.eclipse.cldt.make", "goals"); //$NON-NLS-1$ //$NON-NLS-2$
