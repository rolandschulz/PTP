 ...
 *******************************************************************************/
package org.eclipse.fdt.make.ui.actions;
...
import org.eclipse.fdt.make.ui.wizards.UpdateMakeProjectWizard;
	...
	public static class TargetConvertVisitor implements IResourceProxyVisitor {
		...
		public boolean visit(IResourceProxy proxy) throws CoreException {
			try {
				...
				QualifiedName qName = new QualifiedName("org.eclipse.fdt.make", "goals"); //$NON-NLS-1$ //$NON-NLS-2$
