...
public class RemoteMakefileWizard extends AbstractCWizard {
	...
	public static final String ID = "org.eclipse.ptp.rdt.sync.ui.wizards.RemoteMakefileWizard"; //$NON-NLS-1$
	public static final String NAME = Messages.RemoteMakefileWizard_0;
	public static final String EMPTY_PROJECT = Messages.RemoteMakefileWizard_1;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.cdt.ui.wizards.CNewWizard#createItems(boolean,
