...
public class RemoteBuildServiceFileLocationWidget extends Composite {
	...
	public RemoteBuildServiceFileLocationWidget(Composite parent, int style, final IRemoteServices remoteServices,
		...
		group.setText(Messages.RemoteBuildServiceFileLocationWidget_1);
		...
		browseButton.setText(Messages.IndexFileLocationWidget_1);
		...
		defaultButton.setText(Messages.IndexFileLocationWidget_2);
	...
	private void browse() {
		...
		String remotePath = fmConnection.browseDirectory(this.getShell(), Messages.RemoteBuildServiceFileLocationWidget_0,
				text.getText(), IRemoteUIConstants.NONE);
		if (remotePath != null)
