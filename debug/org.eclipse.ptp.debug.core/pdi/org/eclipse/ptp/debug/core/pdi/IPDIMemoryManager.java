 ...
 *
 */
public interface IPDIMemoryManager extends IPDISessionObject {
	/**
	 ...
	 */
	IPDIMemoryBlock createMemoryBlock(BitList qTasks, String address, int units, int wordSize) throws PDIException;
	 ...
	 * @throws PDIException on failure
	 */
	IPDIMemoryBlock[] getMemoryBlocks(BitList qTasks) throws PDIException;
	 ...
	 * @throws PDIException on failure
	 */
	void removeBlocks(BitList tasks, IPDIMemoryBlock[] memoryBlocks) throws PDIException;
	 ...
	 * @throws PDIException on failure
	 */
	void removeAllBlocks(BitList tasks) throws PDIException;
}
