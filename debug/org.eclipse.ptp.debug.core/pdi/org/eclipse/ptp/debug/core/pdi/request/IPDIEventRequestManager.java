 ...
 *
 */
public interface IPDIEventRequestManager extends IPDISessionObject {
	/**
	 ...
	 * @throws PDIException on failure
	 */
	void deleteEventRequest(IPDIEventRequest request) throws PDIException;
	/**
	 ...
	 * @throws PDIException on failure
	 */
	void execute(IPDIEventRequest request) throws PDIException;
}
