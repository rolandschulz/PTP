...
public class GlobalVariable extends Variable implements IPDIGlobalVariable {
	...
	public GlobalVariable(IPDISession session, TaskSet tasks, IPDIThread thread, IPDIStackFrame frame, String name, String fullName, int pos, int depth, String varid) {
