...
public interface IPTPLaunchConfigurationConstants {
	 ...
	 */
	public static final String ID_LAUNCH_C_APP = "org.eclipse.ptp.launch.localCLaunch"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_PROGRAM_ARGUMENTS = PTP_LAUNCH_ID + ".PROGRAM_ARGUMENTS"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_WORKING_DIRECTORY = PTP_LAUNCH_ID + ".WORKING_DIRECTORY"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_USE_TERMINAL = PTP_LAUNCH_ID + ".use_terminal"; //$NON-NLS-1$
	 ...
	 */
	public static final String ATTR_ATTACH_PROCESS_ID = PTP_LAUNCH_ID + ".ATTACH_PROCESS_ID"; //$NON-NLS-1$
	 ...
	 * interface.
	 */
	public static final String ATTR_COREFILE_PATH = PTP_LAUNCH_ID + ".COREFILE_PATH"; //$NON-NLS-1$
	...
	/**
	 * Status code indicating that the PTP debugger is missing
	 * <p>
	 * A status handler may be registered for this error condition, and should
