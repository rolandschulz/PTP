 ...
 */
public class CModule extends PDebugElement implements ICModule {
	...
	public static CModule createExecutable( PDebugTarget target, IPath path ) {
		// TODO Add support for executables to CDI.
		return new CModule( EXECUTABLE, target, path );
	}

	public static CModule createSharedLibrary( PDebugTarget target, ICDISharedLibrary lib ) {
	 ...
	 */
	private CModule( int type, PDebugTarget target, IPath path ) {
		super( target );
		fType = type;
	 ...
	 * Constructor for CModule. 
	 */
	private CModule( int type, PDebugTarget target, ICDIObject cdiObject ) {
		super( target );
		fType = type;
	...
	public boolean isLittleEndian() {
		return ( fCElement instanceof IBinary ) ? ((IBinary)fCElement).isLittleEndian() : ((PDebugTarget)getDebugTarget()).isLittleEndian();
	}
	...
	public IAddressFactory getAddressFactory() {
		return ((PDebugTarget)getDebugTarget()).getAddressFactory();
	}
