...
import org.eclipse.ptp.debug.internal.core.model.CRegisterDescriptor;
import org.eclipse.ptp.debug.internal.core.model.CRegisterGroup;
...
public class PRegisterManager {
	 ...
	 */
	public PRegisterManager( PDebugTarget target ) {
		fDebugTarget = target;
	}
	...
	public Object getAdapter( Class adapter ) {
		if ( PRegisterManager.class.equals( adapter ) )
			return this;
		return null;
	}
	...
	public void save() {
		...
		try {
			...
			wc.setAttribute( IPTPLaunchConfigurationConstants.ATTR_DEBUGGER_REGISTER_GROUPS, getMemento() );
			wc.doSave();
		}
		catch( CoreException e ) {
			PTPDebugCorePlugin.log( e );
