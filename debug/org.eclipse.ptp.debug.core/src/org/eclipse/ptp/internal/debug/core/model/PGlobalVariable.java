...
public class PGlobalVariable extends PVariable implements IPGlobalVariable {
		...
		public void setValue(String expression) throws DebugException {
			...
			try {
				...
				if (pdiVariable != null) {
					...
					requestFailed(Messages.PGlobalVariable_0, null);
				}
			} catch (final PDIException e) {
	...
	private final IPGlobalVariableDescriptor fDescriptor;
	...
	protected PGlobalVariable(PDebugElement parent, IPGlobalVariableDescriptor descriptor,
			IPDIVariableDescriptor pdiVariableObject, String message) {
