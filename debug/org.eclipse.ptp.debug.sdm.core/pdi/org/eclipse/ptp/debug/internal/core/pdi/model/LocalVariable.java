...
public class LocalVariable extends Variable implements IPDILocalVariable {
	public LocalVariable(Session session, LocalVariableDescriptor varDesc, String varid) {
		super(session, varDesc, varid);
	}
	public LocalVariable(Session session, BitList tasks, Thread thread, StackFrame frame, String name, String fullName, int pos, int depth, String varid) {
