 ...
 *
 */
public class SetCurrentStackFrameRequest extends InternalEventRequest implements IPDISetCurrentStackFrameRequest {
	private int level = 0;
	public SetCurrentStackFrameRequest(Session session, BitList tasks, int level) {
		super(tasks);
		this.level = level;
	}
