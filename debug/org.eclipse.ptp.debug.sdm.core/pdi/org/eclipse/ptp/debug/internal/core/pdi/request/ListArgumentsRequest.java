 ...
 *
 */
public class ListArgumentsRequest extends InternalEventRequest implements IPDIListArgumentsRequest {
	private int low = 0;
	private int high = 0;
	
	public ListArgumentsRequest(Session session, BitList tasks, int low, int high) {
		super(tasks);
		this.low = low;
		this.high = high;
	}
