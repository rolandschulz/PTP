 ...
 *
 */
public class GetStackInfoDepthRequest extends InternalEventRequest implements IPDIGetStackInfoDepthRequest {
	public GetStackInfoDepthRequest(BitList tasks) {
		super(tasks);
	}
