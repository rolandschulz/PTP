...
public class GlobalVariable extends Variable implements IPDIGlobalVariable {
	public GlobalVariable(Session session, GlobalVariableDescriptor varDesc, String varid) {
		super(session, varDesc, varid);
	}
	public GlobalVariable(Session session, BitList tasks, Thread thread, StackFrame frame, String name, String fullName, int pos, int depth, String varid) {
