 ...
 *
 */
public class DataEvaluateExpressionRequest extends InternalEventRequest implements IPDIDataEvaluateExpressionRequest {
	private String expr;
	
	public DataEvaluateExpressionRequest(BitList tasks, String expr) {
		super(tasks);
		this.expr = expr;
	}
