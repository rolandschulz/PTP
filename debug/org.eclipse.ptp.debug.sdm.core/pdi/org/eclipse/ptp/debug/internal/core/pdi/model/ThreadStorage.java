...
public class ThreadStorage extends Variable implements IPDIThreadStorage {
	public ThreadStorage(Session session, ThreadStorageDescriptor threadDesc, String varid) {
		super(session, threadDesc, varid);
	}
	public ThreadStorage(Session session, BitList tasks, Thread thread, StackFrame frame, String name, String fullName, int pos, int depth, String varid) {
