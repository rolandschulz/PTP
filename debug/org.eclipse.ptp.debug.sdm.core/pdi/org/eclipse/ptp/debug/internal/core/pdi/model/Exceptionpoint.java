...
public class Exceptionpoint extends Breakpoint implements IPDIExceptionpoint {
	...
	public Exceptionpoint(Session session, BitList tasks, String clazz, boolean stopOnThrow, boolean stopOnCatch, IPDICondition condition, boolean enabled, IPDIFunctionBreakpoint[] funcBpts) {
