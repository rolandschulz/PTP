...
public class GlobalVariableDescriptor extends VariableDescriptor implements IPDIGlobalVariableDescriptor {
	public GlobalVariableDescriptor(Session session, BitList tasks, Thread thread, StackFrame stack, String n, String fn, int pos, int depth) {
		super(session, tasks, thread, stack, n, fn, pos, depth);
	}
}
