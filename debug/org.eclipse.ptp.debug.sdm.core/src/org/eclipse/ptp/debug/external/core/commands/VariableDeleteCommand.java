 ...
 * 
 */
public class VariableDeleteCommand extends AbstractDebugCommand {
	private String keyVarName = "*";
	
	public VariableDeleteCommand(BitList tasks, String keyVarName) {
		super(tasks);
	...
	public void exec(IAbstractDebugger debugger) throws PCDIException {
		debugger.variableDelete(tasks, keyVarName);
	}
