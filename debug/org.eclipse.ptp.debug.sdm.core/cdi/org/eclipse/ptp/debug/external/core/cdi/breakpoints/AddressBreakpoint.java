...
public class AddressBreakpoint extends LocationBreakpoint implements IPCDIAddressBreakpoint {
	public AddressBreakpoint(int kind, IPCDILocation loc, IPCDICondition cond) {
		super(kind, loc, cond);
	}
}
