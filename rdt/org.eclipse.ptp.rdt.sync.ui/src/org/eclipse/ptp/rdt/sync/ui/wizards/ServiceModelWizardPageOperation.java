...
import static org.eclipse.ptp.rdt.sync.ui.wizards.ServiceModelWizardPage.CONFIG_PROPERTY;
...
public class ServiceModelWizardPageOperation implements IRunnableWithProgress {
	...
	public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		...
		IWizard wizard = MBSCustomPageManager.getPageData(ServiceModelWizardPage.SERVICE_MODEL_WIZARD_PAGE_ID).getWizardPage()
				.getWizard();
