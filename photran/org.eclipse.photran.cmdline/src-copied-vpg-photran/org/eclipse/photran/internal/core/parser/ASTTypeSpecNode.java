...
public class ASTTypeSpecNode extends ASTNode
{
    ...
    @Override protected IASTNode getASTField(int index)
    {
        ...
        case 1:  return this.hiddenTPrecision;
        ...
        case 8:  return this.isComplex;
        case 9:  return this.charSelector;
        case 10: return this.isLogical;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.isDouble = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 1:  this.hiddenTPrecision = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 2:  this.isDerivedType = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 3:  this.hiddenTLparen = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 4:  this.typeName = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 5:  this.hiddenTRparen = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 6:  this.isCharacter = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 7:  this.isReal = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 8:  this.isComplex = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 9:  this.charSelector = (ASTCharSelectorNode)value; return;
        case 10: this.isLogical = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 11: this.isInteger = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 12: this.kindSelector = (ASTKindSelectorNode)value; return;
