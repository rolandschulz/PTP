...
public class FortranEditorVPGTasks
{
     ...
     */
    public final Set<IFortranEditorASTTask> astTasks = new HashSet<IFortranEditorASTTask>();
    
    /**
     * These jobs will be run (in order) when the VPG is more-or-less up-to-date and an AST is available for the
     * file in the editor.
     */
    public final Set<IFortranEditorVPGTask> vpgTasks = new HashSet<IFortranEditorVPGTask>();
