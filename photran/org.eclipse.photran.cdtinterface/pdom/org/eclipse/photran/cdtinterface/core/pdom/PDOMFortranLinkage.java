...
public class PDOMFortranLinkage extends PDOMLinkage {
	...
	public PDOMFortranLinkage(PDOMDatabase pdom, int record) {
		super(pdom, record);
	}

	public PDOMFortranLinkage(PDOMDatabase pdom) throws CoreException {
	...
	private final class FindBinding extends PDOMNode.NodeVisitor {
		...
		public FindBinding(PDOMDatabase pdom, char[] name, int desiredType) {
			...
			System.out.println("-- FindBinding ctor");
		}
		public boolean visit(int record) throws CoreException {
			System.out.println("-- FindBinding visit");
	...
	protected int getBindingType(IBinding binding) {
		System.out.println("-- getBindingType");
