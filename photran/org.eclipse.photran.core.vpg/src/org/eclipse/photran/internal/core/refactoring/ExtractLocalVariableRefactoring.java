...
import org.eclipse.photran.internal.core.parser.ASTActionStmtNode;
...
public class ExtractLocalVariableRefactoring extends FortranRefactoring
{
    ...
    private ASTExprNode enclosingExpr;
    private ASTActionStmtNode enclosingAction;
    ...
    protected void doCheckInitialConditions(RefactoringStatus status, IProgressMonitor pm) throws PreconditionFailure
    {
        ...
        enclosingExpr = (ASTExprNode)this.findEnclosingNode(this.astOfFileInEditor, this.selectedRegionInEditor, Nonterminal.EXPR, false);
