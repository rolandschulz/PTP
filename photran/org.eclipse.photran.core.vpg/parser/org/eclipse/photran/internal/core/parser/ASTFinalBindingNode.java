...
public class ASTFinalBindingNode extends ASTNode implements IProcBindingStmt
{
    ...
    IASTListNode<ASTFinalSubroutineNameListNode> finalSubroutineNameList; // in ASTFinalBindingNode
    ...
    public IASTListNode<ASTFinalSubroutineNameListNode> getFinalSubroutineNameList()
    {
        return this.finalSubroutineNameList;
    }

    public void setFinalSubroutineNameList(IASTListNode<ASTFinalSubroutineNameListNode> newValue)
    {
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        ...
        case 4:  this.finalSubroutineNameList = (IASTListNode<ASTFinalSubroutineNameListNode>)value; return;
