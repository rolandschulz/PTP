...
public class ASTSectionSubscriptListNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTSectionSubscriptListNode
               && grandparent instanceof ASTSectionSubscriptListNode
               && ((ASTSectionSubscriptListNode)grandparent).getRecursiveNode() == parent)
        {
