...
public class ASTSFDummyArgNameListNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTSFDummyArgNameListNode
               && grandparent instanceof ASTSFDummyArgNameListNode
               && ((ASTSFDummyArgNameListNode)grandparent).getRecursiveNode() == parent)
        {
