...
public class ASTDoConstructNode extends ASTNode implements IExecutableConstruct
{
    ASTLabelDoStmtNode labelDoStmt; // in ASTDoConstructNode

    public ASTLabelDoStmtNode getLabelDoStmt()
    {
        return this.labelDoStmt;
    }
