...
public class ASTGenericBindingNode extends ASTNode implements IProcBindingStmt
{
    ...
    IASTListNode<ASTBindingNameListNode> bindingNameList; // in ASTGenericBindingNode
    ...
    public IASTListNode<ASTBindingNameListNode> getBindingNameList()
    {
        return this.bindingNameList;
    }

    public void setBindingNameList(IASTListNode<ASTBindingNameListNode> newValue)
    {
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        ...
        case 8:  this.bindingNameList = (IASTListNode<ASTBindingNameListNode>)value; return;
