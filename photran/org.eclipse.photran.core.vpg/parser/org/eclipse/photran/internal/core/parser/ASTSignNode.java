...
public class ASTSignNode extends ASTNode
{
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hasMinusSign = (org.eclipse.photran.internal.core.lexer.Token)value;
        case 1:  this.hasPlusSign = (org.eclipse.photran.internal.core.lexer.Token)value;
