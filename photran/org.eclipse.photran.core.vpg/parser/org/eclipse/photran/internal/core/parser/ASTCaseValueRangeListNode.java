...
public class ASTCaseValueRangeListNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTCaseValueRangeListNode
               && grandparent instanceof ASTCaseValueRangeListNode
               && ((ASTCaseValueRangeListNode)grandparent).getRecursiveNode() == parent)
        {
    ...
    public ASTCaseValueRangeNode getCaseValueRange(int listIndex)
    {
        ...
        else if (node.getProduction() == Production.CASE_VALUE_RANGE_LIST_696)
    ...
    private ASTCaseValueRangeListNode getRecursiveNode()
    {
        ...
        if (getProduction() == Production.CASE_VALUE_RANGE_LIST_696)
    ...
    {
        if (getProduction() == Production.CASE_VALUE_RANGE_LIST_696 && index == 1)
            return false;
        else
            return true;
    }
