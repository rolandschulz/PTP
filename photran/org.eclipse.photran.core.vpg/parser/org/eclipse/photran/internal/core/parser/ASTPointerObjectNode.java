...
public class ASTPointerObjectNode extends InteriorNode
{
    ASTPointerObjectNode(Production production, List<CSTNode> childNodes, List<CSTNode> discardedSymbols)
    {
         super(production);
    ...
    public ASTPointerFieldNode getPointerField()
    {
        if (treeHasBeenModified()) throw new IllegalStateException("Accessor methods cannot be called on the nodes of a CST after it has been modified");
