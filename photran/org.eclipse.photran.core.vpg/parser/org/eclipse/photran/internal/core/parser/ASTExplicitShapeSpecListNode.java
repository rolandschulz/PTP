...
public class ASTExplicitShapeSpecListNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTExplicitShapeSpecListNode
               && grandparent instanceof ASTExplicitShapeSpecListNode
               && ((ASTExplicitShapeSpecListNode)grandparent).getRecursiveNode() == parent)
        {
