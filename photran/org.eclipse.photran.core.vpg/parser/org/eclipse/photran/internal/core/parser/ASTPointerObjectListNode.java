...
public class ASTPointerObjectListNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTPointerObjectListNode
               && grandparent instanceof ASTPointerObjectListNode
               && ((ASTPointerObjectListNode)grandparent).getRecursiveNode() == parent)
        {
    ...
    {
        if (getProduction() == Production.POINTER_OBJECT_LIST_467 && index == 1)
            return false;
        else
            return true;
    }
