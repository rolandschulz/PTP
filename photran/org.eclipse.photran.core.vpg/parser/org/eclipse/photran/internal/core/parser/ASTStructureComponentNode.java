...
public class ASTStructureComponentNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTStructureComponentNode
               && grandparent instanceof ASTStructureComponentNode
               && ((ASTStructureComponentNode)grandparent).getRecursiveNode() == parent)
        {
