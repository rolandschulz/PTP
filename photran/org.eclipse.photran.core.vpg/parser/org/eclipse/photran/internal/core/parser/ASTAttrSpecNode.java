...
public class ASTAttrSpecNode extends ASTNode
{
    ...
    @Override protected IASTNode getASTField(int index)
    {
        ...
        case 3:  return this.isProtected;
        case 4:  return this.isIntent;
        case 5:  return this.languageBindingSpec;
        case 6:  return this.isExternal;
        case 7:  return this.isValue;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.isPointer = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        ...
        case 3:  this.isProtected = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 4:  this.isIntent = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 5:  this.languageBindingSpec = (ASTLanguageBindingSpecNode)value; return;
        case 6:  this.isExternal = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 7:  this.isValue = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 8:  this.isParameter = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 9:  this.isIntrinsic = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 10: this.isDimension = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 11: this.hiddenTLparen = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 12: this.arraySpec = (ASTArraySpecNode)value; return;
        case 13: this.intentSpec = (ASTIntentSpecNode)value; return;
        case 14: this.hiddenTRparen = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 15: this.isAllocatable = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 16: this.isSave = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 17: this.isVolatile = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 18: this.isAsync = (org.eclipse.photran.internal.core.lexer.Token)value; return;
