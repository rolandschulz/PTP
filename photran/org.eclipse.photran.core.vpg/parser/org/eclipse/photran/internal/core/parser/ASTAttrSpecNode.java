...
public class ASTAttrSpecNode extends ASTNode
{
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return this.isValue;
        case 1:  return this.isContiguous;
        case 2:  return this.isIntent;
        case 3:  return this.isPointer;
        case 4:  return this.isVolatile;
        case 5:  return this.isProtected;
        case 6:  return this.isCodimension;
        case 7:  return this.isIntrinsic;
        case 8:  return this.isOptional;
        ...
        case 19: return this.isDimension;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.isValue = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 1:  this.isContiguous = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 2:  this.isIntent = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 3:  this.isPointer = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 4:  this.isVolatile = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 5:  this.isProtected = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 6:  this.isCodimension = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 7:  this.isIntrinsic = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 8:  this.isOptional = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 9:  this.isAllocatable = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 10: this.isExternal = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 11: this.isSave = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 12: this.hiddenTLbracket = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 13: this.coarraySpec = (ASTCoarraySpecNode)value; return;
        case 14: this.hiddenTRbracket = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 15: this.accessSpec = (ASTAccessSpecNode)value; return;
        case 16: this.languageBindingSpec = (ASTLanguageBindingSpecNode)value; return;
        case 17: this.isAsync = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 18: this.isTarget = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 19: this.isDimension = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 20: this.hiddenTLparen = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 21: this.arraySpec = (ASTArraySpecNode)value; return;
        case 22: this.intentSpec = (ASTIntentSpecNode)value; return;
        case 23: this.hiddenTRparen = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 24: this.isParameter = (org.eclipse.photran.internal.core.lexer.Token)value; return;
