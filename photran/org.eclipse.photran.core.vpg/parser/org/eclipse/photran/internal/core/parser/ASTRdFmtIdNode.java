...
public class ASTRdFmtIdNode extends ASTNode
{
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hasLeOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 1:  this.hasEqEqOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 2:  this.hasTimesOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 3:  this.hasGeOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 4:  this.hasPlusOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 5:  this.hasSlashEqOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 6:  this.definedBinaryOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 7:  this.hasPowerOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 8:  this.hasNeqvOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 9:  this.hasEqvOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 10: this.hasGtOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 11: this.hasDivideOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 12: this.hasNeOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 13: this.hasNotOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 14: this.customDefinedOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 15: this.hasOrOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 16: this.hiddenTLparen = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 17: this.hasAndOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 18: this.hasMinusOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 19: this.formatIsAsterisk = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 20: this.primary1 = (ASTCOperandNode)value; return;
        case 21: this.hasEqOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 22: this.hasLtOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 23: this.definedUnaryOp = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 24: this.label = (org.eclipse.photran.internal.core.lexer.Token)value; return;
