...
public class ASTPointerAssignmentStmtNode extends InteriorNode
{
    ...
    public ASTLblDefNode getLblDef()
    {
        ...
        if (getProduction() == Production.POINTER_ASSIGNMENT_STMT_595)
            ...
            return (ASTLblDefNode)getChild(0);
        else if (getProduction() == Production.POINTER_ASSIGNMENT_STMT_597)
            return (ASTLblDefNode)getChild(0);
        else if (getProduction() == Production.POINTER_ASSIGNMENT_STMT_598)
            return (ASTLblDefNode)getChild(0);
        else
            return null;
    }
    ...
    public Token getTLparen()
    {
        ...
        if (getProduction() == Production.POINTER_ASSIGNMENT_STMT_597)
            return (Token)getChild(2);
        else if (getProduction() == Production.POINTER_ASSIGNMENT_STMT_598)
            return (Token)getChild(2);
        else
    ...
    public ASTSFDummyArgNameListNode getSFDummyArgNameList()
    {
        ...
        if (getProduction() == Production.POINTER_ASSIGNMENT_STMT_598)
