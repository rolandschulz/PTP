...
public class ASTAllocationListNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTAllocationListNode
               && grandparent instanceof ASTAllocationListNode
               && ((ASTAllocationListNode)grandparent).getRecursiveNode() == parent)
        {
    ...
    {
        if (getProduction() == Production.ALLOCATION_LIST_457 && index == 1)
            return false;
        else
            return true;
    }
