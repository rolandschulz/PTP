...
public class ASTBindingAttrNode extends ASTNode
{
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return this.isNonOverridable;
        case 1:  return this.accessSpec;
        case 2:  return this.isNoPass;
        case 3:  return this.isDeferred;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.isNonOverridable = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 1:  this.accessSpec = (ASTAccessSpecNode)value; return;
        case 2:  this.isNoPass = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 3:  this.isDeferred = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 4:  this.isPass = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 5:  this.hiddenTLparen = (org.eclipse.photran.internal.core.lexer.Token)value; return;
        case 6:  this.argName = (org.eclipse.photran.internal.core.lexer.Token)value; return;
