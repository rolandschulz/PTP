...
public class ASTSubstringRangeNode extends InteriorNode
{
    ASTSubstringRangeNode(Production production, List<CSTNode> childNodes, List<CSTNode> discardedSymbols)
    {
         super(production);
