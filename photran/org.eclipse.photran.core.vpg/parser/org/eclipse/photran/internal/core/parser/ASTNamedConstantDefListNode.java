...
public class ASTNamedConstantDefListNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTNamedConstantDefListNode
               && grandparent instanceof ASTNamedConstantDefListNode
               && ((ASTNamedConstantDefListNode)grandparent).getRecursiveNode() == parent)
        {
