...
public class ASTFunctionParsNode extends InteriorNode
{
    ...
    @Override public InteriorNode getASTParent()
    {
        ...
        while (parent != null && grandparent != null
               && parent instanceof ASTFunctionParsNode
               && grandparent instanceof ASTFunctionParsNode
               && ((ASTFunctionParsNode)grandparent).getRecursiveNode() == parent)
        {
    ...
    public ASTFunctionParNode getFunctionPar(int listIndex)
    {
        ...
        if (node.getProduction() == Production.FUNCTION_PARS_982)
            return (ASTFunctionParNode)node.getChild(0);
        else if (node.getProduction() == Production.FUNCTION_PARS_983)
    ...
    private ASTFunctionParsNode getRecursiveNode()
    {
        ...
        if (getProduction() == Production.FUNCTION_PARS_983)
    ...
    {
        if (getProduction() == Production.FUNCTION_PARS_983 && index == 1)
            return false;
        else
            return true;
    }
