...
public class ASTBlockConstructNode extends ScopingNode implements IExecutableConstruct
{
    ASTBlockStmtNode blockStmt; // in ASTBlockConstructNode
    IASTListNode<IBodyConstruct> body; // in ASTBlockConstructNode
    ASTEndBlockStmtNode endBlockStmt; // in ASTBlockConstructNode

    public ASTBlockStmtNode getBlockStmt()
    {
    ...
    public ASTEndBlockStmtNode getEndBlockStmt()
    {
        return this.endBlockStmt;
    }
