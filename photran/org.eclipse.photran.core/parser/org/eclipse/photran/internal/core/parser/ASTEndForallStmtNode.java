...
/**
 * <EndForallStmt> ::= LblDef:<LblDef> tend:T_END tforall:T_FORALL ( EndName:<EndName> )? teos:T_EOS 
 * <EndForallStmt> ::= LblDef:<LblDef> tendforall:T_ENDFORALL ( EndName:<EndName> )? teos:T_EOS 
 */
