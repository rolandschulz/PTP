...
/**
 * <TypeDeclarationStmt> ::= LblDef:<LblDef> TypeSpec:<TypeSpec> AttrSpecSeq:<AttrSpecSeq> tcolon:T_COLON tcolon2:T_COLON EntityDeclList:<EntityDeclList> teos:T_EOS  :production227
 * <TypeDeclarationStmt> ::= LblDef:<LblDef> TypeSpec:<TypeSpec> tcolon:T_COLON tcolon2:T_COLON EntityDeclList:<EntityDeclList> teos:T_EOS  :production228
 * <TypeDeclarationStmt> ::= LblDef:<LblDef> TypeSpec:<TypeSpec> EntityDeclList:<EntityDeclList> teos:T_EOS  :production229
 */
