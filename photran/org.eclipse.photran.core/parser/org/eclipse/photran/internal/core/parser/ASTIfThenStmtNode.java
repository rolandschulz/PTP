...
/**
 * <IfThenStmt> ::= LblDef:<LblDef> tif:T_IF tlparen:T_LPAREN Expr:<Expr> trparen:T_RPAREN tthen:T_THEN teos:T_EOS  :production597
 * <IfThenStmt> ::= LblDef:<LblDef> Name:<Name> tcolon:T_COLON tif:T_IF tlparen:T_LPAREN Expr:<Expr> trparen:T_RPAREN tthen:T_THEN teos:T_EOS  :production598
 */
