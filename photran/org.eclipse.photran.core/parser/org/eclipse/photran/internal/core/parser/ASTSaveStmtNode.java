...
/**
 * <SaveStmt> ::= LblDef:<LblDef> tsave:T_SAVE teos:T_EOS  :production318
 * <SaveStmt> ::= LblDef:<LblDef> tsave:T_SAVE ( tcolon:T_COLON tcolon2:T_COLON )? SavedEntityList:<SavedEntityList> teos:T_EOS  :production319
 */
