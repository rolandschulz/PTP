...
/**
 * <InvalidEntityDecl> ::= ObjectName:<ObjectName> tasterisk:T_ASTERISK CharLength:<CharLength> tlparen:T_LPAREN ArraySpec:<ArraySpec> trparen:T_RPAREN ( Initialization:<Initialization> )?  :production260
 */
