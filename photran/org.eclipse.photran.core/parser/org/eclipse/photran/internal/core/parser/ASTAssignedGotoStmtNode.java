...
/**
 * <AssignedGotoStmt> ::= LblDef:<LblDef> GoToKw:<GoToKw> VariableName:<VariableName> teos:T_EOS  :production960
 * <AssignedGotoStmt> ::= LblDef:<LblDef> GoToKw:<GoToKw> VariableName:<VariableName> tlparen:T_LPAREN LblRefList:<LblRefList> trparen:T_RPAREN teos:T_EOS  :production961
 * <AssignedGotoStmt> ::= LblDef:<LblDef> GoToKw:<GoToKw> VariableComma:<VariableComma> tlparen:T_LPAREN LblRefList:<LblRefList> trparen:T_RPAREN teos:T_EOS  :production962
 */
