...
/**
 * <ReadStmt> ::= LblDef:<LblDef> tread:T_READ RdCtlSpec:<RdCtlSpec> InputItemList:<InputItemList> teos:T_EOS 
 * <ReadStmt> ::= LblDef:<LblDef> tread:T_READ RdCtlSpec:<RdCtlSpec> teos:T_EOS 
 * <ReadStmt> ::= LblDef:<LblDef> tread:T_READ RdFmtId:<RdFmtId> tcomma:T_COMMA InputItemList:<InputItemList> teos:T_EOS 
 * <ReadStmt> ::= LblDef:<LblDef> tread:T_READ RdFmtId:<RdFmtId> teos:T_EOS 
 */
