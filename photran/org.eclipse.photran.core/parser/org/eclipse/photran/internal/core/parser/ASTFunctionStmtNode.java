...
/**
 * <FunctionStmt> ::= LblDef:<LblDef> FunctionPrefix:<FunctionPrefix> FunctionName:<FunctionName> tlparen:T_LPAREN FunctionPars:<FunctionPars> trparen:T_RPAREN ( tresult:T_RESULT tlparen2:T_LPAREN Name:<Name> trparen2:T_RPAREN )? teos:T_EOS 
 * <FunctionStmt> ::= LblDef:<LblDef> FunctionPrefix:<FunctionPrefix> FunctionName:<FunctionName> error:%error lookahead:T_EOS 
 */
