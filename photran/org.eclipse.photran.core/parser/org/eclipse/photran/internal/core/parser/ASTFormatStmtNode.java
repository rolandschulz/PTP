...
/**
 * <FormatStmt> ::= LblDef:<LblDef> tformat:T_FORMAT tlparen:T_LPAREN ( FmtSpec:<FmtSpec> )? trparen:T_RPAREN teos:T_EOS  :production792
 * <FormatStmt> ::= LblDef:<LblDef> tformat:T_FORMAT error:%error lookahead:T_EOS  :production793
 */
