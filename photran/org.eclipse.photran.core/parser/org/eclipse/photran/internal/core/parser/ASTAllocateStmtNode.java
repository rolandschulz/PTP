...
/**
 * <AllocateStmt> ::= LblDef:<LblDef> tallocate:T_ALLOCATE tlparen:T_LPAREN AllocationList:<AllocationList> tcomma:T_COMMA tstateq:T_STATEQ Variable:<Variable> trparen:T_RPAREN teos:T_EOS 
 * <AllocateStmt> ::= LblDef:<LblDef> tallocate:T_ALLOCATE tlparen:T_LPAREN AllocationList:<AllocationList> trparen:T_RPAREN teos:T_EOS 
 */
