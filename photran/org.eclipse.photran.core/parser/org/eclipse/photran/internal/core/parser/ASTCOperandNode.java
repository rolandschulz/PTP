...
/**
 * <COperand> ::= tscon:T_SCON 
 * <COperand> ::= Name:<Name> ( tlparen:T_LPAREN SectionSubscriptList:<SectionSubscriptList> trparen:T_RPAREN )? 
 * <COperand> ::= Name:<Name> ( tlparen:T_LPAREN SectionSubscriptList:<SectionSubscriptList> trparen:T_RPAREN )? tpercent:T_PERCENT DataRef:<DataRef> ( tlparen2:T_LPAREN SectionSubscriptList2:<SectionSubscriptList> trparen2:T_RPAREN )? 
 * <COperand> ::= FunctionReference:<FunctionReference> 
 */
