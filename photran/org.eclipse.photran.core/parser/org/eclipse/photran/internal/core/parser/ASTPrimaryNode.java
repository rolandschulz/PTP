...
/**
 * <Primary> ::= LogicalConstant:<LogicalConstant>  :production454
 * <Primary> ::= tscon:T_SCON  :production455
 * <Primary> ::= UnsignedArithmeticConstant:<UnsignedArithmeticConstant>  :production456
 * <Primary> ::= ArrayConstructor:<ArrayConstructor>  :production457
 * <Primary> ::= Name:<Name> ( tlparen:T_LPAREN SectionSubscriptList:<SectionSubscriptList> trparen:T_RPAREN ( SubstringRange:<SubstringRange> )? )?  :production458
 * <Primary> ::= Name:<Name> tpercent:T_PERCENT DataRef:<DataRef> ( tlparen:T_LPAREN SectionSubscriptList:<SectionSubscriptList> trparen:T_RPAREN ( SubstringRange:<SubstringRange> )? )?  :production459
 * <Primary> ::= Name:<Name> tlparen:T_LPAREN SectionSubscriptList:<SectionSubscriptList> trparen:T_RPAREN tpercent:T_PERCENT DataRef:<DataRef> ( tlparen2:T_LPAREN SectionSubscriptList2:<SectionSubscriptList> trparen2:T_RPAREN ( SubstringRange:<SubstringRange> )? )?  :production460
 * <Primary> ::= FunctionReference:<FunctionReference> ( SubstringRange:<SubstringRange> )?  :production461
 * <Primary> ::= FunctionReference:<FunctionReference> tpercent:T_PERCENT DataRef:<DataRef> ( tlparen:T_LPAREN SectionSubscriptList:<SectionSubscriptList> trparen:T_RPAREN ( SubstringRange:<SubstringRange> )? )?  :production462
 * <Primary> ::= tlparen:T_LPAREN Expr:<Expr> trparen:T_RPAREN  :production463
 * <Primary> ::= SubstrConst:<SubstrConst>  :production464
 */
