...
/**
 * <EndInterfaceStmt> ::= LblDef:<LblDef> tendinterface:T_ENDINTERFACE ( EndName:<EndName> )? teos:T_EOS 
 * <EndInterfaceStmt> ::= LblDef:<LblDef> tend:T_END tinterface:T_INTERFACE ( EndName:<EndName> )? teos:T_EOS 
 */
