...
/**
 * <SectionSubscriptList> ::= SectionSubscript:<SectionSubscript>  :production420
 * <SectionSubscriptList> ::= @:<SectionSubscriptList> tcomma:T_COMMA SectionSubscript:<SectionSubscript>  :production421
 */
