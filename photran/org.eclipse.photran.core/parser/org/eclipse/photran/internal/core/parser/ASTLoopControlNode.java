...
/**
 * <LoopControl> ::= VariableName:<VariableName> tequals:T_EQUALS Expr:<Expr> tcomma:T_COMMA Expr2:<Expr>  :production643
 * <LoopControl> ::= VariableName:<VariableName> tequals:T_EQUALS Expr:<Expr> tcomma:T_COMMA Expr2:<Expr> tcomma2:T_COMMA Expr3:<Expr>  :production644
 * <LoopControl> ::= twhile:T_WHILE tlparen:T_LPAREN Expr:<Expr> trparen:T_RPAREN  :production645
 */
